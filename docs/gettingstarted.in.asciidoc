...
https://github.com/packetbeat/packetbeat/blob/v$PB_VERSION/etc/packetbeat.template.json[here].
...
curl -L -O https://download.elasticsearch.org/beats/packetbeat/packetbeat_$PKG_VERSION_amd64.deb
sudo dpkg -i packetbeat_$PKG_VERSION_amd64.deb
----------------------------------------------------------------------
...
curl -L -O https://download.elasticsearch.org/beats/packetbeat/packetbeat-$PKG_VERSION-x86_64.rpm
sudo rpm -vi packetbeat-$PKG_VERSION-x86_64.rpm
----------------------------------------------------------------------
