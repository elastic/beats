...
CPU time in involuntary wait by virtual the CPU while the hypervisor is servicing another processor CPU time stolen from a virtual machine. Available only on Unix.
