...
* Wire SQS health status aggregation into the v2 `aws-s3` input path. [#51692](https://github.com/elastic/beats/issues/51692) [#51692](https://github.com/elastic/beats/issues/51692)
...
* Fix S3 polling input to exclude same-bucket backup objects from listing. [#52010](https://github.com/elastic/beats/pull/52010)
