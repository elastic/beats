...
* Add sign-in activity enrichment for Azure AD users via `enrich_with: sign_in_activity`. [#51390](https://github.com/elastic/beats/pull/51390) 
...
* Fix goroutine leak in request trace logging infrastructure. [#51950](https://github.com/elastic/beats/pull/51950) 
