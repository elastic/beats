...
| `ldap_ssl` | no | {applies_to}`stack: ga 9.2.3` no default<br>{applies_to}`stack: ga 9.0.0` `30` | LDAP TLS/SSL connection settings. Refer to [SSL](/reference/auditbeat/configuration-ssl.md). |
