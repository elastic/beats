...
The Nginx `stubstatus` metricset collects data from the Nginx [ngx_http_stub_status](http://nginx.org/en/docs/http/ngx_http_stub_status_module.md) module. It scrapes the server status data from the web page generated by ngx_http_stub_status.
