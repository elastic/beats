...
:   A boolean flag that enables extracting the object name directly from the counter path. This is useful when the object name includes a wildcard and you want the resulting event to contain the resolved (expanded) object name.
