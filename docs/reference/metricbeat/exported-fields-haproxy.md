...
:   Total number of times a server was selected, either for new sessions, or when re-dispatching. For servers, this field reports the number of times the server was selected.
