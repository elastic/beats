...
- module: azure
  ...
  # It must be a positive multiple of 24h.
  ...
  # billing_forecast_window controls the length of the forecast period. It must be a positive
  # multiple of 24h and defaults to 720h (30 days).
