...
3. If `rate_limit` is present it must be a map with numeric fields `rate` and `burst`. The `rate_limit` field may also have a string `error` field and other fields which will be logged. If it has an `error` field, the `rate` and `burst` will not be used to set rate limit behavior. The [Limit](https://pkg.go.dev/github.com/elastic/mito@v1.20.0/lib#Limit), and [Okta Rate Limit policy](https://pkg.go.dev/github.com/elastic/mito@v1.20.0/lib#OktaRateLimit) and [Draft Rate Limit policy](https://pkg.go.dev/github.com/elastic/mito@v1.20.0/lib#DraftRateLimit) documentation show how to construct this field.
...
* [AWS v4 request signing](https://pkg.go.dev/github.com/elastic/mito@v1.20.0/lib#AWS)
...
* [Collections](https://pkg.go.dev/github.com/elastic/mito@v1.20.0/lib#Collections)

    * [Collate](https://pkg.go.dev/github.com/elastic/mito@v1.20.0/lib#hdr-Collate-Collections)
    * [Drop](https://pkg.go.dev/github.com/elastic/mito@v1.20.0/lib#hdr-Drop-Collections)
    * [Drop Empty](https://pkg.go.dev/github.com/elastic/mito@v1.20.0/lib#hdr-Drop_Empty-Collections)
    * [Flatten](https://pkg.go.dev/github.com/elastic/mito@v1.20.0/lib#hdr-Flatten-Collections)
    * [Front](https://pkg.go.dev/github.com/elastic/mito@v1.20.0/lib#hdr-Front-Collections)
    * [Keys](https://pkg.go.dev/github.com/elastic/mito@v1.20.0/lib#hdr-Keys-Collections)
    * [Max](https://pkg.go.dev/github.com/elastic/mito@v1.20.0/lib#hdr-Max-Collections)
    * [Min](https://pkg.go.dev/github.com/elastic/mito@v1.20.0/lib#hdr-Min-Collections)
    * [Sum](https://pkg.go.dev/github.com/elastic/mito@v1.20.0/lib#hdr-Sum-Collections)
    * [Tail](https://pkg.go.dev/github.com/elastic/mito@v1.20.0/lib#hdr-Tail-Collections)
    * [Values](https://pkg.go.dev/github.com/elastic/mito@v1.20.0/lib#hdr-Values-Collections)
    * [With](https://pkg.go.dev/github.com/elastic/mito@v1.20.0/lib#hdr-With-Collections)
    * [With Replace](https://pkg.go.dev/github.com/elastic/mito@v1.20.0/lib#hdr-With_Replace-Collections)
    * [With Update](https://pkg.go.dev/github.com/elastic/mito@v1.20.0/lib#hdr-With_Update-Collections)
    * [Zip](https://pkg.go.dev/github.com/elastic/mito@v1.20.0/lib#hdr-Zip-Collections)

* [Crypto](https://pkg.go.dev/github.com/elastic/mito@v1.20.0/lib#Crypto)

    * [Base64](https://pkg.go.dev/github.com/elastic/mito@v1.20.0/lib#hdr-Base64-Crypto)
    * [Base64 Decode](https://pkg.go.dev/github.com/elastic/mito@v1.20.0/lib#hdr-Base64_Decode-Crypto)
    * [Base64 Raw](https://pkg.go.dev/github.com/elastic/mito@v1.20.0/lib#hdr-Base64_Raw-Crypto)
    * [Base64 Raw Decode](https://pkg.go.dev/github.com/elastic/mito@v1.20.0/lib#hdr-Base64_Raw_Decode-Crypto)
    * [Hex](https://pkg.go.dev/github.com/elastic/mito@v1.20.0/lib#hdr-Hex-Crypto)
    * [Hex Decode](https://pkg.go.dev/github.com/elastic/mito@v1.20.0/lib#hdr-Hex_Decode-Crypto)
    * [MD5](https://pkg.go.dev/github.com/elastic/mito@v1.20.0/lib#hdr-MD5-Crypto)
    * [SHA-1](https://pkg.go.dev/github.com/elastic/mito@v1.20.0/lib#hdr-SHA_1-Crypto)
    * [SHA-256](https://pkg.go.dev/github.com/elastic/mito@v1.20.0/lib#hdr-SHA_256-Crypto)
    * [HMAC](https://pkg.go.dev/github.com/elastic/mito@v1.20.0/lib#hdr-HMAC-Crypto)
    * [UUID](https://pkg.go.dev/github.com/elastic/mito@v1.20.0/lib#hdr-UUID-Crypto)

* [File](https://pkg.go.dev/github.com/elastic/mito@v1.20.0/lib#File) — the file extension is initialized with MIME handlers for "application/gzip", ["application/x-ndjson"](https://pkg.go.dev/github.com/elastic/mito@v1.20.0/lib#NDJSON), ["application/zip"](https://pkg.go.dev/github.com/elastic/mito@v1.20.0/lib#Zip), ["text/csv; header=absent"](https://pkg.go.dev/github.com/elastic/mito@v1.20.0/lib#CSVNoHeader), and ["text/csv; header=present"](https://pkg.go.dev/github.com/elastic/mito@v1.20.0/lib#CSVHeader).

    * [Dir](https://pkg.go.dev/github.com/elastic/mito@v1.20.0/lib#hdr-Dir-File)
    * [File](https://pkg.go.dev/github.com/elastic/mito@v1.20.0/lib#hdr-File-File)

* [HTTP](https://pkg.go.dev/github.com/elastic/mito@v1.20.0/lib#HTTP)

    * [HEAD](https://pkg.go.dev/github.com/elastic/mito@v1.20.0/lib#hdr-HEAD-HTTP)
    * [GET](https://pkg.go.dev/github.com/elastic/mito@v1.20.0/lib#hdr-GET-HTTP)
    * [GET Request](https://pkg.go.dev/github.com/elastic/mito@v1.20.0/lib#hdr-GET_Request-HTTP)
    * [POST](https://pkg.go.dev/github.com/elastic/mito@v1.20.0/lib#hdr-POST-HTTP)
    * [POST Request](https://pkg.go.dev/github.com/elastic/mito@v1.20.0/lib#hdr-POST_Request-HTTP)
    * [Request](https://pkg.go.dev/github.com/elastic/mito@v1.20.0/lib#hdr-Request-HTTP)
    * [Basic Authentication](https://pkg.go.dev/github.com/elastic/mito@v1.20.0/lib#hdr-Basic_Authentication-HTTP)
    * [Do Request](https://pkg.go.dev/github.com/elastic/mito@v1.20.0/lib#hdr-Do_Request-HTTP)
    * [Parse URL](https://pkg.go.dev/github.com/elastic/mito@v1.20.0/lib#hdr-Parse_URL-HTTP)
    * [Format URL](https://pkg.go.dev/github.com/elastic/mito@v1.20.0/lib#hdr-Format_URL-HTTP)
    * [Parse Query](https://pkg.go.dev/github.com/elastic/mito@v1.20.0/lib#hdr-Parse_Query-HTTP)
    * [Format Query](https://pkg.go.dev/github.com/elastic/mito@v1.20.0/lib#hdr-Format_Query-HTTP)

* [JSON](https://pkg.go.dev/github.com/elastic/mito@v1.20.0/lib#JSON)

    * [Encode JSON](https://pkg.go.dev/github.com/elastic/mito@v1.20.0/lib#hdr-Encode_JSON-JSON)
    * [Decode JSON](https://pkg.go.dev/github.com/elastic/mito@v1.20.0/lib#hdr-Decode_JSON-JSON)
    * [Decode JSON Stream](https://pkg.go.dev/github.com/elastic/mito@v1.20.0/lib#hdr-Decode_JSON_Stream-JSON)

* [XML](https://pkg.go.dev/github.com/elastic/mito@v1.20.0/lib#XML) — the XML extension is initialized with XML schema definitions provided via the `xsd` configuration option.

    * [Decode XML](https://pkg.go.dev/github.com/elastic/mito@v1.20.0/lib#hdr-Decode_XML-XML)

* [Limit](https://pkg.go.dev/github.com/elastic/mito@v1.20.0/lib#Limit) — the rate limit extension is initialized with [Okta (as "okta")](https://pkg.go.dev/github.com/elastic/mito@v1.20.0/lib#OktaRateLimit) and the [Draft Rate Limit (as "draft")](https://pkg.go.dev/github.com/elastic/mito@v1.20.0/lib#DraftRateLimit) policies.

    * [Rate Limit](https://pkg.go.dev/github.com/elastic/mito@v1.20.0/lib#hdr-Rate_Limit-Limit)

* [MIME](https://pkg.go.dev/github.com/elastic/mito@v1.20.0/lib#MIME) — the MIME extension is initialized with MIME handlers for "application/gzip", ["application/x-ndjson"](https://pkg.go.dev/github.com/elastic/mito@v1.20.0/lib#NDJSON), ["application/zip"](https://pkg.go.dev/github.com/elastic/mito@v1.20.0/lib#Zip), ["text/csv; header=absent"](https://pkg.go.dev/github.com/elastic/mito@v1.20.0/lib#CSVNoHeader), and ["text/csv; header=present"](https://pkg.go.dev/github.com/elastic/mito@v1.20.0/lib#CSVHeader).

    * [MIME](https://pkg.go.dev/github.com/elastic/mito@v1.20.0/lib#hdr-MIME-MIME)

* [Regexp](https://pkg.go.dev/github.com/elastic/mito@v1.20.0/lib#Regexp) — the regular expression extension is initialized with the patterns specified in the user input configuration via the `regexp` field.

    * [RE Match](https://pkg.go.dev/github.com/elastic/mito@v1.20.0/lib#hdr-RE_Match)
    * [RE Find](https://pkg.go.dev/github.com/elastic/mito@v1.20.0/lib#hdr-RE_Find)
    * [RE Find All](https://pkg.go.dev/github.com/elastic/mito@v1.20.0/lib#hdr-RE_Find_All)
    * [RE Find Submatch](https://pkg.go.dev/github.com/elastic/mito@v1.20.0/lib#hdr-RE_Find_Submatch)
    * [RE Find All Submatch](https://pkg.go.dev/github.com/elastic/mito@v1.20.0/lib#hdr-RE_Find_All_Submatch)
    * [RE Replace All](https://pkg.go.dev/github.com/elastic/mito@v1.20.0/lib#hdr-RE_Replace_All)

* [Printf](https://pkg.go.dev/github.com/elastic/mito@v1.20.0/lib#Printf)

    * [Sprintf](https://pkg.go.dev/github.com/elastic/mito@v1.20.0/lib#hdr-Sprintf-Printf)

* [Strings](https://pkg.go.dev/github.com/elastic/mito@v1.20.0/lib#Strings)

    * [String Methods](https://pkg.go.dev/github.com/elastic/mito@v1.20.0/lib#hdr-String_Methods-Strings)
    * [String List Methods](https://pkg.go.dev/github.com/elastic/mito@v1.20.0/lib#hdr-String_List_Methods-Strings)
    * [Bytes Methods](https://pkg.go.dev/github.com/elastic/mito@v1.20.0/lib#hdr-Bytes_Methods-Strings)

* [Time](https://pkg.go.dev/github.com/elastic/mito@v1.20.0/lib#Time)

    * [Format](https://pkg.go.dev/github.com/elastic/mito@v1.20.0/lib#hdr-Format-Time)
    * [Parse Time](https://pkg.go.dev/github.com/elastic/mito@v1.20.0/lib#hdr-Parse_Time-Time)
    * [Global Variables](https://pkg.go.dev/github.com/elastic/mito@v1.20.0/lib#hdr-Global_Variables-Time)

* [Try](https://pkg.go.dev/github.com/elastic/mito@v1.20.0/lib#Try)

    * [Try](https://pkg.go.dev/github.com/elastic/mito@v1.20.0/lib#hdr-Try-Try)
    * [Is Error](https://pkg.go.dev/github.com/elastic/mito@v1.20.0/lib#hdr-Is_Error-Try)

* [Debug](https://pkg.go.dev/github.com/elastic/mito@v1.20.0/lib#Debug) — the debug handler registers a logger with the name extension `cel_debug` and calls to the CEL `debug` function are emitted to that logger.

    * [Debug](https://pkg.go.dev/github.com/elastic/mito@v1.20.0/lib#hdr-Debug)
...
The CEL environment enables the [optional types](https://pkg.go.dev/github.com/google/cel-go/cel#OptionalTypes) library using the version defined [here](https://pkg.go.dev/github.com/elastic/mito@v1.20.0/lib#OptionalTypesVersion).
