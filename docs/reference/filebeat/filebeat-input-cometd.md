...
Use the `https://docs.cometd.org/[cometd]` input to stream the real-time events from a Salesforce generic subscription Push Topic. For more information, refer to Saleforce’s [Streaming API](https://developer.salesforce.com/docs/atlas.en-us.api_streaming.meta/api_streaming/intro_stream.htm) documentation.
