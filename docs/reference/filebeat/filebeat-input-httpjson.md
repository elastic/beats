...
3. All but the last response in a chain is allowed to be an array of strings where each string is an id. The replace expression to access the id is `replace: $[:]`.
