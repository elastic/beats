...
[source,shell]
----------------------------------------------------------------------
curl -L -O https://download.elastic.co/beats/packetbeat/packetbeat-dashboards-1.0.0-beta3.tar.gz
tar xzvf packetbeat-dashboards-1.0.0-beta3.tar.gz
cd packetbeat-dashboards-1.0.0-beta3/
./load.sh
----------------------------------------------------------------------
