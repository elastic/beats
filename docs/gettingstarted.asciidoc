...
curl -L -O https://download.elastic.co/elasticsearch/elasticsearch/elasticsearch-1.5.2.deb
...
curl -L -O https://download.elastic.co/elasticsearch/elasticsearch/elasticsearch-1.5.2.noarch.rpm
...
curl -L -O https://download.elastic.co/beats/packetbeat/packetbeat_1.0.0-beta3_amd64.deb
...
curl -L -O https://download.elastic.co/beats/packetbeat/packetbeat-1.0.0-beta3-x86_64.rpm
...
[source,shell]
----------------------------------------------------------------------
curl -L -O https://download.elastic.co/beats/packetbeat/packetbeat-1.0.0-beta3-darwin.tgz
