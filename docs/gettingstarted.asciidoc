...
[source,shell]
----------------------------------------------------------------------
curl -L -O https://raw.githubusercontent.com/elastic/packetbeat/v$PB_VERSION/etc/packetbeat.template.json
...
curl -L -O https://download.elasticsearch.org/beats/packetbeat/packetbeat_$PB_VERSION-1_amd64.deb
...
curl -L -O https://download.elasticsearch.org/beats/packetbeat/packetbeat-$PB_VERSION-1.el6.x86_64.rpm
...
curl -L -O https://download.elasticsearch.org/beats/packetbeat/packetbeat-$PB_VERSION-x86_64.tar.gz
...
Set the IP address and port where the agent can find the Elasticsearch
installation:
...
[source,shell]
----------------------------------------------------------------------
$ curl -L -O https://github.com/elastic/packetbeat-dashboards/archive/v$DASHBOARDS_VERSION.tar.gz
