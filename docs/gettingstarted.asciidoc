...
////
TODO: add a real reference to Packetbeat Deploy. Do we even keep this
 reference?
////
...
////
TODO: Update URLs to the Elastic service.
////
...
The first think you need to do is to configure the index pattern. In
