...
Check the TODO[Getting started] guide to see how to get started with Elasticsearch, Kibana
...
More details about starting and stopping packetbeat you can find TODO[here].
