...
https://github.com/menderesk/beats/blob/main/CHANGELOG.next.asciidoc[CHANGELOG.next.asciidoc].
...
git clone https://github.com/menderesk/beats ${GOPATH}/src/github.com/menderesk/beats
----------------------------------------------------------------------
...
contributing docs, see the https://github.com/menderesk/docs/blob/master/README.asciidoc[Docs HOWTO].
...
https://github.com/menderesk/beats/blob/main/CHANGELOG-developer.next.asciidoc[here].
