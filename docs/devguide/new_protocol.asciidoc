...
$ git clone https://github.com/menderesk/beats.git
----------------------------------------------------------------------
...
create a symlink to the `$GOPATH/src/github.com/menderesk/` directory.
...
* In the `$GOPATH/src/github.com/menderesk/beats` folder, add your fork
...
https://github.com/menderesk/beats/tree/master/packetbeat/scripts/tcp-protocol.
