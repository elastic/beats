...
If you haven't installed Mage on your system already, be sure to follow the [installation instructions here](https://magefile.org/). Next up we'll run a mage script to generate the custom beat:
