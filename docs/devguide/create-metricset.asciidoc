...
https://github.com/menderesk/beats/blob/main/metricbeat/scripts/module/metricset/metricset.go.tmpl
...
https://godoc.org/github.com/menderesk/beats/libbeat/common#MapStr[MapStr API docs].
...
https://godoc.org/github.com/menderesk/beats/libbeat/common/schema[schema] package
...
----
import (
	s "github.com/menderesk/beats/libbeat/common/schema"
	c "github.com/menderesk/beats/libbeat/common/schema/mapstrstr"
)
