...
Certificate for TLS client authentication. Both certificate and certificate-key
are required.

===== certificate-key: "/etc/pki/client/cert.key"

Client certificate key. Both certificate and certificate-key are required.
...
* RSA-RC4-128-SHA (disabled by default)
* RSA-3DES-CBC3-SHA
* RSA-AES128-CBC-SHA
* RSA-AES256-CBC-SHA
* ECDHE-ECDSA-RC4-128-SHA (disabled by default)
* ECDHE-ECDSA-AES128-CBC-SHA
* ECDHE-ECDSA-AES256-CBC-SHA
* ECDHE-RSA-RC4-128-SHA (disabled by default)
