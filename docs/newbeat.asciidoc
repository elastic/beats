= Developer guide: create a new Beat
...
func main() {
    ...
    if cfgfile.IsTestConfig() { <5>
        // all good, exit with 0
        os.Exit(0)
    }
    service.BeforeRun()

    service.HandleSignals(topbeat.Stop) <6>
...
<1> libbeat modules can provide their own command line flags.
