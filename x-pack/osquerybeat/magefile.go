...
import (
	...
	"github.com/elastic/beats/v8/x-pack/osquerybeat/internal/command"
	"github.com/elastic/beats/v8/x-pack/osquerybeat/internal/distro"
	osquerybeat "github.com/elastic/beats/v8/x-pack/osquerybeat/scripts/mage"

	// mage:import
	_ "github.com/elastic/beats/v8/dev-tools/mage/target/pkg"
	// mage:import
	_ "github.com/elastic/beats/v8/dev-tools/mage/target/unittest"
	// mage:import
	_ "github.com/elastic/beats/v8/dev-tools/mage/target/integtest/notests"
	// mage:import
