...
type scheduledResponsePublisher interface {
	PublishScheduledResponse(scheduleID, responseID string, startedAt, completedAt, plannedScheduleTime time.Time, resultCount int, scheduleExecutionCount int64)
}
