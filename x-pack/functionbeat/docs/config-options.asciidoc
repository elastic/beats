...
You can also set up triggers for Kinesis and API Gateway, but they are not
currently supported as {beatname_uc} configuration options. You must create them
manually by using the Lambda console in AWS after deploying the function of
AWS.

// REVIEWERS: I have not verified this and I don't know if it's true. Is it
// correct?
