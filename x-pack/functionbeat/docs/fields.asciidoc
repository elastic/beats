...
Fields provided by Functionbeat.



*`functionbeat.aws.event_id`*::
+
--
type: keyword
...
*`functionbeat.aws.event_source_arn`*::
+
--
type: keyword
...
*`functionbeat.cloudwatchlog.owner`*::
+
--
type: keyword

Owner of the log group.


--

*`functionbeat.cloudwatchlog.log_stream`*::
+
--
type: keyword
...
*`functionbeat.cloudwatchlog.log_group`*::
+
--
type: keyword
...
*`functionbeat.subscription_filters`*::
+
--
type: keyword
...
*`functionbeat.sqs.receipt_handle`*::
+
--
type: keyword
...
*`functionbeat.api_gateway_proxy.resource`*::
+
--
type: keyword
...
*`functionbeat.api_gateway_proxy.path`*::
+
--
type: keyword
...
*`functionbeat.api_gateway_proxy.method`*::
+
--
type: keyword
...
*`functionbeat.api_gateway_proxy.headers`*::
+
--
type: object
...
*`functionbeat.api_gateway_proxy.query_string`*::
+
--
type: object
...
*`functionbeat.api_gateway_proxy.is_based64_encoded`*::
+
--
type: bool
