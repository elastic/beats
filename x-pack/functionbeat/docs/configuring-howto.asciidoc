...
[role="xpack"]
include::{libbeat-dir}/outputs/output-elasticsearch.asciidoc[]

[role="xpack"]
include::{libbeat-dir}/outputs/output-logstash.asciidoc[]

[role="xpack"]
include::{libbeat-dir}/outputs/output-cloud.asciidoc[]
