...
* *Google cloud example*: The following example configures a function called
...
To deploy the {beatname_uc} functions to your cloud provider, either use the
...
. Create (or use) a service account that has these roles:
+
--
