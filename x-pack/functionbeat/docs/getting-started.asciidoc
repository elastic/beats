...
TIP: Instead of deploying from the command line, you can export an
{cloudformation-ref} template and use the template with automation software to
deploy {beatname_uc} code to your cloud environment. For more information, see 
