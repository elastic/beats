...
func (r *metricsRequester) Metric(ctx context.Context, service, metricType string, timeInterval *monitoringpb.TimeInterval, aligner string) (out timeSeriesWithAligner) {
	...
	req := &monitoringpb.ListTimeSeriesRequest{
		...
		Filter:   r.getFilterForMetric(service, metricType),
...
func (r *metricsRequester) getFilterForMetric(service, m string) (f string) {
