...
var (
	s = schema.Schema{
		"ec2": schema.Object{
			...
			"network.in.packets":           mapstrstr.Float("network_packets_in"),
			"network.out.packets":          mapstrstr.Float("network_packets_out"),
			"network.in.bytes":             mapstrstr.Float("network_in"),
			"network.out.bytes":            mapstrstr.Float("network_out"),
			"diskio.read.bytes":            mapstrstr.Float("disk_read_bytes"),
			"diskio.write.bytes":           mapstrstr.Float("disk_write_bytes"),
			"diskio.read.ops":              mapstrstr.Float("disk_read_ops"),
			"diskio.write.ops":             mapstrstr.Float("disk_write_ops"),
