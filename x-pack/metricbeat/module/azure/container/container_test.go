...
func TestFetch(t *testing.T) {
	...
	assert.Equal(t, ms.Client.Config.Resources[0].Query, fmt.Sprintf("resourceType eq '%s' OR resourceType eq '%s' or resourceType eq '%s' ",
		defaultContainerNamespace, registryNamespace, groupNamespace))
