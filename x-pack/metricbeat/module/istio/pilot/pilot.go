...
var mapping = &prometheus.MetricsMapping{
	Metrics: map[string]prometheus.MetricMap{
		...
		"pilot_conflict_inbound_listener":                        prometheus.Metric("conflict.inbound.listener"),
		"pilot_conflict_outbound_listener_http_over_current_tcp": prometheus.Metric("conflict.outbound.listener.http.over.current.tcp"),
		"pilot_conflict_outbound_listener_http_over_https":       prometheus.Metric("conflict.outbound.listener.http.over.https"),
		"pilot_conflict_outbound_listener_tcp_over_current_http": prometheus.Metric("conflict.outbound.listener.tcp.over.current.http"),
		"pilot_conflict_outbound_listener_tcp_over_current_tcp":  prometheus.Metric("conflict.outbound.listener.tcp.over.current.tcp"),
