	...
	testCases := []testCase{
		...
		},
		{
			...
			common.MapStr{
				...
				"step":            common.MapStr{"name": "MyStep", "status": "success", "index": 42, "duration": common.MapStr{"us": time.Duration(10)}},
				"root_fields": map[string]interface{}{
					"synthetics": map[string]interface{}{
						"nested": "v1",
					},
		...
		},
		{
			...
			common.MapStr{
				...
				"package_version": "1.2.3",
				"journey":         common.MapStr{"name": "MyJourney", "id": "MyJourney"},
				"step":            common.MapStr{"name": "MyStep", "index": 42, "status": "down", "duration": common.MapStr{"us": time.Duration(21312)}},
				"error": common.MapStr{
					"name":    "MyErrorName",
