 ...
 docker run --env STACK_VERSION=7.10.2  --name vm_extension_ubuntu_run --rm -i -t vm_extension_ubuntu bash -c "./handler/scripts/linux/install.sh;bash" --privileged=true
