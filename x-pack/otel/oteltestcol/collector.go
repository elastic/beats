...
import (
	...
	"github.com/elastic/beats/v9/x-pack/auditbeat/abreceiver"
	"github.com/elastic/beats/v9/x-pack/filebeat/fbreceiver"
	"github.com/elastic/beats/v9/x-pack/heartbeat/hbreceiver"
	"github.com/elastic/beats/v9/x-pack/metricbeat/mbreceiver"
	"github.com/elastic/beats/v9/x-pack/osquerybeat/osqreceiver"
	"github.com/elastic/beats/v9/x-pack/otel/exporter/logstashexporter"
	"github.com/elastic/beats/v9/x-pack/otel/extension/beatsauthextension"
	"github.com/elastic/beats/v9/x-pack/otel/extension/elasticsearchstorage"
	"github.com/elastic/beats/v9/x-pack/otel/processor/beatprocessor"
	"github.com/elastic/beats/v9/x-pack/packetbeat/pbreceiver"
