module github.com/elastic/beats/v7/x-pack/otel/oteltestcol

go 1.25.8

replace github.com/elastic/beats/v7/x-pack/filebeat/fbreceiver => ../../filebeat/fbreceiver

replace github.com/elastic/beats/v7/x-pack/metricbeat/mbreceiver => ../../metricbeat/mbreceiver

replace github.com/elastic/beats/v7/x-pack/otel/exporter/logstashexporter => ../exporter/logstashexporter

replace github.com/elastic/beats/v7/x-pack/otel/extension/beatsauthextension => ../extension/beatsauthextension

replace github.com/elastic/beats/v7/x-pack/otel/extension/elasticsearchstorage => ../extension/elasticsearchstorage

replace github.com/elastic/beats/v7/x-pack/otel/processor/beatprocessor => ../processor/beatprocessor

replace github.com/elastic/beats/v7 => ../../..

require (
	github.com/elastic/beats/v7 v7.0.0-alpha
	github.com/elastic/beats/v7/x-pack/filebeat/fbreceiver v0.0.0-00010101000000-000000000000
	github.com/elastic/beats/v7/x-pack/metricbeat/mbreceiver v0.0.0-00010101000000-000000000000
	github.com/elastic/beats/v7/x-pack/otel/exporter/logstashexporter v0.0.0-00010101000000-000000000000
	github.com/elastic/beats/v7/x-pack/otel/extension/beatsauthextension v0.0.0-00010101000000-000000000000
	github.com/elastic/beats/v7/x-pack/otel/extension/elasticsearchstorage v0.0.0-00010101000000-000000000000
	github.com/elastic/beats/v7/x-pack/otel/processor/beatprocessor v0.0.0-00010101000000-000000000000
...
require (
	...
	github.com/elastic/elastic-agent-libs v0.33.3 // indirect
