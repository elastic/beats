...
//REVIEWERS: I'm not including this in the tabbed panel display because I
//don't want it to end up in the quick start.
...
// REVIEWERS: Is the last step ^^ actually needed? Seemed to me that it worked
// without it.
