...
//REVIEWERS: This doesn't work on macOS. ^^ Does not seem to return the ID
//of a actual process (ID doesn't match what I see in the activity monitor). 

//TODO: move deb/rpm tabs to the end of the widget.
