...
type config struct {
	Field         string `config:"field"        validate:"required"` // Source field containing the CEF message.
	TargetField   string `config:"target_field" validate:"required"` // Target field for the CEF object.
