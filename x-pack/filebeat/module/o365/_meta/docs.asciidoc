...
Example configuration using client-secret authentication:
...
The `o365.audit` fileset supports certificate-based authentication. This is
specially useful when monitoring multiple tenants:
