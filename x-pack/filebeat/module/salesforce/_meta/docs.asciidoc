...
- module: salesforce
  login:
    ...
    var.jwt_authentication_enabled: true

    var.client_id: "my-client-id"
    var.client_username: "my.email@here.com"
    var.client_key_path: client_key.pem
    var.jwt_url: https://login.salesforce.com

    var.user_pass_authentication_enabled: true
...
*`var.jwt_authentication_enabled`*::

Set to true if JWT authentication is enabled.
...
*`var.user_pass_authentication_enabled`*::

Set to false if user-password authentication is enabled.
...
The user used for user-password authentication.
