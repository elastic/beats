...
provokes reading the S3 objects multiple times even if they didn't change.
Not having an expiration on the S3 object and settings this value to `0s` has an impact
on memory usage of Filebat.
