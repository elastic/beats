...
For the first setup, the application will require permission to set the default paths and create folders on your system. Therefore the permission `Incident.ReadWrite.All` is required for the first setup.
