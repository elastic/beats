...
This is a module for receiving Kaspersky Anti-Virus logs over Syslog or a file.
...
NOTE: This was converted from RSA NetWitness log parser XML "kasperskyav" device revision 127.
...
The port to listen for syslog traffic. Defaults to `9514`
