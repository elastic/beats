...
func TestNewReceiver(t *testing.T) {
	...
	oteltest.CheckReceivers(oteltest.CheckReceiversParams{
		...
		AssertFunc: func(c *assert.CollectT, logs map[string][]mapstr.M, zapLogs *observer.ObservedLogs) {
			...
			assert.Equal(c, "filebeatreceiver/r1", logs["r1"][0].Flatten()["otelcol.component.id"], "expected otelcol.component.id field in log record")
...
func TestMultipleReceivers(t *testing.T) {
	...
	oteltest.CheckReceivers(oteltest.CheckReceiversParams{
		...
		AssertFunc: func(c *assert.CollectT, logs map[string][]mapstr.M, zapLogs *observer.ObservedLogs) {
			...
			assert.Equal(c, "filebeatreceiver/r1", logs["r1"][0].Flatten()["otelcol.component.id"], "expected otelcol.component.id field in r1 log record")
			assert.Equal(c, "receiver", logs["r1"][0].Flatten()["otelcol.component.kind"], "expected otelcol.component.kind field in r1 log record")
			assert.Equal(c, "filebeatreceiver/r2", logs["r2"][0].Flatten()["otelcol.component.id"], "expected otelcol.component.id field in r2 log record")
