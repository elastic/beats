...
func TestInputMetricsInit(t *testing.T) {
	...
	assert.NotNil(t, m.recoveryModeEntries)
	...
	assert.EqualValues(t, 0, m.recoveryModeEntries.Get())
...
func TestInputMetricsCountersAndHistograms(t *testing.T) {
	...
	assert.EqualValues(t, 1, m.recoveryModeEntries.Get())
