...
//func newLegacySanitizerSpecs(opts ...string) []SanitizerSpec {
//	var sanitizers []SanitizerSpec
//
//	for _, opt := range opts {
//		switch sanitizationOption(opt) {
//		case newLines:
//			sanitizers = append(sanitizers, SanitizerSpec{Type: "new_lines"})
//		case singleQuotes:
//			sanitizers = append(sanitizers, SanitizerSpec{Type: "single_quotes"})
//		}
//	}
//
//	return sanitizers
