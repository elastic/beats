...
var fetchBucket = map[string]string{
	bucketGcsTestNew:    bucket_gcs_test_new,
	bucketGcsTestLatest: bucket_gcs_test_latest,
}

var objectList = map[string]string{
	bucketGcsTestNew:    gcs_test_new_objectList,
	bucketGcsTestLatest: gcs_test_latest_objectList,
}
...
var gcs_test_latest_objectList = `{
	"kind": "storage#objects",
	"items": [
	  {
		"kind": "storage#object",
