...
CEL Metrics exported for each periodic run:
		...
		input.cel.program.event.published           the number of events the program has published.                                          Int64Histogram	input.cel.program.batch.published           the number of batched the program has published.                                         Int64Histogram
