...
func Init(info beat.Info, log *logp.Logger, store beat.StateStore) []v2.Plugin {
	return append(
...
func xpackInputs(info beat.Info, log *logp.Logger, store beat.StateStore) []v2.Plugin {
	return []v2.Plugin{
		cloudfoundry.Plugin(),
