...
func TestConfigEdgeGridValidation(t *testing.T) {
	cases := []struct {
		name        string
		expectedErr string
		input       map[string]interface{}
		...
		{
			name:        "can't set edge grid and basic auth together",
			expectedErr: "only one kind of auth can be enabled accessing 'auth'",
			input: map[string]interface{}{
				"auth.basic.user":     "user",
				"auth.basic.password": "pass",
				"auth.edgegrid": map[string]interface{}{
					"client_token":  "asdf",
					"host":          "localhost",
					"client_secret": "asdf",
					"access_token":  "asdf",
		...
		{
			name:        "Must set all config parameters",
			expectedErr: "All parameters must be set; Host, Client Token, Client Secret, Access Token. accessing 'auth.edgegrid'",
			input: map[string]interface{}{
				"auth.edgegrid": map[string]interface{}{
					"client_token":  "asdf",
					"host":          "localhost",
