...
<<<<<<< HEAD:x-pack/filebeat/input/httpjson/internal/v2/response.go
...
>>>>>>> 043cab99de (x-pack/filebeat/input/httpjson: make sure interval data clearing happens before processing (#30730)):x-pack/filebeat/input/httpjson/response.go
