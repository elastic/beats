...
func TestInputRunSQS(t *testing.T) {
	...
	assert.EqualValues(t, s3Input.metrics.sqsMessagesWaiting.Get(), 1) // sqsMessagesWaitingMetric is polled every minute and test completes in less than a minute
