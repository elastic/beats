...
// CreateForS3Polling mocks base method.
func (m *MockS3ObjectHandlerFactory) CreateForS3Polling(ctx context.Context, log *logp.Logger, client beat.Client, acker *aws.EventACKTracker, obj s3EventV2) s3ObjectHandler {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "CreateForS3Polling", ctx, log, client, acker, obj)
	ret0, _ := ret[0].(s3ObjectHandler)
	return ret0
}

// CreateForS3Polling indicates an expected call of CreateForS3Polling.
func (mr *MockS3ObjectHandlerFactoryMockRecorder) CreateForS3Polling(ctx, log, client, acker, obj interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "CreateForS3Polling", reflect.TypeOf((*MockS3ObjectHandlerFactory)(nil).CreateForS3Polling), ctx, log, client, acker, obj)
}
