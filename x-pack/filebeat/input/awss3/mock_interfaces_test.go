...
func (m *MockSQSProcessor) DeleteSQS(ctx context.Context, msg *types.Message, receiveCount int, processingErr error, handles []s3ObjectHandler) error {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "DeleteSQS", ctx, msg, receiveCount, processingErr, handles)
	ret0, _ := ret[0].(error)
	return ret0
}

// DeleteSQS indicates an expected call of DeleteSQS.
func (mr *MockSQSProcessorMockRecorder) DeleteSQS(ctx, msg, receiveCount, processingErr, handles interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "DeleteSQS", reflect.TypeOf((*MockSQSProcessor)(nil).DeleteSQS), ctx, msg, receiveCount, processingErr, handles)
}

// ProcessSQS mocks base method.
func (m *MockSQSProcessor) ProcessSQS(ctx context.Context, msg *types.Message, client beat.Client, acker *aws.EventACKTracker) (int, []s3ObjectHandler, context.CancelFunc, *sync.WaitGroup, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "ProcessSQS", ctx, msg, client, acker)
	ret0, _ := ret[0].(int)
	ret1, _ := ret[1].([]s3ObjectHandler)
	ret2, _ := ret[2].(context.CancelFunc)
	ret3, _ := ret[3].(*sync.WaitGroup)
	ret4, _ := ret[4].(error)
	return ret0, ret1, ret2, ret3, ret4
}

// ProcessSQS indicates an expected call of ProcessSQS.
func (mr *MockSQSProcessorMockRecorder) ProcessSQS(ctx, msg, client, acker interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "ProcessSQS", reflect.TypeOf((*MockSQSProcessor)(nil).ProcessSQS), ctx, msg, client, acker)
}
