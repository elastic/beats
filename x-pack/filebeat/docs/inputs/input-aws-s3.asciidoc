...
- type: s3
  ...
  access_key_id: '$\{AWS_ACCESS_KEY_ID:"fake-access-key"\}'
  secret_access_key: '$\{AWS_SECRET_ACCESS_KEY:"fake-secret-key"\}'
  session_token: '$\{AWS_SESSION_TOKEN:"fake-session-token"\}'
----
