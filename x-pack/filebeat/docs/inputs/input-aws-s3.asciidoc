...
Please keep the default value 5 for this field for majority of the use cases.
The only time we recommend using a large number for this field is when processing
large amount of small size S3 objects.
