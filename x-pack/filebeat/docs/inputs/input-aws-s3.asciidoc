...
The maximum number of SQS messages to receive during a single `ReceiveMessage` call.
As many goroutine workers will be started to process the SQS messages received.
Defaults to 5.
