...
*Supported Attributes :-*
   ...
   14. <<attrib-custom-properties-gcs,custom_properties>>
...
[id="attrib-custom-properties-gcs"]
[float]
==== Custom properties
