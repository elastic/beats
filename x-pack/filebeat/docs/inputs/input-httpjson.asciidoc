...
NOTE: This defaulting to `1` is just to avoid breaking current configurations. V1 configuration is deprecated and will be unsupported in next releases. Any new configuration should use `config_version: 2`.
