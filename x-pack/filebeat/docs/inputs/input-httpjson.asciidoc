...
A link:https://goessner.net/articles/JsonPath/index.html#e2[JSONPath] string to parse values from responses JSON, collected from previous chain steps. Place the same replace string in url where collected values from the previous call should be placed. Required.
