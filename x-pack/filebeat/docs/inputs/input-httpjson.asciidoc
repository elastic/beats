...
| `http_request_errors`                      | Total number of request errors.
| `http_request_delete`                      | Total number of `DELETE` requests.
| `http_request_get`                         | Total number of `GET` requests.
| `http_request_head`                        | Total number of `HEAD` requests.
| `http_request_options`                     | Total number of `OPTIONS` requests.
| `http_request_patch`                       | Total number of `PATCH` requests.
| `http_request_post`                        | Total number of `POST` requests.
| `http_request_put`                         | Total number of `PUT` requests.
| `http_request_body.size`                   | Histogram of the requests body size.
| `http_response_total`                      | Total number of responses received.
| `http_response_errors`                     | Total number of response errors.
| `http_response_1xx`                        | Total number of `1xx` responses.
| `http_response_2xx`                        | Total number of `2xx` responses.
| `http_response_3xx`                        | Total number of `3xx` responses.
| `http_response_4xx`                        | Total number of `4xx` responses.
| `http_response_5xx`                        | Total number of `5xx` responses.
| `http_response_body.size`                  | Histogram of the responses body size.
| `http_round_trip_time`                     | Histogram of the round trip time.
| `httpjson_interval_total`                  | Total number of intervals executed.
| `httpjson_interval_errors`                 | Total number of interval errors.
| `httpjson_interval_execution_time`         | Histogram of the interval execution time.
| `httpjson_interval_pages.total`            | Histogram of the total number of pages per interval.
| `httpjson_interval_pages.execution_time`   | Histogram of the interval pages execution time.
|=======
