...
- `max`: returns the maximum value of a list of integers where at least one value is required. If no values are provided, it returns an error.
- `min`: returns the minimum value of a list of integers where at least one value is required. If no values are provided, it returns an error.
