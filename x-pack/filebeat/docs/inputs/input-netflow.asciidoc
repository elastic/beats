...
A list of paths of field definitions YAML files. The supported formats are
the same used by Logstash's NetFlow codec {logstash-ref}/plugins-codecs-netflow.html#plugins-codecs-netflow-ipfix_definitions[ipfix_definitions]
...
mapping of ECS fields to function correctly.
