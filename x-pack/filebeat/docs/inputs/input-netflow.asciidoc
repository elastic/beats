...
A list of paths of field definitions YAML files. The supported format is
the same used by Logstash's NetFlow codec.

See https://github.com/logstash-plugins/logstash-codec-netflow/blob/master/lib/logstash/codecs/netflow/ipfix.yaml[Sample IPFIX fields]
and https://github.com/logstash-plugins/logstash-codec-netflow/blob/master/lib/logstash/codecs/netflow/netflow.yaml[Sample NetFlow fields.]
