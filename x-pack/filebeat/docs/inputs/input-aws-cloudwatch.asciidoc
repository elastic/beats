...
the `beginning`, `end` or from the last known successful sync (`lastSync`).
...
* When `start_position: lastSync`, reading starts from the last known sync timestamp.
Assuming last sync timestamp stored in the registry is `2020-06-23 12:00:00`,
