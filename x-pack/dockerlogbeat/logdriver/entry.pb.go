...
// source: entry.proto
//
// Vendored from github.com/moby/moby/v2 daemon/logger/internal/logdriver
// which is an internal package not importable by external consumers.
// The proto wire format is unchanged from the original docker/docker package.
