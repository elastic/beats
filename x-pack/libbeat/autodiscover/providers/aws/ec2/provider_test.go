...
import (
	...
	awsauto "github.com/elastic/beats/v9/x-pack/libbeat/autodiscover/providers/aws"
	"github.com/elastic/beats/v9/x-pack/libbeat/autodiscover/providers/aws/test"
