...
* *endpoint*: URL of the entry point for an AWS web service, value is one of `amazonaws.com, amazonaws.com.cn, c2s.ic.gov, sc2s.sgov.gov`, default is `amazonaws.com`.
* *role_arn*: AWS IAM Role to assume.
* *aws_partition*: AWS region partition name, value is one of `aws, aws-cn, aws-us-gov, us-iso-east-1, us-isob-east-1`, default is `aws`.
