...
func init() {
	if err := mb.Registry.AddMetricSet("docker", "node", New, docker.HostParser); err != nil {
		panic(err)
	}
}
...
// This is based on https://docs.docker.com/engine/reference/api/docker_remote_api_v1.24/#/list-nodes.
func (m *MetricSet) Fetch() ([]common.MapStr, error) {
	...
	return eventsMapping(nodes), nil
}
