...
func TestMemoryService_GetMemoryStats(t *testing.T) {
	...
	expectedEvent := common.MapStr{
		...
		"fail.count": memorystats.MemoryStats.Failcnt,
		"limit": memorystats.MemoryStats.Limit,
		"total": common.MapStr{
			"rss":   memorystats.MemoryStats.Stats.TotalRss,
			"rss.pct": float64(memorystats.MemoryStats.Stats.TotalRss) / float64(memorystats.MemoryStats.Limit),
		},
		"usage": common.MapStr{
