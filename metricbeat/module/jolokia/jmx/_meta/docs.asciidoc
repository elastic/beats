...
https://jolokia.org/agent.html[Jolokia agents].
...
2. If `http_method` is set to `GET`, then https://jolokia.org/reference/html/manual/jolokia_protocol.html[Proxy requests]
