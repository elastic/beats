...
func init() {
	mb.Registry.MustAddMetricSet("iis", metricsetName, New, mb.DefaultMetricSet())
}
...
func New(base mb.BaseMetricSet) (mb.MetricSet, error) {
	...
	counters := iis.GetPerfCounters(metricsetName)

	reader, err := iis.NewReader(counters)
	if err != nil {
