...
func init() {
	mb.Registry.MustAddMetricSet(kibana.ModuleName, "node_actions", New,
...
var (
	hostParser = parse.URLHostParserBuilder{
		DefaultScheme: "http",
		DefaultPath:   kibana.NodeActionsPath,
	}.Build()
)
...
func (m *MetricSet) Fetch(r mb.ReporterV2) (err error) {
	...
	if err = m.fetchMetrics(r); err != nil {
		return errors.Wrap(err, "error trying to get node action data from Kibana")
	}
