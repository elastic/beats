...
var (
	schema = s.Schema{
		...
		"elasticsearch_client": c.Dict("elasticsearch_client", s.Schema{
			...
			"connected_nodes":                 c.Int("connected_nodes"),
			"nodes_with_active_sockets":       c.Int("nodes_with_active_sockets"),
			"nodes_with_idle_sockets":         c.Int("nodes_with_idle_sockets"),
			...
			"most_active_node_sockets":        c.Int("most_active_node_sockets"),
			"average_active_sockets_per_node": c.Float("average_active_sockets_per_node"),
			"most_idle_node_sockets":          c.Int("most_idle_node_sockets"),
			"average_idle_sockets_per_node":   c.Float("average_idle_sockets_per_node"),
		}, c.DictOptional),
