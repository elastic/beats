...
- https://docs.mongodb.com/manual/reference/privilege-actions/#collStats[`collStats` action] on collection resources
- https://docs.mongodb.com/manual/reference/privilege-actions/#aggregate[`aggregate` action] on collection resources (for MongoDB 6.2+)
