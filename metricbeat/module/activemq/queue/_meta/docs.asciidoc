Queue Metricset retrieves the JMX key `org.apache.activemq:brokerName=*,destinationName=*,destinationType=Queue,type=Broker` using Jolokia. It exposes the following metrics:
