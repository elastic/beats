...
func (bt *Metricbeat) Run(b *beat.Beat) error {
	...
	factory := module.NewFactory(b.Info, b.Monitoring, b.Paths, bt.registry, moduleOptions...)
	...
	factory = module.NewFactory(b.Info, b.Monitoring, b.Paths, bt.registry, bt.moduleOptions...)
