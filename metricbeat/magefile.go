...
import (
	...
	_ "github.com/menderesk/beats/v7/dev-tools/mage/kubernetes"
	...
	// mage:import
	_ "github.com/menderesk/beats/v7/metricbeat/scripts/mage/target/metricset"
)
...
func MockedTests(ctx context.Context) error {
	...
	params.ExtraFlags = []string{"github.com/menderesk/beats/v7/metricbeat/mb/testing/data/."}
