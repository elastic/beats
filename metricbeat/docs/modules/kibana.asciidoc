...
* <<metricbeat-metricset-kibana-rule,rule>>
...
* <<metricbeat-metricset-kibana-task_manager,task_manager>>

include::kibana/rule.asciidoc[]
...
include::kibana/task_manager.asciidoc[]
