...
By default it enables the metricsets `alert`, `cluster`, `datastore`, `datastorecluster`, `host`, `network`, `resourcepool` and `virtualmachine`.
...
- module: vsphere
  enabled: true
  metricsets: ["alert", cluster", "datastore", "datastorecluster", "host", "network", "resourcepool", "virtualmachine"]
...
* <<metricbeat-metricset-vsphere-alert,alert>>
...
include::vsphere/alert.asciidoc[]
