...
To use credentials requiring an Active Directory domain, separate out the username and password as:
...
You should store sensitive values like passwords in the <<keystore,secrets keystore>>.
