...
- module: windows
  ...
  wmi:
    ...
    include_null_properties: false          # Exclude properties with null values from the output
    include_empty_string_properties: false  # Exclude properties with empty string values from the output
