...
metricbeat.modules:
#- module: docker
  #metricsets: ["cpu", "info", "memory", "network", "diskio", "container", "node", "service"]
...
* <<metricbeat-metricset-docker-node,node>>

* <<metricbeat-metricset-docker-service,service>>
...
include::docker/node.asciidoc[]

include::docker/service.asciidoc[]
