...
*`kubernetes.apiserver.request.latency.le.key`*::
+
--
type: keyword

Request latency, less or equal key


--

*`kubernetes.apiserver.request.latency.le.value`*::
+
--
type: long

Request latency, count value for the provided key
