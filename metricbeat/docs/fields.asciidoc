...
*`kubernetes.apiserver.subresource`*::
+
--
type: keyword
...
*`kubernetes.apiserver.content_type`*::
+
--
type: keyword
...
*`kubernetes.apiserver.component`*::
+
--
type: keyword
