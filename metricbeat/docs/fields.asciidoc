...
Minimum latency that has been reached by the serverreached
...
*`zookeeper.server.version.id`*::
+
--
type: string

Zookeeper version running

--

*`zookeeper.server.version.date`*::
+
--
type: date
