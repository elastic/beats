...
*`ceph.mgr_pool_disk.stats.available.bytes`*::
+
--
...
*`ceph.mgr_pool_disk.stats.used.bytes`*::
+
--
...
*`ceph.mgr_pool_disk.stats.used.kb`*::
+
--
Used kb of the pool
