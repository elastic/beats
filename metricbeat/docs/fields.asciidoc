...
*`linux.pressure.pressure.cpu.some.10.pct`*::
+
--
...
*`linux.pressure.pressure.cpu.some.60.pct`*::
+
--
...
*`linux.pressure.pressure.cpu.some.300.pct`*::
+
--
...
*`linux.pressure.pressure.cpu.some.total.time.us`*::
+
--
...
*`linux.pressure.pressure.memory.some.10.pct`*::
+
--
...
*`linux.pressure.pressure.memory.some.60.pct`*::
+
--
The average share of time in which at least some tasks were stalled on Memory over a 60.pct second window.
...
*`linux.pressure.pressure.memory.some.300.pct`*::
+
--
...
*`linux.pressure.pressure.memory.some.total.time.us`*::
+
--
...
*`linux.pressure.pressure.memory.full.10.pct`*::
+
--
...
*`linux.pressure.pressure.memory.full.60.pct`*::
+
--
...
*`linux.pressure.pressure.memory.full.300.pct`*::
+
--
...
*`linux.pressure.pressure.memory.full.total.time.us`*::
+
--
...
*`linux.pressure.pressure.io.some.10.pct`*::
+
--
...
*`linux.pressure.pressure.io.some.60.pct`*::
+
--
The average share of time in which at least some tasks were stalled on io over a 60.pct second window.
...
*`linux.pressure.pressure.io.some.300.pct`*::
+
--
...
*`linux.pressure.pressure.io.some.total.time.us`*::
+
--
...
*`linux.pressure.pressure.io.full.10.pct`*::
+
--
...
*`linux.pressure.pressure.io.full.60.pct`*::
+
--
...
*`linux.pressure.pressure.io.full.300.pct`*::
+
--
...
*`linux.pressure.pressure.io.full.total.time.us`*::
+
--
