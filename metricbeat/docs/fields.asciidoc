...
*`nats.varz.metrics.metrics.msgs.in`*::
+
--
type: integer
...
*`nats.varz.metrics.metrics.msgs.out`*::
+
--
type: integer
...
*`nats.varz.metrics.metrics.bytes.in`*::
+
--
type: integer
...
*`nats.varz.metrics.metrics.bytes.out`*::
+
--
type: integer
...
*`nats.varz.metrics.metrics.http_req_stats.root_uri`*::
+
--
type: object
...
*`nats.varz.metrics.metrics.http_req_stats.connz_uri`*::
+
--
type: object
...
*`nats.varz.metrics.metrics.http_req_stats.routez_uri`*::
+
--
type: object
...
*`nats.varz.metrics.metrics.http_req_stats.subsz_uri`*::
+
--
type: object
...
*`nats.varz.metrics.metrics.http_req_stats.varz_uri`*::
+
--
type: object
