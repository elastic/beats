...
OSD tree information



*`ceph.mgr_osd_tree.id`*::
+
--
...
*`ceph.mgr_osd_tree.type_id`*::
+
--
OSD or bucket node type ID
...
*`ceph.mgr_osd_tree.crush_weight`*::
+
--
...
*`ceph.mgr_osd_tree.exists`*::
+
--
Node exists (1-yes, 0-no)
...
*`ceph.mgr_osd_tree.primary_affinity`*::
+
--
Weight of reading data from primary OSD
...
*`ceph.mgr_osd_tree.device_class`*::
+
--
Device class of OSD, like HDD, SSD etc.
...
*`ceph.mgr_osd_tree.father`*::
+
--
Parent node of this OSD or bucket node
