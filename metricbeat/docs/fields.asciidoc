...
alias to: logstash.node.stats.os.cgroup.stat.number_of_elapsed_periods
...
alias to: logstash.node.stats.os.cgroup.stat.time_throttled_nanos
...
alias to: logstash.node.stats.os.cgroup.stat.number_of_times_throttled
...
*`logstash.stats.jvm.mem.heap_used.bytes`*::
+
--
type: alias
...
*`logstash.stats.jvm.mem.heap_max.bytes`*::
+
--
type: alias
...
*`logstash.stats.events.duration.ms`*::
+
--
type: alias
...
*`logstash.stats.os.cpu.load_average.15m`*::
+
--
type: alias
...
*`logstash.stats.os.cpu.load_average.5m`*::
+
--
type: alias
...
*`logstash.stats.os.cgroup.cpuacct.usage_nanos`*::
+
--
type: alias
...
*`logstash.stats.os.cpu.stat.number_of_elapsed_periods`*::
+
--
type: alias
...
*`logstash.stats.os.cpu.stat.number_of_times_throttled`*::
+
--
type: alias
...
*`logstash.stats.queue.events_count`*::
+
--
type: alias
...
*`logstash.node.stats.os.cgroup.cpuact.usage_nanos`*::
+
--
TODO
