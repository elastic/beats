...
*`node_stats.indexing_pressure.elasticsearch.node.stats.indexing_pressure.memory.current.combined_coordinating_and_primary_in_bytes`*::
+
--
type: alias

alias to: elasticsearch.node.stats.indexing_pressure.memory.current.combined_coordinating_and_primary_in_bytes

--

*`node_stats.indexing_pressure.memory.total.combined_coordinating_and_primary_in_bytes`*::
+
--
type: alias

alias to: elasticsearch.node.stats.indexing_pressure.memory.total.combined_coordinating_and_primary_in_bytes

--

*`node_stats.indexing_pressure.memory.current.coordinating_in_bytes`*::
+
--
type: alias

alias to: elasticsearch.node.stats.indexing_pressure.memory.current.coordinating_in_bytes

--

*`node_stats.indexing_pressure.memory.total.coordinating_in_bytes`*::
+
--
type: alias

alias to: elasticsearch.node.stats.indexing_pressure.memory.total.coordinating_in_bytes

--

*`node_stats.indexing_pressure.limit_in_bytes`*::
+
--
type: alias

alias to: elasticsearch.node.stats.indexing_pressure.limit_in_bytes
...
*`elasticsearch.node.stats.indexing_pressure.elasticsearch.node.stats.indexing_pressure.memory.current.combined_coordinating_and_primary_in_bytes`*::
+
--
type: alias
...
*`elasticsearch.node.stats.indexing_pressure.memory.total.combined_coordinating_and_primary_in_bytes`*::
+
--
type: alias
...
*`elasticsearch.node.stats.indexing_pressure.memory.current.coordinating_in_bytes`*::
+
--
type: alias
...
*`elasticsearch.node.stats.indexing_pressure.memory.total.coordinating_in_bytes`*::
+
--
type: alias
...
*`elasticsearch.node.stats.indexing_pressure.limit_in_bytes`*::
+
--
type: alias
