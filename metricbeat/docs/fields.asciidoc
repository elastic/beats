...
The process associated with the service. For systemd, this is the main pid spawned by systemd itself.


*`system.service.process.pid`*::
+
--
...
*`system.service.process.exec_code`*::
+
--
...
*`system.service.process.exec_rc`*::
+
--
