...
`process_list` show the output of the SHOW PROCESSLIST query




*`mysql.process_list.process.list.time`*::
+
--
...
*`mysql.process_list.process.list.state`*::
+
--
...
*`mysql.process_list.process.list.db`*::
+
--
...
*`mysql.process_list.process.list.id`*::
+
--
...
*`mysql.process_list.process.list.user`*::
+
--
...
*`mysql.process_list.process.list.host`*::
+
--
...
*`mysql.process_list.process.list.command`*::
+
--
...
*`mysql.process_list.process.list.info`*::
+
--
The statement the thread is executing, or NULL if it is executing no statement.
