...
*`ceph.mgr_cluster_health.monmap.mons.public_addrs.addrvec`*::
+
--
...
*`ceph.mgr_cluster_health.pgmap.pgs_by_state`*::
+
--
...
*`ceph.mgr_cluster_health.fsmap.by_rank`*::
+
--
...
*`ceph.mgr_osd_perf.osdstats.osd_perf_infos`*::
+
--
...
`stray` contains stray OSD nodes.



*`ceph.mgr_osd_tree.stray.name`*::
+
--
Node name
...
*`ceph.mgr_osd_tree.stray.type_id`*::
+
--
Type ID
...
*`ceph.mgr_osd_tree.stray.children`*::
+
--
Node children
...
*`ceph.mgr_osd_tree.stray.reweight`*::
+
--
Reweight
...
*`ceph.mgr_osd_tree.stray.status`*::
+
--
Node status
...
*`ceph.mgr_osd_tree.stray.primary_affinity`*::
+
--
Primary affinity
...
*`ceph.mgr_osd_tree.stray.crush_weight`*::
+
--
CRUSH weight
