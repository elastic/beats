...
*`envoyproxy.server.listener.admin.downstream_cx_active`*::
+
--
type: integer
...
*`envoyproxy.server.listener.admin.downstream_cx_destroy`*::
+
--
type: integer
...
*`envoyproxy.server.listener.admin.downstream_cx_total`*::
+
--
type: integer
...
*`envoyproxy.server.listener.admin.http.admin.downstream_rq_1xx`*::
+
--
type: integer
...
*`envoyproxy.server.listener.admin.http.admin.downstream_rq_2xx`*::
+
--
type: integer
...
*`envoyproxy.server.listener.admin.http.admin.downstream_rq_3xx`*::
+
--
type: integer
...
*`envoyproxy.server.listener.admin.http.admin.downstream_rq_4xx`*::
+
--
type: integer
...
*`envoyproxy.server.listener.admin.http.admin.downstream_rq_5xx`*::
+
--
type: integer
...
*`envoyproxy.server.http.admin.downstream_cx_active`*::
+
--
type: integer
...
*`envoyproxy.server.http.admin.downstream_cx_destroy`*::
+
--
type: integer
...
*`envoyproxy.server.http.admin.downstream_cx_destroy_active_rq`*::
+
--
type: integer
...
*`envoyproxy.server.http.admin.downstream_cx_destroy_local`*::
+
--
type: integer
...
*`envoyproxy.server.http.admin.downstream_cx_destroy_local_active_rq`*::
+
--
type: integer
...
*`envoyproxy.server.http.admin.downstream_cx_destroy_remote`*::
+
--
type: integer
...
*`envoyproxy.server.http.admin.downstream_cx_destroy_remote_active_rq`*::
+
--
type: integer
...
*`envoyproxy.server.http.admin.downstream_cx_drain_close`*::
+
--
type: integer
...
*`envoyproxy.server.http.admin.downstream_cx_http1_active`*::
+
--
type: integer
...
*`envoyproxy.server.http.admin.downstream_cx_http1_total`*::
+
--
type: integer
...
*`envoyproxy.server.http.admin.downstream_cx_http2_active`*::
+
--
type: integer
...
*`envoyproxy.server.http.admin.downstream_cx_http2_total`*::
+
--
type: integer
...
*`envoyproxy.server.http.admin.downstream_cx_idle_timeout`*::
+
--
type: integer
...
*`envoyproxy.server.http.admin.downstream_cx_protocol_error`*::
+
--
type: integer
...
*`envoyproxy.server.http.admin.downstream_cx_rx_bytes_buffered`*::
+
--
type: integer
...
*`envoyproxy.server.http.admin.downstream_cx_rx_bytes_total`*::
+
--
type: integer
...
*`envoyproxy.server.http.admin.downstream_cx_ssl_active`*::
+
--
type: integer
...
*`envoyproxy.server.http.admin.downstream_cx_ssl_total`*::
+
--
type: integer
...
*`envoyproxy.server.http.admin.downstream_cx_total`*::
+
--
type: integer
...
*`envoyproxy.server.http.admin.downstream_cx_tx_bytes_buffered`*::
+
--
type: integer
...
*`envoyproxy.server.http.admin.downstream_cx_tx_bytes_total`*::
+
--
type: integer
...
*`envoyproxy.server.http.admin.downstream_cx_websocket_active`*::
+
--
type: integer
...
*`envoyproxy.server.http.admin.downstream_cx_websocket_total`*::
+
--
type: integer
...
*`envoyproxy.server.http.admin.downstream_flow_control_paused_reading_total`*::
+
--
type: integer
...
*`envoyproxy.server.http.admin.downstream_flow_control_resumed_reading_total`*::
+
--
type: integer
...
*`envoyproxy.server.http.admin.downstream_rq_1xx`*::
+
--
type: integer
...
*`envoyproxy.server.http.admin.downstream_rq_2xx`*::
+
--
type: integer
...
*`envoyproxy.server.http.admin.downstream_rq_3xx`*::
+
--
type: integer
...
*`envoyproxy.server.http.admin.downstream_rq_4xx`*::
+
--
type: integer
...
*`envoyproxy.server.http.admin.downstream_rq_5xx`*::
+
--
type: integer
...
*`envoyproxy.server.http.admin.downstream_rq_active`*::
+
--
type: integer
...
*`envoyproxy.server.http.admin.downstream_rq_http1_total`*::
+
--
type: integer
...
*`envoyproxy.server.http.admin.downstream_rq_http2_total`*::
+
--
type: integer
...
*`envoyproxy.server.http.admin.downstream_rq_non_relative_path`*::
+
--
type: integer
...
*`envoyproxy.server.http.admin.downstream_rq_response_before_rq_complete`*::
+
--
type: integer
...
*`envoyproxy.server.http.admin.downstream_rq_rx_reset`*::
+
--
type: integer
...
*`envoyproxy.server.http.admin.downstream_rq_too_large`*::
+
--
type: integer
...
*`envoyproxy.server.http.admin.downstream_rq_total`*::
+
--
type: integer
...
*`envoyproxy.server.http.admin.downstream_rq_tx_reset`*::
+
--
type: integer
...
*`envoyproxy.server.http.admin.downstream_rq_ws_on_non_ws_route`*::
+
--
type: integer
...
*`envoyproxy.server.http.admin.rs_too_large`*::
+
--
type: integer
...
*`envoyproxy.server.http.async-client.no_cluster`*::
+
--
type: integer
...
*`envoyproxy.server.http.async-client.no_route`*::
+
--
type: integer
...
*`envoyproxy.server.http.async-client.rq_direct_response`*::
+
--
type: integer
...
*`envoyproxy.server.http.async-client.rq_redirect`*::
+
--
type: integer
...
*`envoyproxy.server.http.async-client.rq_total`*::
+
--
type: integer
