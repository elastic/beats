...
*`kubernetes.container.unit`*::
+
--
Resource kind metric unit

type: keyword

--

*`kubernetes.container.reason`*::
+
--
Reason for resource status change
...
*`kubernetes.container.status.restarts.count`*::
+
--
...
+
--
The namespace of the job resource
...
+
--
Whether the job completed/failed
...
+
--
Whether the owner is controller
...
+
--
The unix time at which the job completed
...
+
--
Kubernetes pod scheduled status
