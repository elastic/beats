...
go http based process profiling information.
...
unique id shared by all events of the same profiling run.
...
[float]
=== goprof.memprof.summary.alloc_objects.count
...
[float]
=== goprof.memprof.summary.alloc_space.count
...
[float]
=== goprof.memprof.summary.inuse_objects.count

type: long

Number of objects not being collected by garbage collector.

[float]
=== goprof.memprof.summary.inuse_space.count

type: long

format: bytes

Amount of space not being collected by garbage collector.
...
[float]
=== goprof.memprof.function.package

type: keyword

The function its package name

[float]
=== goprof.memprof.function.name
...
[float]
=== goprof.memprof.function.file

type: keyword

The file name in package the function is defined in
...
[float]
=== goprof.memprof.function.self.alloc_objects.count
...
[float]
=== goprof.memprof.function.self.alloc_space.count
...
[float]
=== goprof.memprof.function.self.inuse_objects.count
...
[float]
=== goprof.memprof.function.self.inuse_space.count
...
Cummulative allocation statistics including the function itself and all functions being called directly or indirectly.



[float]
=== goprof.memprof.function.total.alloc_objects.count
...
[float]
=== goprof.memprof.function.total.alloc_space.count
...
[float]
=== goprof.memprof.function.total.inuse_objects.count
...
[float]
=== goprof.memprof.function.total.inuse_space.count
...
Cummulative allocation statistics including all functions being called directly or indirectly, but not the current function itself.



[float]
=== goprof.memprof.function.children.alloc_objects.count
...
[float]
=== goprof.memprof.function.children.alloc_space.count
...
[float]
=== goprof.memprof.function.children.inuse_objects.count
...
[float]
=== goprof.memprof.function.children.inuse_space.count
...
[float]
=== goprof.memprof.edge_allocation.parent.package
...
[float]
=== goprof.memprof.edge_allocation.parent.name
...
[float]
=== goprof.memprof.edge_allocation.parent.file
...
[float]
=== goprof.memprof.edge_allocation.child.package
...
[float]
=== goprof.memprof.edge_allocation.child.name
...
[float]
=== goprof.memprof.edge_allocation.child.file
...
[float]
=== goprof.memprof.edge_allocation.stats.alloc_objects.count
...
[float]
=== goprof.memprof.edge_allocation.stats.alloc_space.count
...
[float]
=== goprof.memprof.edge_allocation.stats.inuse_objects.count
...
[float]
=== goprof.memprof.edge_allocation.stats.inuse_space.count
...
[float]
=== goprof.memprof.allocation.package
...
[float]
=== goprof.memprof.allocation.function
...
[float]
=== goprof.memprof.allocation.file
...
[float]
=== goprof.memprof.allocation.line

type: integer

The file its line the allocation happened.

[float]
=== goprof.memprof.allocation.address

type: long

Executable in memory location the allocation happened at.
...
[float]
=== goprof.memprof.allocation.stats.alloc_objects.count
...
[float]
=== goprof.memprof.allocation.stats.alloc_space.count
...
[float]
=== goprof.memprof.allocation.stats.inuse_objects.count
...
[float]
=== goprof.memprof.allocation.stats.inuse_space.count
...
[float]
=== goprof.memstats.gc_summary.next_gc_limit

type: long

format: bytes

Upper bound of memory being allocated until another garbage collection phase will be run.


[float]
=== goprof.memstats.gc_summary.gc_count
...
[float]
== gc_total_pause Fields

Total duration of all garbage collection cycles


[float]
=== goprof.memstats.gc_summary.gc_total_pause.ns
...
[float]
=== goprof.memstats.heap.allocations.mallocs
...
[float]
=== goprof.memstats.heap.allocations.frees
...
[float]
=== goprof.memstats.heap.allocations.objects
...
[float]
=== goprof.memstats.heap.allocations.total
...
[float]
=== goprof.memstats.heap.allocations.allocated
...
[float]
=== goprof.memstats.heap.allocations.idle
...
[float]
=== goprof.memstats.heap.allocations.active
...
[float]
=== goprof.memstats.heap.system.total
...
[float]
=== goprof.memstats.heap.system.obtained
...
[float]
=== goprof.memstats.heap.system.stack
...
[float]
=== goprof.memstats.heap.system.released
...
Go runtime allocator per size class counters.



[float]
=== goprof.memstats.allocator.size
...
[float]
=== goprof.memstats.allocator.allocations
...
[float]
=== goprof.memstats.allocator.frees
...
Go per garbage collection cycle counters.



[float]
=== goprof.memstats.gc_cycle.run
...
[float]
=== goprof.memstats.gc_cycle.start
...
[float]
=== goprof.memstats.gc_cycle.duration.ns
