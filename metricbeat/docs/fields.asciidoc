...
*`kibana.rule.lastExecutionDuration`*::
+
--
type: long
...
*`kibana.rule.lastExecutionTimeout`*::
+
--
type: date
...
*`kibana.task_manager.kibana.status`*::
+
--
type: keyword
