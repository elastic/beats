...
*`ceph.mgr_cluster_health.overall_status`*::
+
--
Overall status of the cluster
...
*`ceph.mgr_cluster_health.timechecks.epoch`*::
+
--
Map version
...
*`ceph.mgr_cluster_health.timechecks.round.value`*::
+
--
timecheck round
...
*`ceph.mgr_cluster_health.timechecks.round.status`*::
+
--
Status of the round
