...
[float]
== cluster.pending_tasks fields

`cluster.pending_tasks` contains pending tasks description.



*`elasticsearch.cluster.pending_tasks.time_in_queue`*::
+
--
type: keyword

Time in queue with unit (ms)


--

*`elasticsearch.cluster.pending_tasks.insert_order`*::
+
--
type: long
...
*`elasticsearch.cluster.pending_tasks.priority`*::
+
--
type: long
...
*`elasticsearch.cluster.pending_tasks.source`*::
+
--
type: keyword
...
*`elasticsearch.cluster.pending_tasks.time_in_queue_millis`*::
+
--
type: long
...
[float]
== cluster.pending_tasks_summary fields

Summary metrics for the pending tasks on elasticsearch.



*`elasticsearch.cluster.pending_tasks_summary.max_time_in_queue_millis`*::
+
--
type: long

Max time in queue (ms)


--

*`elasticsearch.cluster.pending_tasks_summary.count_priority_high`*::
+
--
type: long

Number of pending tasks in priority high


--

*`elasticsearch.cluster.pending_tasks_summary.count_priority_urgent`*::
+
--
type: long

Number of pending tasks in priority urgent


--

*`elasticsearch.cluster.pending_tasks_summary.count_total`*::
+
--
type: long

Number of pendings tasks 
