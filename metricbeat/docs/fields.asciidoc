...
*`iis.application_pool.net_clr.bytes_in_all_heaps`*::
+
--
...
*`iis.application_pool.net_clr.gen_0_collections`*::
+
--
...
*`iis.application_pool.net_clr.gen_1_collections`*::
+
--
...
*`iis.application_pool.net_clr.gen_2_collections`*::
+
--
...
*`iis.application_pool.net_clr.total_committed_bytes`*::
+
--
...
*`iis.application_pool.net_clr.allocated_bytes_per_sec`*::
+
--
Allocated Bytes/sec.
...
*`iis.application_pool.net_clr.gen_0_heap_size`*::
+
--
Gen 0 heap size.
...
*`iis.application_pool.net_clr.gen_1_heap_size`*::
+
--
Gen 1 heap size.
...
*`iis.application_pool.net_clr.gen_2_heap_size`*::
+
--
Gen 2 heap size.
...
*`iis.application_pool.net_clr.large_object_heap_size`*::
+
--
...
*`iis.application_pool.net_clr.time_in_gc_perc`*::
+
--
% Time in GC.
...
*`iis.application_pool.net_clr.contention_rate_per_sec`*::
+
--
Contention Rate / sec.
...
*`iis.application_pool.net_clr.current_queue_length`*::
+
--
