...
*`vsphere.resourcepool.cpu.entitlment.mhz`*::
+
--
...
*`vsphere.resourcepool.cpu.entitlment.static.mhz`*::
+
--
...
*`vsphere.resourcepool.memory.usage.entitlement.bytes`*::
+
--
This is the amount of memory, in bytes, that this VM is entitled to, as calculated by DRS.
...
*`vsphere.resourcepool.memory.usage.entitlement.static.mhz`*::
+
--
...
*`vsphere.resourcepool.memory.usage.private.bytes`*::
+
--
...
*`vsphere.resourcepool.memory.usage.shared.bytes`*::
+
--
...
*`vsphere.resourcepool.memory.usage.swapped.bytes`*::
+
--
...
*`vsphere.resourcepool.memory.usage.ballooned.bytes`*::
+
--
...
*`vsphere.resourcepool.memory.usage.overhead.bytes`*::
+
--
...
*`vsphere.resourcepool.memory.usage.overhead.consumed.bytes`*::
+
--
...
*`vsphere.resourcepool.memory.usage.compressed.bytes`*::
+
--
