...
`ibmmq` contains statistics that were read from IBM MQ
...
Contains statistics related to Queue Manager


*`ibmmq.qmgr.mqca_alteration_date`*::
+
--
...
*`ibmmq.qmgr.mqca_alteration_time`*::
+
--
...
*`ibmmq.qmgr.mqca_channel_auto_def_exit`*::
+
--
...
*`ibmmq.qmgr.mqca_cluster_workload_data`*::
+
--
...
*`ibmmq.qmgr.mqca_cluster_workload_exit`*::
+
--
...
*`ibmmq.qmgr.mqca_command_input_q_name`*::
+
--
...
*`ibmmq.qmgr.mqca_creation_date`*::
+
--
Queue creation date, in the form yyyy-mm-dd

type: text

--

*`ibmmq.qmgr.mqca_creation_time`*::
+
--
Creation time, in the form hh.mm.ss

type: text

--

*`ibmmq.qmgr.mqca_custom`*::
+
--
...
*`ibmmq.qmgr.mqca_dead_letter_q_name`*::
+
--
Dead letter (undelivered message) queue name.

type: text

--

*`ibmmq.qmgr.mqca_def_xmit_q_name`*::
+
--
...
*`ibmmq.qmgr.mqca_installation_desc`*::
+
--
...
*`ibmmq.qmgr.mqca_installation_name`*::
+
--
...
*`ibmmq.qmgr.mqca_installation_path`*::
+
--
...
*`ibmmq.qmgr.mqca_parent`*::
+
--
The name of the hierarchically connected queue manager nominated as the parent of this queue manager.

type: text

--

*`ibmmq.qmgr.mqca_q_mgr_desc`*::
+
--
...
*`ibmmq.qmgr.mqca_q_mgr_identifier`*::
+
--
...
*`ibmmq.qmgr.mqca_repository_name`*::
+
--
...
*`ibmmq.qmgr.mqca_repository_namelist`*::
+
--
...
*`ibmmq.qmgr.mqca_ssl_crl_namelist`*::
+
--
The SSL certificate revocation location namelist

type: text

--

*`ibmmq.qmgr.mqca_ssl_crypto_hardware`*::
+
--
Parameters to configure the SSL cryptographic hardware

type: text

--

*`ibmmq.qmgr.mqca_ssl_key_repository`*::
+
--
...
*`ibmmq.qmgr.mqca_version`*::
+
--
The version of the IBM MQ code.

type: text

--

*`ibmmq.qmgr.mqcacf_archive_log_extent_name`*::
+
--
None
...
*`ibmmq.qmgr.mqcacf_current_log_extent_name`*::
+
--
...
*`ibmmq.qmgr.mqcacf_media_log_extent_name`*::
+
--
None
...
*`ibmmq.qmgr.mqcacf_q_mgr_start_date`*::
+
--
Date when this queue manager was started (in the form yyyy-mm-dd).

type: text

--

*`ibmmq.qmgr.mqcacf_q_mgr_start_time`*::
+
--
Time when this queue manager was started (in the form hh:mm:ss).

type: text

--

*`ibmmq.qmgr.mqcacf_restart_log_extent_name`*::
+
--
None
...
*`ibmmq.qmgr.mqia_accounting_conn_override`*::
+
--
Specifies whether applications can override the settings of the QueueAccounting and MQIAccounting queue manager parameters.

type: integer

--

*`ibmmq.qmgr.mqia_accounting_interval`*::
+
--
type: integer
...
*`ibmmq.qmgr.mqia_accounting_mqi`*::
+
--
None
...
*`ibmmq.qmgr.mqia_activity_conn_override`*::
+
--
Specifies whether applications can override the setting of the ACTVTRC value in the queue manager attribute.

type: integer

--

*`ibmmq.qmgr.mqia_activity_recording`*::
+
--
...
*`ibmmq.qmgr.mqia_activity_trace`*::
+
--
Whether activity reports can be generated.
...
*`ibmmq.qmgr.mqia_advanced_capability`*::
+
--
None
...
*`ibmmq.qmgr.mqia_amqp_capability`*::
+
--
None
...
*`ibmmq.qmgr.mqia_authority_event`*::
+
--
None
...
*`ibmmq.qmgr.mqia_cert_val_policy`*::
+
--
Specifies which SSL/TLS certificate validation policy is used to validate digital certificates received from remote partner systems

type: integer

--

*`ibmmq.qmgr.mqia_channel_auto_def`*::
+
--
...
*`ibmmq.qmgr.mqia_channel_auto_def_event`*::
+
--
Controls whether channel auto-definition events are generated, when a receiver, server-connection, or cluster-sender channel is auto-defined.

type: integer

--

*`ibmmq.qmgr.mqia_channel_event`*::
+
--
Controls whether channel events are generated.

type: integer

--

*`ibmmq.qmgr.mqia_chinit_control`*::
+
--
Start the channel initiator during queue manager start.

type: integer

--

*`ibmmq.qmgr.mqia_chlauth_records`*::
+
--
None
...
*`ibmmq.qmgr.mqia_cluster_workload_length`*::
+
--
...
*`ibmmq.qmgr.mqia_clwl_mru_channels`*::
+
--
Cluster workload most recently used (MRU) channels.

type: integer

--

*`ibmmq.qmgr.mqia_clwl_useq`*::
+
--
Use of remote queue. Specifies whether a cluster queue manager is to use remote puts to other queues defined in other queue managers within the cluster during workload management.

type: integer

--

*`ibmmq.qmgr.mqia_cmd_server_control`*::
+
--
Start the command server during queue manager start.

type: integer

--

*`ibmmq.qmgr.mqia_coded_char_set_id`*::
+
--
None
...
*`ibmmq.qmgr.mqia_configuration_event`*::
+
--
...
*`ibmmq.qmgr.mqia_def_cluster_xmit_q_type`*::
+
--
...
*`ibmmq.qmgr.mqia_inhibit_event`*::
+
--
Controls whether inhibit.

type: integer

--

*`ibmmq.qmgr.mqia_ip_address_version`*::
+
--
...
*`ibmmq.qmgr.mqia_logger_event`*::
+
--
Controls whether recovery log events are generated.

type: integer

--

*`ibmmq.qmgr.mqia_max_handles`*::
+
--
...
*`ibmmq.qmgr.mqia_max_msg_length`*::
+
--
...
*`ibmmq.qmgr.mqia_max_properties_length`*::
+
--
...
*`ibmmq.qmgr.mqia_max_uncommitted_msgs`*::
+
--
...
*`ibmmq.qmgr.mqia_media_image_interval`*::
+
--
None
...
*`ibmmq.qmgr.mqia_media_image_log_length`*::
+
--
None
...
*`ibmmq.qmgr.mqia_media_image_recover_obj`*::
+
--
None
...
*`ibmmq.qmgr.mqia_media_image_recover_q`*::
+
--
None
...
*`ibmmq.qmgr.mqia_monitoring_auto_clussdr`*::
+
--
None
...
*`ibmmq.qmgr.mqia_monitoring_channel`*::
+
--
Default setting for online monitoring for channels.

type: integer

--

*`ibmmq.qmgr.mqia_monitoring_q`*::
+
--
None
...
*`ibmmq.qmgr.mqia_msg_mark_browse_interval`*::
+
--
None
...
*`ibmmq.qmgr.mqia_performance_event`*::
+
--
...
*`ibmmq.qmgr.mqia_prot_policy_capability`*::
+
--
If the IBM MQ AMS component is installed for the version of IBM MQ that the queue manager is running under.

type: integer

--

*`ibmmq.qmgr.mqia_pubsub_cluster`*::
+
--
Controls whether the queue manager participates in publish/subscribe clustering.

type: integer

--

*`ibmmq.qmgr.mqia_pubsub_maxmsg_retry_count`*::
+
--
The number of attempts to reprocess a failed command message under sync point.

type: integer

--

*`ibmmq.qmgr.mqia_pubsub_mode`*::
+
--
Specifies whether the publish/subscribe engine and the queued publish/subscribe interface are running.

type: integer

--

*`ibmmq.qmgr.mqia_pubsub_np_msg`*::
+
--
...
*`ibmmq.qmgr.mqia_pubsub_np_resp`*::
+
--
...
*`ibmmq.qmgr.mqia_pubsub_sync_pt`*::
+
--
...
*`ibmmq.qmgr.mqia_reverse_dns_lookup`*::
+
--
Whether reverse lookup of the host name from a Domain Name Server is carried out.

type: integer

--

*`ibmmq.qmgr.mqia_ssl_event`*::
+
--
Controls whether SSL events are generated.

type: integer

--

*`ibmmq.qmgr.mqia_ssl_fips_required`*::
+
--
Controls whether only FIPS-certified algorithms are to be used if cryptography is executed in IBM MQ itself.

type: integer

--

*`ibmmq.qmgr.mqia_ssl_reset_count`*::
+
--
...
*`ibmmq.qmgr.mqia_start_stop_event`*::
+
--
...
*`ibmmq.qmgr.mqia_statistics_auto_clussdr`*::
+
--
None
...
*`ibmmq.qmgr.mqia_statistics_channel`*::
+
--
...
*`ibmmq.qmgr.mqia_statistics_interval`*::
+
--
...
*`ibmmq.qmgr.mqia_statistics_mqi`*::
+
--
None
...
*`ibmmq.qmgr.mqia_suite_b_strength_0`*::
+
--
None
...
*`ibmmq.qmgr.mqia_suite_b_strength_1`*::
+
--
None
...
*`ibmmq.qmgr.mqia_suite_b_strength_2`*::
+
--
None
...
*`ibmmq.qmgr.mqia_suite_b_strength_3`*::
+
--
None
...
*`ibmmq.qmgr.mqia_trace_route_recording`*::
+
--
...
*`ibmmq.qmgr.mqia_tree_life_time`*::
+
--
...
*`ibmmq.qmgr.mqia_trigger_interval`*::
+
--
Trigger interval.
...
*`ibmmq.qmgr.mqia_xr_capability`*::
+
--
Specifies whether the IBM MQ Telemetry capability and commands are supported by the queue manager.

type: integer

--

*`ibmmq.qmgr.mqiacf_archive_log_size`*::
+
--
None
...
*`ibmmq.qmgr.mqiacf_chinit_status`*::
+
--
None
...
*`ibmmq.qmgr.mqiacf_cmd_server_status`*::
+
--
None
...
*`ibmmq.qmgr.mqiacf_connection_count`*::
+
--
...
*`ibmmq.qmgr.mqiacf_ldap_connection_status`*::
+
--
None
...
*`ibmmq.qmgr.mqiacf_log_utilization`*::
+
--
None
...
*`ibmmq.qmgr.mqiacf_media_log_size`*::
+
--
None
...
*`ibmmq.qmgr.mqiacf_permit_standby`*::
+
--
None
...
*`ibmmq.qmgr.mqiacf_q_mgr_status`*::
+
--
None
...
*`ibmmq.qmgr.mqiacf_restart_log_size`*::
+
--
None
...
*`ibmmq.qmgr.mqiacf_reusable_log_size`*::
+
--
None
