...
The count of all docs.    


[float]
=== `elasticsearch.cluster.stats.indices.segments.count`

type: long

The count of all segments.   
...
[float]
=== `elasticsearch.cluster.stats.nodes.count.total`
...
[float]
=== `elasticsearch.cluster.stats.nodes.jvm.mem.heap.used`
...
[float]
=== `elasticsearch.cluster.stats.nodes.jvm.mem.heap.max`
...
[float]
=== `elasticsearch.cluster.stats.nodes.fs.free.bytes`
