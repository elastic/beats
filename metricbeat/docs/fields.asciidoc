...
+
--
Sum of requests latency in microseconds
...
+
--
Requests latency distribution in histogram buckets
...
+
--
Requests size distribution in histogram buckets
...
+
--
Responses size distribution in histogram buckets
...
*`kubernetes.scheduler.scheduling.attempts.count`*::
+
--
Number of attempts to schedule pod
...
+
--
Scheduling attempt latency distribution in histogram buckets
...
+
--
Sum of scheduling attempt latency in microseconds
