...
`mesos` contains statistics that were read from Mesos
...
*`mesos.master.master.cpus_percent`*::
+
--
type: long
...
*`mesos.master.master.disk_percent`*::
+
--
type: long
...
*`mesos.master.master.mem_percent`*::
+
--
type: long
...
*`mesos.master.master.uptime_secs`*::
+
--
type: long
...
*`mesos.master.master.slave_reregistrations`*::
+
--
type: long
...
*`mesos.master.master.slaves_active`*::
+
--
type: long
...
*`mesos.master.master.slaves_disconnected`*::
+
--
type: long
...
*`mesos.master.master.tasks_error`*::
+
--
type: long
...
*`mesos.master.master.tasks_failed`*::
+
--
type: long
...
*`mesos.master.master.tasks_finished`*::
+
--
type: long
...
*`mesos.master.master.tasks_killed`*::
+
--
type: long
...
*`mesos.master.master.tasks_lost`*::
+
--
type: long
...
*`mesos.master.master.tasks_running`*::
+
--
type: long
...
*`mesos.master.master.tasks_starting`*::
+
--
type: long
...
*`mesos.master.master.invalid_operation_status_update_acknowledgements`*::
+
--
type: long
...
*`mesos.master.master.messages_decline_offers`*::
+
--
type: long
...
*`mesos.master.master.messages_kill_task`*::
+
--
type: long
...
*`mesos.master.master.messages_operation_status_update_acknowledgement`*::
+
--
type: long
...
*`mesos.master.master.messages_reconcile_operations`*::
+
--
type: long
...
*`mesos.master.master.recovery_slave_removals`*::
+
--
type: long
...
*`mesos.master.master.valid_operation_status_update_acknowledgements`*::
+
--
type: long
...
*`mesos.master.master.operator_event_stream_subscribers`*::
+
--
type: long
...
*`mesos.master.system.mem_free_bytes`*::
+
--
type: long
...
[float]
== allocation_run_latency_MS fields
...
*`mesos.master.allocator.mesos.resources.mem.total`*::
+
--
type: long
