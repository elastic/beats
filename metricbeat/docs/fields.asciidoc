...
+
--
The total uptime of a host in the vSphere environment.
...
*`vsphere.host.disk.throughput.bytes`*::
+
--
The average disk throughput usage over a specified interval.
...
*`vsphere.host.disk.device.latency.ms`*::
+
--
