...
*`system.services.exec_rc`*::
+
--
The exit code of the service's main process

type: long

--

*`system.services.state_since`*::
+
--
...
*`system.services.main_pid`*::
+
--
the main PID of the service.
...
*`system.services.resources.cpu.usage.nsec`*::
+
--
...
*`system.services.resources.memory.usage.bytes`*::
+
--
...
*`system.services.resources.tasks.count`*::
+
--
...
*`system.services.resources.network.bytes.in`*::
+
--
bytes in
...
*`system.services.resources.network.bytes.out`*::
+
--
bytes out
...
*`system.services.resources.network.packets.in`*::
+
--
packets in
...
*`system.services.resources.network.packets.out`*::
+
--
packets out
