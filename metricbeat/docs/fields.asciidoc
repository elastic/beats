...
*`openai.usage.data.organization_id`*::
+
--
...
*`openai.usage.data.organization_name`*::
+
--
Organization name
...
*`openai.usage.data.aggregation_timestamp`*::
+
--
...
*`openai.usage.data.n_context_tokens_total`*::
+
--
...
*`openai.usage.data.n_generated_tokens_total`*::
+
--
...
*`openai.usage.data.n_cached_context_tokens_total`*::
+
--
...
*`openai.usage.data.api_key_name`*::
+
--
API key name
...
*`openai.usage.data.api_key_redacted`*::
+
--
Redacted API key
...
*`openai.usage.data.api_key_type`*::
+
--
Type of API key
...
*`openai.usage.data.project_name`*::
+
--
Project name
...
*`openai.usage.dalle.num_requests`*::
+
--
Number of requests
...
*`openai.usage.dalle.organization_id`*::
+
--
Organization identifier
...
*`openai.usage.dalle.api_key_name`*::
+
--
API key name
...
*`openai.usage.dalle.api_key_redacted`*::
+
--
Redacted API key
...
*`openai.usage.dalle.api_key_type`*::
+
--
Type of API key
...
*`openai.usage.dalle.organization_name`*::
+
--
Organization name
...
*`openai.usage.dalle.project_name`*::
+
--
Project name
...
*`openai.usage.whisper.timestamp`*::
+
--
Timestamp of request
...
*`openai.usage.whisper.num_requests`*::
+
--
Number of requests
...
*`openai.usage.whisper.organization_id`*::
+
--
Organization identifier
...
*`openai.usage.whisper.api_key_id`*::
+
--
API key identifier
...
*`openai.usage.whisper.api_key_name`*::
+
--
API key name
...
*`openai.usage.whisper.api_key_redacted`*::
+
--
Redacted API key
...
*`openai.usage.whisper.api_key_type`*::
+
--
Type of API key
...
*`openai.usage.whisper.organization_name`*::
+
--
Organization name
...
*`openai.usage.whisper.project_id`*::
+
--
Project identifier
...
*`openai.usage.whisper.project_name`*::
+
--
Project name
...
*`openai.usage.tts.organization_id`*::
+
--
Organization identifier
...
*`openai.usage.tts.api_key_redacted`*::
+
--
Redacted API key
...
*`openai.usage.tts.organization_name`*::
+
--
Organization name
