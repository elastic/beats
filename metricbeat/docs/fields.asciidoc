...
Summed network summary statistics of every PID associated with the container



*`docker.network.network_summary.ip.*`*::
+
--
IP counters
...
*`docker.network.network_summary.tcp.*`*::
+
--
TCP counters
...
*`docker.network.network_summary.udp.*`*::
+
--
UDP counters
...
*`docker.network.network_summary.udp_lite.*`*::
+
--
UDP Lite counters
...
*`docker.network.network_summary.icmp.*`*::
+
--
ICMP counters
