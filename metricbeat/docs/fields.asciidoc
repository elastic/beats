...
*`couchdb.server.httpd.viewReads.description`*::
+
--
type: keyword
...
*`couchdb.server.httpd.viewReads.current`*::
+
--
type: scaled_float
...
*`couchdb.server.httpd.viewReads.sum`*::
+
--
type: scaled_float
...
*`couchdb.server.httpd.viewReads.mean`*::
+
--
type: scaled_float
...
*`couchdb.server.httpd.viewReads.stddev`*::
+
--
type: scaled_float
...
*`couchdb.server.httpd.viewReads.min`*::
+
--
type: scaled_float
...
*`couchdb.server.httpd.viewReads.max`*::
+
--
type: scaled_float
