...
*`cloud.billing.EstimatedCharges`*::
+
--
...
*`cloud.billing.AmortizedCost.amount`*::
+
--
...
*`cloud.billing.AmortizedCost.unit`*::
+
--
Amortized cost unit
...
*`cloud.billing.BlendedCost.amount`*::
+
--
Blended cost amount
...
*`cloud.billing.BlendedCost.unit`*::
+
--
Blended cost unit
...
*`cloud.billing.NormalizedUsageAmount.amount`*::
+
--
...
*`cloud.billing.NormalizedUsageAmount.unit`*::
+
--
...
*`cloud.billing.UnblendedCost.amount`*::
+
--
...
*`cloud.billing.UnblendedCost.unit`*::
+
--
Unblended cost unit
...
*`cloud.billing.UsageQuantity.amount`*::
+
--
...
*`cloud.billing.UsageQuantity.unit`*::
+
--
Usage quantity unit
...
*`cloud.billing.group_definition.key`*::
+
--
...
*`cloud.billing.group_definition.type`*::
+
--
...
*`cloud.dynamodb.metrics.SuccessfulRequestLatency.avg`*::
+
--
...
*`cloud.dynamodb.metrics.SuccessfulRequestLatency.max`*::
+
--
...
*`cloud.dynamodb.metrics.OnlineIndexPercentageProgress.avg`*::
+
--
...
*`cloud.dynamodb.metrics.ProvisionedWriteCapacityUnits.avg`*::
+
--
...
*`cloud.dynamodb.metrics.ProvisionedReadCapacityUnits.avg`*::
+
--
...
*`cloud.dynamodb.metrics.ConsumedReadCapacityUnits.avg`*::
+
--
...
*`cloud.dynamodb.metrics.ConsumedReadCapacityUnits.sum`*::
+
--
...
*`cloud.dynamodb.metrics.ConsumedWriteCapacityUnits.avg`*::
+
--
...
*`cloud.dynamodb.metrics.ConsumedWriteCapacityUnits.sum`*::
+
--
...
*`cloud.dynamodb.metrics.ReplicationLatency.avg`*::
+
--
...
*`cloud.dynamodb.metrics.ReplicationLatency.max`*::
+
--
...
*`cloud.dynamodb.metrics.TransactionConflict.avg`*::
+
--
...
*`cloud.dynamodb.metrics.TransactionConflict.sum`*::
+
--
...
*`cloud.dynamodb.metrics.AccountProvisionedReadCapacityUtilization.avg`*::
+
--
...
*`cloud.dynamodb.metrics.AccountProvisionedWriteCapacityUtilization.avg`*::
+
--
...
*`cloud.dynamodb.metrics.SystemErrors.sum`*::
+
--
...
*`cloud.dynamodb.metrics.ConditionalCheckFailedRequests.sum`*::
+
--
...
*`cloud.dynamodb.metrics.PendingReplicationCount.sum`*::
+
--
...
*`cloud.dynamodb.metrics.ReadThrottleEvents.sum`*::
+
--
...
*`cloud.dynamodb.metrics.ThrottledRequests.sum`*::
+
--
...
*`cloud.dynamodb.metrics.WriteThrottleEvents.sum`*::
+
--
...
*`cloud.dynamodb.metrics.AccountMaxReads.max`*::
+
--
...
*`cloud.dynamodb.metrics.AccountMaxTableLevelReads.max`*::
+
--
...
*`cloud.dynamodb.metrics.AccountMaxTableLevelWrites.max`*::
+
--
...
*`cloud.dynamodb.metrics.AccountMaxWrites.max`*::
+
--
...
*`cloud.dynamodb.metrics.MaxProvisionedTableReadCapacityUtilization.max`*::
+
--
...
*`cloud.dynamodb.metrics.MaxProvisionedTableWriteCapacityUtilization.max`*::
+
--
...
*`cloud.ebs.metrics.VolumeReadBytes.avg`*::
+
--
...
*`cloud.ebs.metrics.VolumeWriteBytes.avg`*::
+
--
...
*`cloud.ebs.metrics.VolumeReadOps.avg`*::
+
--
...
*`cloud.ebs.metrics.VolumeWriteOps.avg`*::
+
--
...
*`cloud.ebs.metrics.VolumeQueueLength.avg`*::
+
--
...
*`cloud.ebs.metrics.VolumeThroughputPercentage.avg`*::
+
--
...
*`cloud.ebs.metrics.VolumeConsumedReadWriteOps.avg`*::
+
--
...
*`cloud.ebs.metrics.BurstBalance.avg`*::
+
--
...
*`cloud.ebs.metrics.VolumeTotalReadTime.sum`*::
+
--
...
*`cloud.ebs.metrics.VolumeTotalWriteTime.sum`*::
+
--
...
*`cloud.ebs.metrics.VolumeIdleTime.sum`*::
+
--
...
*`cloud.ec2.cpu.surplus_credit_balance`*::
+
--
...
*`cloud.ec2.cpu.surplus_credits_charged`*::
+
--
...
*`cloud.ec2.network.in.packets_per_sec`*::
+
--
...
*`cloud.ec2.network.out.packets_per_sec`*::
+
--
The number of packets per second sent out on all network interfaces by the instance.
...
*`cloud.ec2.network.in.bytes_per_sec`*::
+
--
...
*`cloud.ec2.network.out.bytes_per_sec`*::
+
--
...
*`cloud.ec2.diskio.read.bytes_per_sec`*::
+
--
...
*`cloud.ec2.diskio.write.bytes_per_sec`*::
+
--
...
*`cloud.ec2.diskio.read.count_per_sec`*::
+
--
...
*`cloud.ec2.diskio.write.count_per_sec`*::
+
--
...
*`cloud.ec2.status.check_failed_system`*::
+
--
...
*`cloud.ec2.status.check_failed_instance`*::
+
--
...
*`cloud.ec2.instance.monitoring.state`*::
+
--
...
*`cloud.ec2.instance.private.dns_name`*::
+
--
...
*`cloud.ec2.instance.public.dns_name`*::
+
--
...
*`cloud.ec2.instance.threads_per_core`*::
+
--
...
*`cloud.elb.metrics.BackendConnectionErrors.sum`*::
+
--
...
*`cloud.elb.metrics.HTTPCode_Backend_2XX.sum`*::
+
--
...
*`cloud.elb.metrics.HTTPCode_Backend_3XX.sum`*::
+
--
...
*`cloud.elb.metrics.HTTPCode_Backend_4XX.sum`*::
+
--
...
*`cloud.elb.metrics.HTTPCode_Backend_5XX.sum`*::
+
--
...
*`cloud.elb.metrics.HTTPCode_ELB_4XX.sum`*::
+
--
...
*`cloud.elb.metrics.HTTPCode_ELB_5XX.sum`*::
+
--
...
*`cloud.elb.metrics.RequestCount.sum`*::
+
--
...
*`cloud.elb.metrics.SpilloverCount.sum`*::
+
--
...
*`cloud.elb.metrics.HealthyHostCount.max`*::
+
--
...
*`cloud.elb.metrics.SurgeQueueLength.max`*::
+
--
...
*`cloud.elb.metrics.UnHealthyHostCount.max`*::
+
--
...
*`cloud.elb.metrics.EstimatedALBActiveConnectionCount.avg`*::
+
--
...
*`cloud.elb.metrics.EstimatedALBConsumedLCUs.avg`*::
+
--
...
*`cloud.elb.metrics.EstimatedALBNewConnectionCount.avg`*::
+
--
...
*`cloud.elb.metrics.EstimatedProcessedBytes.avg`*::
+
--
...
*`cloud.applicationelb.metrics.ActiveConnectionCount.sum`*::
+
--
...
*`cloud.applicationelb.metrics.ClientTLSNegotiationErrorCount.sum`*::
+
--
...
*`cloud.applicationelb.metrics.HTTP_Fixed_Response_Count.sum`*::
+
--
...
*`cloud.applicationelb.metrics.HTTP_Redirect_Count.sum`*::
+
--
...
*`cloud.applicationelb.metrics.HTTP_Redirect_Url_Limit_Exceeded_Count.sum`*::
+
--
...
*`cloud.applicationelb.metrics.HTTPCode_ELB_3XX_Count.sum`*::
+
--
...
*`cloud.applicationelb.metrics.HTTPCode_ELB_4XX_Count.sum`*::
+
--
...
*`cloud.applicationelb.metrics.HTTPCode_ELB_5XX_Count.sum`*::
+
--
...
*`cloud.applicationelb.metrics.HTTPCode_ELB_500_Count.sum`*::
+
--
...
*`cloud.applicationelb.metrics.HTTPCode_ELB_502_Count.sum`*::
+
--
...
*`cloud.applicationelb.metrics.HTTPCode_ELB_503_Count.sum`*::
+
--
...
*`cloud.applicationelb.metrics.HTTPCode_ELB_504_Count.sum`*::
+
--
...
*`cloud.applicationelb.metrics.IPv6ProcessedBytes.sum`*::
+
--
...
*`cloud.applicationelb.metrics.IPv6RequestCount.sum`*::
+
--
...
*`cloud.applicationelb.metrics.NewConnectionCount.sum`*::
+
--
...
*`cloud.applicationelb.metrics.ProcessedBytes.sum`*::
+
--
...
*`cloud.applicationelb.metrics.RejectedConnectionCount.sum`*::
+
--
...
*`cloud.applicationelb.metrics.RequestCount.sum`*::
+
--
...
*`cloud.applicationelb.metrics.RuleEvaluations.sum`*::
+
--
...
*`cloud.applicationelb.metrics.ConsumedLCUs.avg`*::
+
--
...
*`cloud.networkelb.metrics.ActiveFlowCount.avg`*::
+
--
...
*`cloud.networkelb.metrics.ActiveFlowCount_TCP.avg`*::
+
--
...
*`cloud.networkelb.metrics.ActiveFlowCount_TLS.avg`*::
+
--
...
*`cloud.networkelb.metrics.ActiveFlowCount_UDP.avg`*::
+
--
...
*`cloud.networkelb.metrics.ConsumedLCUs.avg`*::
+
--
The number of load balancer capacity units (LCU) used by your load balancer.
...
*`cloud.networkelb.metrics.ClientTLSNegotiationErrorCount.sum`*::
+
--
...
*`cloud.networkelb.metrics.NewFlowCount.sum`*::
+
--
...
*`cloud.networkelb.metrics.NewFlowCount_TLS.sum`*::
+
--
...
*`cloud.networkelb.metrics.ProcessedBytes.sum`*::
+
--
...
*`cloud.networkelb.metrics.ProcessedBytes_TLS.sum`*::
+
--
...
*`cloud.networkelb.metrics.TargetTLSNegotiationErrorCount.sum`*::
+
--
...
*`cloud.networkelb.metrics.TCP_Client_Reset_Count.sum`*::
+
--
...
*`cloud.networkelb.metrics.TCP_ELB_Reset_Count.sum`*::
+
--
...
*`cloud.networkelb.metrics.TCP_Target_Reset_Count.sum`*::
+
--
...
*`cloud.networkelb.metrics.HealthyHostCount.max`*::
+
--
...
*`cloud.networkelb.metrics.UnHealthyHostCount.max`*::
+
--
...
*`cloud.lambda.metrics.Invocations.avg`*::
+
--
...
*`cloud.lambda.metrics.Errors.avg`*::
+
--
...
*`cloud.lambda.metrics.DeadLetterErrors.avg`*::
+
--
...
*`cloud.lambda.metrics.DestinationDeliveryFailures.avg`*::
+
--
...
*`cloud.lambda.metrics.Duration.avg`*::
+
--
...
*`cloud.lambda.metrics.Throttles.avg`*::
+
--
...
*`cloud.lambda.metrics.IteratorAge.avg`*::
+
--
...
*`cloud.lambda.metrics.ConcurrentExecutions.avg`*::
+
--
...
*`cloud.lambda.metrics.UnreservedConcurrentExecutions.avg`*::
+
--
...
*`cloud.lambda.metrics.ProvisionedConcurrentExecutions.max`*::
+
--
...
*`cloud.lambda.metrics.ProvisionedConcurrencyUtilization.max`*::
+
--
...
*`cloud.lambda.metrics.ProvisionedConcurrencyInvocations.sum`*::
+
--
...
*`cloud.lambda.metrics.ProvisionedConcurrencySpilloverInvocations.sum`*::
+
--
...
*`cloud.natgateway.metrics.BytesInFromDestination.sum`*::
+
--
...
*`cloud.natgateway.metrics.BytesInFromSource.sum`*::
+
--
...
*`cloud.natgateway.metrics.BytesOutToDestination.sum`*::
+
--
...
*`cloud.natgateway.metrics.BytesOutToSource.sum`*::
+
--
...
*`cloud.natgateway.metrics.ConnectionAttemptCount.sum`*::
+
--
...
*`cloud.natgateway.metrics.ConnectionEstablishedCount.sum`*::
+
--
...
*`cloud.natgateway.metrics.ErrorPortAllocation.sum`*::
+
--
...
*`cloud.natgateway.metrics.IdleTimeoutCount.sum`*::
+
--
...
*`cloud.natgateway.metrics.PacketsDropCount.sum`*::
+
--
...
*`cloud.natgateway.metrics.PacketsInFromDestination.sum`*::
+
--
...
*`cloud.natgateway.metrics.PacketsInFromSource.sum`*::
+
--
...
*`cloud.natgateway.metrics.PacketsOutToDestination.sum`*::
+
--
...
*`cloud.natgateway.metrics.PacketsOutToSource.sum`*::
+
--
...
*`cloud.natgateway.metrics.ActiveConnectionCount.max`*::
+
--
...
*`cloud.rds.database_connections`*::
+
--
...
*`cloud.rds.db_instance.identifier`*::
+
--
...
*`cloud.rds.failed_sql_server_agent_jobs`*::
+
--
...
*`cloud.rds.freeable_memory.bytes`*::
+
--
...
*`cloud.rds.maximum_used_transaction_ids`*::
+
--
...
*`cloud.rds.oldest_replication_slot_lag.mb`*::
+
--
...
*`cloud.rds.transaction_logs_generation`*::
+
--
...
*`cloud.rds.write_io.ops_per_sec`*::
+
--
...
*`cloud.rds.free_local_storage.bytes`*::
+
--
...
*`cloud.rds.throughput.network_receive`*::
+
--
...
*`cloud.rds.throughput.network_transmit`*::
+
--
...
*`cloud.rds.disk_usage.bin_log.bytes`*::
+
--
...
*`cloud.rds.disk_usage.replication_slot.mb`*::
+
--
...
*`cloud.rds.disk_usage.transaction_logs.mb`*::
+
--
The disk space used by transaction logs. Applies to PostgreSQL.
...
*`cloud.rds.transactions.blocked`*::
+
--
...
*`cloud.rds.db_instance.db_cluster_identifier`*::
+
--
...
*`cloud.rds.db_instance.engine_name`*::
+
--
...
*`cloud.rds.aurora_bin_log_replica_lag`*::
+
--
...
*`cloud.rds.aurora_global_db.replicated_write_io.bytes`*::
+
--
...
*`cloud.rds.aurora_global_db.data_transfer.bytes`*::
+
--
...
*`cloud.rds.aurora_global_db.replication_lag.ms`*::
+
--
...
*`cloud.rds.aurora_replica.lag.ms`*::
+
--
...
*`cloud.rds.aurora_replica.lag_max.ms`*::
+
--
...
*`cloud.rds.aurora_replica.lag_min.ms`*::
+
--
...
*`cloud.rds.backtrack_change_records.creation_rate`*::
+
--
...
*`cloud.rds.backtrack_change_records.stored`*::
+
--
...
*`cloud.rds.backtrack_window.actual`*::
+
--
...
*`cloud.rds.backtrack_window.alert`*::
+
--
...
*`cloud.rds.storage_used.backup_retention_period.bytes`*::
+
--
...
*`cloud.rds.storage_used.snapshot.bytes`*::
+
--
...
*`cloud.rds.cache_hit_ratio.buffer`*::
+
--
...
*`cloud.rds.cache_hit_ratio.result_set`*::
+
--
...
*`cloud.rds.rds_to_aurora_postgresql_replica_lag.sec`*::
+
--
...
*`cloud.rds.backup_storage_billed_total.bytes`*::
+
--
...
*`cloud.rds.aurora_volume_left_total.bytes`*::
+
--
...
*`cloud.s3_daily_storage.bucket.size.bytes`*::
+
--
...
*`cloud.s3_daily_storage.number_of_objects`*::
+
--
...
*`cloud.s3_request.requests.total`*::
+
--
...
*`cloud.s3_request.requests.delete`*::
+
--
...
*`cloud.s3_request.requests.head`*::
+
--
...
*`cloud.s3_request.requests.post`*::
+
--
...
*`cloud.s3_request.requests.select`*::
+
--
...
*`cloud.s3_request.requests.select_scanned.bytes`*::
+
--
...
*`cloud.s3_request.requests.select_returned.bytes`*::
+
--
...
*`cloud.s3_request.requests.list`*::
+
--
...
*`cloud.s3_request.downloaded.bytes`*::
+
--
...
*`cloud.s3_request.uploaded.bytes`*::
+
--
...
*`cloud.s3_request.latency.first_byte.ms`*::
+
--
...
*`cloud.s3_request.latency.total_request.ms`*::
+
--
...
*`cloud.sns.metrics.PublishSize.avg`*::
+
--
...
*`cloud.sns.metrics.SMSSuccessRate.avg`*::
+
--
...
*`cloud.sns.metrics.NumberOfMessagesPublished.sum`*::
+
--
...
*`cloud.sns.metrics.NumberOfNotificationsDelivered.sum`*::
+
--
...
*`cloud.sns.metrics.NumberOfNotificationsFailed.sum`*::
+
--
...
*`cloud.sns.metrics.NumberOfNotificationsFilteredOut.sum`*::
+
--
...
*`cloud.sns.metrics.NumberOfNotificationsFilteredOut-InvalidAttributes.sum`*::
+
--
...
*`cloud.sns.metrics.NumberOfNotificationsFilteredOut-NoMessageAttributes.sum`*::
+
--
...
*`cloud.sns.metrics.NumberOfNotificationsRedrivenToDlq.sum`*::
+
--
...
*`cloud.sns.metrics.NumberOfNotificationsFailedToRedriveToDlq.sum`*::
+
--
...
*`cloud.sns.metrics.SMSMonthToDateSpentUSD.sum`*::
+
--
...
*`cloud.sqs.oldest_message_age.sec`*::
+
--
...
*`cloud.sqs.messages.not_visible`*::
+
--
...
*`cloud.sqs.sent_message_size.bytes`*::
+
--
...
*`cloud.transitgateway.metrics.BytesIn.sum`*::
+
--
...
*`cloud.transitgateway.metrics.BytesOut.sum`*::
+
--
...
*`cloud.transitgateway.metrics.PacketsIn.sum`*::
+
--
...
*`cloud.transitgateway.metrics.PacketsOut.sum`*::
+
--
...
*`cloud.transitgateway.metrics.PacketDropCountBlackhole.sum`*::
+
--
...
*`cloud.transitgateway.metrics.PacketDropCountNoRoute.sum`*::
+
--
...
*`cloud.usage.metrics.CallCount.sum`*::
+
--
...
*`cloud.usage.metrics.ResourceCount.sum`*::
+
--
...
*`cloud.vpn.metrics.TunnelState.avg`*::
+
--
...
*`cloud.vpn.metrics.TunnelDataIn.sum`*::
+
--
...
*`cloud.vpn.metrics.TunnelDataOut.sum`*::
+
--
