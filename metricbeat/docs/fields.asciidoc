...
Operating system load averages



*`kibana.stats.os.load.avg.1m`*::
+
--
type: scaled_float
...
Operating system memory metrics



*`kibana.stats.os.memory.total.bytes`*::
+
--
type: long
...
Total operating system memory available in bytes


--

*`kibana.stats.os.memory.free.bytes`*::
+
--
type: long
...
Operating system memory free in bytes


--

*`kibana.stats.os.memory.used.bytes`*::
+
--
type: long
...
Operating system memory used in bytes


--

*`kibana.stats.os.uptime.ms`*::
+
--
type: long

Operating system uptime in seconds
...
*`kibana.stats.process.memory.heap.external.bytes`*::
+
--
type: long
...
Heap used by C++ objects bound to Javascript objects managed by V8, in bytes
...
Kibana core plugins' usage metrics



*`kibana.stats.usage.kibana.index`*::
+
--
type: keyword
...
*`kibana.stats.usage.kibana.dashboard.total`*::
+
--
type: long

Total number of dashboards saved


--

*`kibana.stats.usage.kibana.visualization.total`*::
+
--
type: long

Total number of visualizations saved


--

*`kibana.stats.usage.kibana.search.total`*::
+
--
type: long

Total number of searches saved


--

*`kibana.stats.usage.kibana.index_pattern.total`*::
+
--
type: long

Total number of index patterns saved


--

*`kibana.stats.usage.kibana.graph_workspace.total`*::
+
--
type: long

Total number of graph workspaces saved


--

*`kibana.stats.usage.kibana.timelion_sheet.total`*::
+
--
type: long

Total number of timelion sheets saved
...
Kibana Reporting plugin's usage metrics



*`kibana.stats.usage.reporting.available`*::
+
--
type: boolean

Whether the Reporting plugin is available


--

*`kibana.stats.usage.reporting.enabled`*::
+
--
type: boolean

Whether the Reporting plugin is enabled


--

*`kibana.stats.usage.reporting.browser_type`*::
+
--
type: keyword

Type of browser being used by Reporting for screenshots


--

*`kibana.stats.usage.reporting._all`*::
+
--
type: long

Total number of reports generated across all types of reports
...
Metrics for CSV reports



*`kibana.stats.usage.reporting.csv.available`*::
+
--
type: boolean

Whether CSV reporting is available


--

*`kibana.stats.usage.reporting.csv.total`*::
+
--
type: long

Total number of CSV reports generated


--

[float]
== printable_pdf fields

Metrics for PDF reports



*`kibana.stats.usage.reporting.printable_pdf.available`*::
+
--
type: boolean

Whether PDF reporting is available


--

*`kibana.stats.usage.reporting.printable_pdf.total`*::
+
--
type: long

Total number of PDF reports generated
...
*`kibana.stats.usage.reporting.status.completed`*::
+
--
type: long
...
*`kibana.stats.usage.reporting.status.failed`*::
+
--
type: long
...
*`kibana.stats.usage.reporting.status.processing`*::
+
--
type: long

Number of reports currently processing


--

*`kibana.stats.usage.reporting.status.pending`*::
+
--
type: long

Number of reports waiting to start processing
...
Metrics for the last day



*`kibana.stats.usage.reporting.lastDay._all`*::
+
--
type: long
...
*`kibana.stats.usage.reporting.lastDay.csv.available`*::
+
--
type: boolean
...
*`kibana.stats.usage.reporting.lastDay.csv.total`*::
+
--
type: long
...
*`kibana.stats.usage.reporting.lastDay.printable_pdf.available`*::
+
--
type: boolean
...
*`kibana.stats.usage.reporting.lastDay.printable_pdf.total`*::
+
--
type: long
...
*`kibana.stats.usage.reporting.lastDay.status.completed`*::
+
--
type: long
...
*`kibana.stats.usage.reporting.lastDay.status.failed`*::
+
--
type: long
...
*`kibana.stats.usage.reporting.lastDay.status.processing`*::
+
--
type: long
...
*`kibana.stats.usage.reporting.lastDay.status.pending`*::
+
--
type: long
...
Metrics for the last seven days



*`kibana.stats.usage.reporting.last7Days._all`*::
+
--
type: long
...
*`kibana.stats.usage.reporting.last7Days.csv.available`*::
+
--
type: boolean
...
*`kibana.stats.usage.reporting.last7Days.csv.total`*::
+
--
type: long
...
*`kibana.stats.usage.reporting.last7Days.printable_pdf.available`*::
+
--
type: boolean
...
*`kibana.stats.usage.reporting.last7Days.printable_pdf.total`*::
+
--
type: long
...
*`kibana.stats.usage.reporting.last7Days.status.completed`*::
+
--
type: long
...
*`kibana.stats.usage.reporting.last7Days.status.failed`*::
+
--
type: long
...
*`kibana.stats.usage.reporting.last7Days.status.processing`*::
+
--
type: long
...
*`kibana.stats.usage.reporting.last7Days.status.pending`*::
+
--
type: long
