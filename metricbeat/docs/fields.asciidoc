...
*`nats.varz.http_req_stats.root_uri`*::
+
--
type: object
...
*`nats.varz.http_req_stats.connz_uri`*::
+
--
type: object
...
*`nats.varz.http_req_stats.routez_uri`*::
+
--
type: object
...
*`nats.varz.http_req_stats.subsz_uri`*::
+
--
type: object
...
*`nats.varz.http_req_stats.varz_uri`*::
+
--
type: object
...
*`nats.varz.http.req_stats.uri.routez`*::
+
--
type: integer
...
*`nats.varz.http.req_stats.uri.connz`*::
+
--
type: integer
...
*`nats.varz.http.req_stats.uri.varz`*::
+
--
type: integer
...
*`nats.varz.http.req_stats.uri.subsz`*::
+
--
type: integer
...
*`nats.varz.http.req_stats.uri.root`*::
+
--
type: integer
