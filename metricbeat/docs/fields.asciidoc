...
*`mongodb.status.oplatencies.reads.latency`*::
+
--
type: long
...
*`mongodb.status.oplatencies.reads.count`*::
+
--
type: long
...
*`mongodb.status.oplatencies.writes.latency`*::
+
--
type: long
...
*`mongodb.status.oplatencies.writes.count`*::
+
--
type: long
...
*`mongodb.status.oplatencies.commands.latency`*::
+
--
type: long
...
*`mongodb.status.oplatencies.commands.count`*::
+
--
type: long
