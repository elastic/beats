...
[float]
=== couchbase.bucket.stats_QuotaPercUse
...
[float]
=== couchbase.bucket.stats_OpsPerSec
...
[float]
=== couchbase.bucket.stats_DiskFetches
...
[float]
=== couchbase.bucket.stats_ItemCount
...
[float]
=== couchbase.bucket.stats_DiskUsed
...
[float]
=== couchbase.bucket.stats_DataUsed
...
[float]
=== couchbase.bucket.stats_MemUsed
...
[float]
=== couchbase.cluster.hdd_quotaTotal
...
[float]
=== couchbase.cluster.hdd_usedByData
...
[float]
=== couchbase.cluster.indexMemoryQuota
...
[float]
=== couchbase.cluster.maxBucketCount
...
[float]
=== couchbase.cluster.ram_quotaTotal
...
[float]
=== couchbase.cluster.ram_quotaTotalPerNode
...
[float]
=== couchbase.cluster.ram_quotaUsed
...
[float]
=== couchbase.cluster.ram_quotaUsedPerNode
...
[float]
=== couchbase.cluster.ram_usedByData
...
[float]
=== couchbase.node.CPUUtilizationRate
...
[float]
=== couchbase.node.couchDocsActualDiskSize
...
[float]
=== couchbase.node.couchDocsDataSize
...
[float]
=== couchbase.node.couchSpatialDataSize
...
[float]
=== couchbase.node.couchSpatialDiskSize
...
[float]
=== couchbase.node.couchViewsActualDiskSize
...
[float]
=== couchbase.node.couchViewsDataSize
...
[float]
=== couchbase.node.mcdMemoryAllocated
...
[float]
=== couchbase.node.mcdMemoryReserved
...
[float]
=== couchbase.node.vbReplicaCurrItems
