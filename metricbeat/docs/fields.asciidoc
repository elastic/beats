...
*`oracle.sysmetric.metrics.begin_time`*::
+
--
...
*`oracle.sysmetric.metrics.container_id`*::
+
--
Container ID.
...
*`oracle.sysmetric.metrics.end_time`*::
+
--
...
*`oracle.sysmetric.metrics.group_id`*::
+
--
Metric group ID.
...
*`oracle.sysmetric.metrics.interval_size_csec`*::
+
--
...
*`oracle.sysmetric.metrics.metric_id`*::
+
--
Metric ID.
...
*`oracle.sysmetric.metrics.metric_unit`*::
+
--
Description of metric unit.
...
*`oracle.sysmetric.metrics.value`*::
+
--
Metric value.
