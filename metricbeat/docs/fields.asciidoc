...
`cost` contains the metrics that were scraped from cost explorer




*`aws.cost.AmortizedCost.amount.amount`*::
+
--
...
*`aws.cost.AmortizedCost.amount.unit`*::
+
--
Amortized cost unit
...
*`aws.cost.NormalizedUsageAmount.amount`*::
+
--
...
*`aws.cost.NormalizedUsageAmount.unit`*::
+
--
