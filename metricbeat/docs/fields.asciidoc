...
*`enterprisesearch.health.jvm.gc.collection_time.msec`*::
+
--
...
*`enterprisesearch.health.jvm.threads.thread_count`*::
+
--
...
*`enterprisesearch.health.jvm.threads.peak_thread_count`*::
+
--
...
*`enterprisesearch.health.jvm.threads.total_started_thread_count`*::
+
--
...
*`enterprisesearch.health.jvm.threads.daemon_thread_count`*::
+
--
...
*`enterprisesearch.stats.http.request_duration.max.msec`*::
+
--
...
*`enterprisesearch.stats.http.request_duration.mean.msec`*::
+
--
...
*`enterprisesearch.stats.http.request_duration.std_dev.msec`*::
+
--
