...
`stats` contains disk availability statistics.



*`ceph.mgr_cluster_disk.stats.total_bytes`*::
+
--
Total bytes of the cluster
...
*`ceph.mgr_cluster_disk.stats.total_avail_bytes`*::
+
--
Available bytes of the cluster
...
*`ceph.mgr_cluster_disk.stats.total_used_bytes`*::
+
--
Used bytes of the cluster
...
*`ceph.mgr_cluster_disk.stats.total_used_raw_bytes`*::
+
--
Used raw bytes of the cluster

type: long

--

*`ceph.mgr_cluster_disk.stats.total_used_raw_ratio`*::
+
--
Used raw bytes ratio

type: scaled_float

--

*`ceph.mgr_cluster_disk.stats.num_osds`*::
+
--
...
*`ceph.mgr_cluster_disk.stats.num_per_pool_osds`*::
+
--
Number of OSDs per pool in the cluster
...
`pools` contains disk pool statistics.



*`ceph.mgr_cluster_disk.pools.name`*::
+
--
Pool name
...
*`ceph.mgr_cluster_disk.pools.id`*::
+
--
Pool ID
...
*`ceph.mgr_cluster_disk.pools.stats.kb_used`*::
+
--
...
*`ceph.mgr_cluster_disk.pools.stats.bytes_used`*::
+
--
Used space in bytes
...
*`ceph.mgr_cluster_disk.pools.stats.percent_used`*::
+
--
Used space in pct
...
*`ceph.mgr_cluster_disk.pools.stats.max_avail`*::
+
--
...
*`ceph.mgr_cluster_disk.pools.stats.stored`*::
+
--
Stored bytes
...
*`ceph.mgr_cluster_disk.pools.stats.objects`*::
+
--
...
*`ceph.mgr_cluster_health.fsid`*::
+
--
File System ID, a unique identifier for the cluster

type: keyword

--

*`ceph.mgr_cluster_health.quorum_age`*::
+
--
Cluster quarum age
...
`monmap` contains information about cluster monitors.



*`ceph.mgr_cluster_health.monmap.min_mon_release`*::
+
--
Minimal monitor release

type: long

--

*`ceph.mgr_cluster_health.monmap.min_mon_release_name`*::
+
--
Minimal monitor release name
...
`features` contains information about available cluster features.



*`ceph.mgr_cluster_health.monmap.features.persistent`*::
+
--
Persistent feature
...
*`ceph.mgr_cluster_health.monmap.features.optional`*::
+
--
Optional feature
...
`mons` contains information about monitor configurations.



*`ceph.mgr_cluster_health.monmap.mons.public_addr`*::
+
--
Monitor public address

type: keyword

--

*`ceph.mgr_cluster_health.monmap.mons.rank`*::
+
--
Monitor rank
...
*`ceph.mgr_cluster_health.monmap.mons.name`*::
+
--
Monitor name
...
Monitor public addresses


[float]
=== addrvec

`addrvec` contains details of all public addresses.



*`ceph.mgr_cluster_health.monmap.mons.public_addrs.addrvec.type`*::
+
--
Address type
...
*`ceph.mgr_cluster_health.monmap.mons.public_addrs.addrvec.addr`*::
+
--
...
*`ceph.mgr_cluster_health.monmap.mons.public_addrs.addrvec.nonce`*::
+
--
Nonce value
...
*`ceph.mgr_cluster_health.monmap.mons.addr`*::
+
--
Monitor address
...
*`ceph.mgr_cluster_health.monmap.epoch`*::
+
--
Epoch version
...
*`ceph.mgr_cluster_health.monmap.fsid`*::
+
--
File System ID, a unique identifier for the cluster
...
*`ceph.mgr_cluster_health.monmap.modified`*::
+
--
...
*`ceph.mgr_cluster_health.monmap.created`*::
+
--
...
`pgmap` contains information about placement groups.



*`ceph.mgr_cluster_health.pgmap.num_pgs`*::
+
--
Number of PGs
...
*`ceph.mgr_cluster_health.pgmap.bytes_avail`*::
+
--
Available bytes
...
*`ceph.mgr_cluster_health.pgmap.read_bytes_sec`*::
+
--
...
*`ceph.mgr_cluster_health.pgmap.write_bytes_sec`*::
+
--
...
*`ceph.mgr_cluster_health.pgmap.bytes_used`*::
+
--
Used bytes
...
*`ceph.mgr_cluster_health.pgmap.bytes_total`*::
+
--
Total bytes
...
*`ceph.mgr_cluster_health.pgmap.read_op_per_sec`*::
+
--
...
*`ceph.mgr_cluster_health.pgmap.write_op_per_sec`*::
+
--
...
`pgs_by_state` contains information about PGs' states.



*`ceph.mgr_cluster_health.pgmap.pgs_by_state.state_name`*::
+
--
State name
...
*`ceph.mgr_cluster_health.pgmap.pgs_by_state.count`*::
+
--
Count
...
*`ceph.mgr_cluster_health.pgmap.num_pools`*::
+
--
Number of pools
...
*`ceph.mgr_cluster_health.pgmap.num_objects`*::
+
--
Number of objects
...
*`ceph.mgr_cluster_health.pgmap.data_bytes`*::
+
--
Data bytes
...
`health` contains general information about cluster status.



*`ceph.mgr_cluster_health.health.status`*::
+
--
Health status
...
*`ceph.mgr_cluster_health.election_epoch`*::
+
--
Election epoch
...
*`ceph.mgr_cluster_health.quorum`*::
+
--
Quorum ID
...
*`ceph.mgr_cluster_health.quorum_names`*::
+
--
Quorum names
...
`osdmap` contains information about OSDs.



*`ceph.mgr_cluster_health.osdmap.epoch`*::
+
--
Epoch version
...
*`ceph.mgr_cluster_health.osdmap.num_osds`*::
+
--
Number of OSDs
...
*`ceph.mgr_cluster_health.osdmap.num_up_osds`*::
+
--
Number of up OSDs
...
*`ceph.mgr_cluster_health.osdmap.num_in_osds`*::
+
--
Number of in OSDs
...
*`ceph.mgr_cluster_health.osdmap.num_remapped_pgs`*::
+
--
Number of remapped OSDs
...
`fsmap` contains information about file systems.



*`ceph.mgr_cluster_health.fsmap.in`*::
+
--
File system in
...
*`ceph.mgr_cluster_health.fsmap.max`*::
+
--
File system max
...
*`ceph.mgr_cluster_health.fsmap.up:standby`*::
+
--
File system up:standby

type: long

--

*`ceph.mgr_cluster_health.fsmap.epoch`*::
+
--
Epoch version
...
*`ceph.mgr_cluster_health.fsmap.up`*::
+
--
File system up
...
`by_rank` contains information about file systems sorted by rank.



*`ceph.mgr_cluster_health.fsmap.by_rank.filesystem_id`*::
+
--
File system ID
...
*`ceph.mgr_cluster_health.fsmap.by_rank.rank`*::
+
--
File system rank
...
*`ceph.mgr_cluster_health.fsmap.by_rank.name`*::
+
--
File system name
...
*`ceph.mgr_cluster_health.fsmap.by_rank.status`*::
+
--
File system status
...
*`ceph.mgr_cluster_health.fsmap.by_rank.gid`*::
+
--
File system GID
...
`nodes` contains information about active nodes.



*`ceph.mgr_osd_disk.nodes.depth`*::
+
--
Depth
...
*`ceph.mgr_osd_disk.nodes.reweight`*::
+
--
Reweight (controls how much data the system tries to allocate to the OSD)

type: long

--

*`ceph.mgr_osd_disk.nodes.pgs`*::
+
--
Number of PGs
...
*`ceph.mgr_osd_disk.nodes.crush_weight`*::
+
--
CRUSH weight
...
*`ceph.mgr_osd_disk.nodes.status`*::
+
--
Node status
...
*`ceph.mgr_osd_disk.nodes.type_id`*::
+
--
Type ID
...
*`ceph.mgr_osd_disk.nodes.kb_used_data`*::
+
--
Used data (in KB)
...
*`ceph.mgr_osd_disk.nodes.kb_used_omap`*::
+
--
Used omap (in KB)
...
*`ceph.mgr_osd_disk.nodes.kb_used_meta`*::
+
--
Used meta (in KB)
...
*`ceph.mgr_osd_disk.nodes.kb_avail`*::
+
--
...
*`ceph.mgr_osd_disk.nodes.kb_used`*::
+
--
Used space (in KB)
...
*`ceph.mgr_osd_disk.nodes.Utilization`*::
+
--
Space utilization
...
`stray` contains information about stray OSD nodes.



*`ceph.mgr_osd_disk.stray.depth`*::
+
--
Depth
...
*`ceph.mgr_osd_disk.stray.reweight`*::
+
--
Reweight (controls how much data the system tries to allocate to the OSD)
...
*`ceph.mgr_osd_disk.stray.crush_weight`*::
+
--
CRUSH weight
...
*`ceph.mgr_osd_disk.stray.status`*::
+
--
Node status
...
*`ceph.mgr_osd_disk.stray.type_id`*::
+
--
Type ID
...
*`ceph.mgr_osd_disk.stray.kb_used_data`*::
+
--
Used space for data (in KB)

type: long

--

*`ceph.mgr_osd_disk.stray.kb_used_omap`*::
+
--
Used space for omap (in KB)

type: long

--

*`ceph.mgr_osd_disk.stray.kb_used_meta`*::
+
--
Used space for meta (in KB)

type: long

--

*`ceph.mgr_osd_disk.stray.kb_avail`*::
+
--
Available space (in KB)
...
*`ceph.mgr_osd_disk.stray.kb_used`*::
+
--
Used space (in KB)
...
*`ceph.mgr_osd_disk.stray.utilization`*::
+
--
Space utilization
...
`summary` contains general information about OSDs.



*`ceph.mgr_osd_disk.summary.total_kb_used_omap`*::
+
--
Total used space for omap (in KB)

type: long

--

*`ceph.mgr_osd_disk.summary.average_utilization`*::
+
--
...
*`ceph.mgr_osd_disk.summary.total_kb_avail`*::
+
--
Total available space (in KB)

type: long

--

*`ceph.mgr_osd_disk.summary.min_var`*::
+
--
Minimal variant
...
*`ceph.mgr_osd_disk.summary.max_var`*::
+
--
Maximal variant
...
*`ceph.mgr_osd_disk.summary.total_kb`*::
+
--
Total space (in KB)
...
*`ceph.mgr_osd_disk.summary.total_kb_used`*::
+
--
Total used space (in KB)

type: long

--

*`ceph.mgr_osd_disk.summary.total_kb_used_data`*::
+
--
Total used space for data (in KB)

type: long

--

*`ceph.mgr_osd_disk.summary.total_kb_used_meta`*::
+
--
Total used space for meta (in KB)
...
*`ceph.mgr_osd_perf.pg_ready`*::
+
--
Placement Group readiness status
...
*`ceph.mgr_osd_perf.osdstats.osd_perf_infos.id`*::
+
--
OSD ID
...
*`ceph.mgr_osd_perf.osdstats.osd_perf_infos.perf_stats.commit_latency_ms`*::
+
--
...
*`ceph.mgr_osd_perf.osdstats.osd_perf_infos.perf_stats.apply_latency_ms`*::
+
--
Apply latency in ms
...
*`ceph.mgr_osd_perf.osdstats.osd_perf_infos.perf_stats.commit_latency_ns`*::
+
--
...
*`ceph.mgr_osd_perf.osdstats.osd_perf_infos.perf_stats.apply_latency_ns`*::
+
--
Apply latency in ns
...
*`ceph.mgr_osd_pool_stats.client_io_rate.read_bytes_sec`*::
+
--
type: long
...
*`ceph.mgr_osd_pool_stats.client_io_rate.write_bytes_sec`*::
+
--
type: long
...
*`ceph.mgr_osd_pool_stats.client_io_rate.read_op_per_sec`*::
+
--
type: long
...
*`ceph.mgr_osd_pool_stats.client_io_rate.write_op_per_sec`*::
+
--
type: long
...
`nodes` contains disk active OSD nodes.



*`ceph.mgr_osd_tree.nodes.name`*::
+
--
Node name
...
*`ceph.mgr_osd_tree.nodes.type_id`*::
+
--
Type ID
...
*`ceph.mgr_osd_tree.nodes.children`*::
+
--
Node children
...
*`ceph.mgr_osd_tree.nodes.reweight`*::
+
--
Reweight
...
*`ceph.mgr_osd_tree.nodes.exists`*::
+
--
Exists
...
*`ceph.mgr_osd_tree.nodes.status`*::
+
--
Node status
...
*`ceph.mgr_osd_tree.nodes.primary_affinity`*::
+
--
Primary affinity
...
*`ceph.mgr_osd_tree.nodes.crush_weight`*::
+
--
CRUSH weight
