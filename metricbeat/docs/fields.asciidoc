...
*`mysql.status.cert.deps_distance`*::
+
--
type: double
...
*`mysql.status.flow_ctl.paused_ns`*::
+
--
type: long
...
*`mysql.status.local.cert_failures`*::
+
--
type: long
...
*`mysql.status.local.recv.queue_avg`*::
+
--
type: double
...
*`mysql.status.local.recv.queue_max`*::
+
--
type: long
...
*`mysql.status.local.recv.queue_min`*::
+
--
type: long
...
*`mysql.status.local.send.queue_avg`*::
+
--
type: double
...
*`mysql.status.local.send.queue_max`*::
+
--
type: long
...
*`mysql.status.local.send.queue_min`*::
+
--
type: long
