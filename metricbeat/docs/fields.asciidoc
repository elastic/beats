...
*`etcd.metrics.disk.wal_fsync_duration_ns.bucket.*`*::
+
--
type: object
...
*`etcd.metrics.disk.wal_fsync_duration_ns.count`*::
+
--
type: long
...
*`etcd.metrics.disk.wal_fsync_duration_ns.sum`*::
+
--
type: scaled_float
...
*`etcd.metrics.disk.backend_commit_duration_ns.bucket.*`*::
+
--
type: object
...
*`etcd.metrics.disk.backend_commit_duration_ns.count`*::
+
--
type: long
...
*`etcd.metrics.disk.backend_commit_duration_ns.sum`*::
+
--
type: scaled_float
...
*`etcd.metrics.network.client_grpc_received_bytes_total`*::
+
--
type: long
...
*`etcd.metrics.network.client_grpc_sent_bytes_total`*::
+
--
type: long
