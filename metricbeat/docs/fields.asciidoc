...
*`aws.s3_request.delete_requests`*::
+
--
type: long
...
*`aws.s3_request.select_requests`*::
+
--
type: long
...
*`aws.s3_request.select_scanned.bytes`*::
+
--
type: scaled_float
...
*`aws.s3_request.select_returned.bytes`*::
+
--
type: scaled_float
...
*`aws.s3_request.bytes_downloaded`*::
+
--
type: scaled_float
...
*`aws.s3_request.first_byte_latency`*::
+
--
type: long
...
*`aws.s3_request.total_request_latency`*::
+
--
type: long
