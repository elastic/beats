...
*`logstash.node.stats.pipelines.cgroup.cpuacct.usage_nanos`*::
+
--
type: long
...
*`logstash.node.stats.pipelines.cgroup.cpu.stat.number_of_elapsed_periods`*::
+
--
type: long
...
*`logstash.node.stats.pipelines.cgroup.cpu.stat.time_throttled_nanos`*::
+
--
type: long
...
*`logstash.node.stats.pipelines.cgroup.cpu.stat.number_of_times_throttled`*::
+
--
type: long
