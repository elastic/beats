...
*`elasticsearch.enrich.coordinator_stats.queue.size`*::
+
--
...
*`elasticsearch.enrich.coordinator_stats.executed_searches.count`*::
+
--
...
*`elasticsearch.enrich.coordinator_stats.remote_requests.current`*::
+
--
...
*`elasticsearch.enrich.coordinator_stats.remote_requests.count`*::
+
--
...
alias to: elasticsearch.enrich.coordinator_stats.queue.size
...
alias to: elasticsearch.coordinator_stats.remote_requests.current
...
alias to: elasticsearch.coordinator_stats.remote_requests.count
...
alias to: elasticsearch.coordinator_stats.executed_searches.count
