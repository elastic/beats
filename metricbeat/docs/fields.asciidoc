...
[float]
== kubecontroller fields

Kubernetes controller manager metrics



*`kubernetes.kubecontroller.handler`*::
+
--
type: keyword
...
*`kubernetes.kubecontroller.code`*::
+
--
type: keyword
...
*`kubernetes.kubecontroller.method`*::
+
--
type: keyword
...
*`kubernetes.kubecontroller.host`*::
+
--
type: keyword
...
*`kubernetes.kubecontroller.name`*::
+
--
type: keyword
...
*`kubernetes.kubecontroller.zone`*::
+
--
type: keyword
...
*`kubernetes.kubecontroller.process.cpu.sec`*::
+
--
type: scaled_float
...
*`kubernetes.kubecontroller.process.memory.resident.bytes`*::
+
--
type: long
...
*`kubernetes.kubecontroller.process.memory.virtual.bytes`*::
+
--
type: long
...
*`kubernetes.kubecontroller.process.fds.open.count`*::
+
--
type: integer
...
*`kubernetes.kubecontroller.process.started.sec`*::
+
--
type: scaled_float
...
*`kubernetes.kubecontroller.http.request.duration.us.percentile.*`*::
+
--
type: scaled_float
...
*`kubernetes.kubecontroller.http.request.duration.us.sum`*::
+
--
type: scaled_float
...
*`kubernetes.kubecontroller.http.request.duration.us.count`*::
+
--
type: long
...
*`kubernetes.kubecontroller.http.request.size.bytes.percentile.*`*::
+
--
type: integer
...
*`kubernetes.kubecontroller.http.request.size.bytes.sum`*::
+
--
type: long
...
*`kubernetes.kubecontroller.http.request.size.bytes.count`*::
+
--
type: long
...
*`kubernetes.kubecontroller.http.response.size.bytes.percentile.*`*::
+
--
type: integer
...
*`kubernetes.kubecontroller.http.response.size.bytes.sum`*::
+
--
type: long
...
*`kubernetes.kubecontroller.http.response.size.bytes.count`*::
+
--
type: long
...
*`kubernetes.kubecontroller.http.request.count`*::
+
--
type: long
...
*`kubernetes.kubecontroller.client.request.count`*::
+
--
type: long
...
*`kubernetes.kubecontroller.workqueue.longestrunning.sec`*::
+
--
type: scaled_float
...
*`kubernetes.kubecontroller.workqueue.unfinished.sec`*::
+
--
type: scaled_float
...
*`kubernetes.kubecontroller.node.collector.eviction.count`*::
+
--
type: long
...
*`kubernetes.kubecontroller.node.collector.unhealthy.count`*::
+
--
type: long
...
*`kubernetes.kubecontroller.node.collector.count`*::
+
--
type: long
...
*`kubernetes.kubecontroller.node.collector.health.pct`*::
+
--
type: integer
...
*`kubernetes.kubecontroller.leader.is_master`*::
+
--
type: int
