...
+
--
Number of requests to API server, broken down by verb and host
...
+
--
Count of network programming latency
...
+
--
Number of attempts, broken down by profile and result
