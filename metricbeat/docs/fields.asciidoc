...
*`kubernetes.proxy.http.request.duration.us`*::
+
--
...
*`kubernetes.proxy.http.request.size.bytes`*::
+
--
HTTP request size
...
*`kubernetes.proxy.http.response.size.bytes`*::
+
--
HTTP response size
