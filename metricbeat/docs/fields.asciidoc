...
alias to: elasticsearch.cluster.stats.nodes.count.total
...
alias to: elasticsearch.cluster.stats.nodes.count.master

--

*`elasticsearch.cluster.stats.nodes.count.master`*::
+
--
...
alias to: elasticsearch.cluster.stats.nodes.count.data

--

*`elasticsearch.cluster.stats.nodes.count.data`*::
+
--
