...
*`node_stats.thread_pool.force_merge.queue`*::
+
--
type: alias

alias to: elasticsearch.node.stats.thread_pool.force_merge.queue.count

--

*`node_stats.thread_pool.force_merge.rejected`*::
+
--
type: alias

alias to: elasticsearch.node.stats.thread_pool.force_merge.rejected.count
