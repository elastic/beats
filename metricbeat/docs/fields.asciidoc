...
[float]
=== task_manager_utilization

The percentage of task manager workers running or about to run tasks during the latest claim cycle.


*`kibana.task_manager.utilization.load`*::
+
--
type: scaled_float
