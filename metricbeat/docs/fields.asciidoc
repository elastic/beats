...
*`etcd.metrics.server.leader_changes_seen_total`*::
+
--
type: integer
...
*`etcd.metrics.server.proposals_committed_total`*::
+
--
type: long
...
*`etcd.metrics.server.proposals_failed_total`*::
+
--
type: long
...
*`etcd.metrics.server.proposals_pending`*::
+
--
type: long
...
*`etcd.metrics.server.grpc_handled_total`*::
+
--
type: long
...
*`etcd.metrics.server.grpc_started_total`*::
+
--
type: long
...
*`etcd.metrics.disk.mvcc_db_total_size_in_bytes`*::
+
--
type: long
...
*`etcd.metrics.disk.wal_fsync_duration_seconds.bucket`*::
+
--
type: object
...
*`etcd.metrics.disk.wal_fsync_duration_seconds.count`*::
+
--
type: long
...
*`etcd.metrics.disk.wal_fsync_duration_seconds.sum`*::
+
--
type: scaled_float
...
*`etcd.metrics.disk.backend_commit_duration_seconds.bucket`*::
+
--
type: object
...
*`etcd.metrics.disk.backend_commit_duration_seconds.count`*::
+
--
type: long
...
*`etcd.metrics.disk.backend_commit_duration_seconds.sum`*::
+
--
type: scaled_float
...
*`etcd.metrics.memory.go_memstats_alloc_bytes`*::
+
--
type: long
...
*`etcd.metrics.netowrk.client_grpc_received_bytes_total`*::
+
--
type: long
...
*`etcd.metrics.netowrk.client_grpc_sent_bytes_total`*::
+
--
type: long

gRPC received sent total
