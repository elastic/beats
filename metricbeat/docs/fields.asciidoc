...
[float]
=== vsphere.datastore_usage.capacity.bytes
...
[float]
=== vsphere.datastore_usage.freespace.bytes
...
[float]
=== vsphere.datastore_usage.usedspace.bytes
...
[float]
=== vsphere.datastore_usage.usedspace.percent
