...
kubernetes state metrics data



*`kubernetes.statemetrics.certificatesigningrequest.cert.length`*::
+
--
type: long
...
*`kubernetes.statemetrics.certificatesigningrequest.condition.count`*::
+
--
type: long
...
*`kubernetes.statemetrics.certificatesigningrequest.created`*::
+
--
type: date
...
*`kubernetes.statemetrics.certificatesigningrequest.name`*::
+
--
type: keyword
...
*`kubernetes.statemetrics.certificatesigningrequest.condition.status`*::
+
--
type: keyword
...
*`kubernetes.statemetrics.configmap.created`*::
+
--
type: date
...
*`kubernetes.statemetrics.configmap.name`*::
+
--
type: keyword
...
*`kubernetes.statemetrics.configmap.resource_version`*::
+
--
type: long
