...
[float]
=== ceph.df.pools.stats.bytes_used
...
[float]
=== ceph.df.pools.stats.max_avail

type: long

Free space of the pool


[float]
=== ceph.df.pools.stats.objects

type: long

Notional number of objects stored per pool


[float]
=== ceph.df.stats.total_avail_bytes

type: long

Free bytes of cluster


[float]
=== ceph.df.stats.total_bytes

type: long

Total bytes of cluster


[float]
=== ceph.df.stats.total_used_bytes

type: long

Used bytes of cluster
...
[float]
=== ceph.osdpoolstats.client_io_rate.read_bytes_sec

type: long

Bytes readed per sec


[float]
=== ceph.osdpoolstats.client_io_rate.write_bytes_sec
...
[float]
=== ceph.osdpoolstats.client_io_rate.read_op_per_sec

type: long

Read operations per sec


[float]
=== ceph.osdpoolstats.client_io_rate.write_op_per_sec
...
[float]
=== ceph.osdpoolstats.recovery_rate.recovering_objects_per_sec

type: long

Recovering objects per sec


[float]
=== ceph.osdpoolstats.recovery_rate.recovering_bytes_per_sec

type: long

Recovering bytes per sec


[float]
=== ceph.osdpoolstats.recovery_rate.recovering_keys_per_sec

type: long

Recovering keys per sec
...
[float]
=== ceph.status.health.mons.avail_percent
...
[float]
=== ceph.status.health.mons.health
...
[float]
=== ceph.status.health.mons.kb_avail
...
[float]
=== ceph.status.health.mons.kb_total
...
[float]
=== ceph.status.health.mons.kb_used
...
[float]
=== ceph.status.health.mons.last_updated
...
[float]
=== ceph.status.health.mons.store_stats.bytes_log
...
[float]
=== ceph.status.health.mons.store_stats.bytes_misc
...
[float]
=== ceph.status.health.mons.store_stats.bytes_sst
...
[float]
=== ceph.status.health.mons.store_stats.bytes_total
...
[float]
=== ceph.status.health.mons.store_stats.last_updated
...
[float]
=== ceph.status.health.timechecks.epoch
...
[float]
=== ceph.status.health.timechecks.round
...
[float]
=== ceph.status.health.timechecks.round_stats
...
[float]
=== ceph.status.osdmap.full

type: boolean

True if osdmap is full


[float]
=== ceph.status.osdmap.nearfull

type: boolean

True if osdmap is nearfull


[float]
=== ceph.status.osdmap.num_in_osds

type: long

OSD number participating


[float]
=== ceph.status.osdmap.num_osds

type: long

Number of known OSDs


[float]
=== ceph.status.osdmap.num_remapped_pgs

type: long

Number of placement groups remapped


[float]
=== ceph.status.osdmap.num_up_osds
...
[float]
=== ceph.status.pgmap.pgs_by_state.count
...
[float]
=== ceph.status.pgmap.pgs_by_state.state_name
...
Setting of Memory quota for the Index service (Mbyte)
...
Setting of Memory quota for the cluster (Mbyte)
