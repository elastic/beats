...
Couchbase index metrics.



*`couchbase.index.name`*::
+
--
Name of the index as returned by Couchbase REST API in format "keyspace:index_name"
...
*`couchbase.index.avg_scan_latency.ns`*::
+
--
Average time to serve a scan request in nanoseconds.

type: long

--

*`couchbase.index.cache.hits`*::
+
--
...
*`couchbase.index.data_size.bytes`*::
+
--
The size of indexable data that is maintained for the index or partition.

type: long

--

*`couchbase.index.disk_size.bytes`*::
+
--
...
*`couchbase.index.memory_used.bytes`*::
+
--
Amount of memory used by the Index service on this node.
...
*`couchbase.index.items_flushed.count`*::
+
--
...
*`couchbase.index.requests.pending.count`*::
+
--
...
*`couchbase.index.requests.count`*::
+
--
...
*`couchbase.index.scan.timeouts.count`*::
+
--
...
*`couchbase.index.scan.errors.count`*::
+
--
