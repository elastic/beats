...
List of all the processes with details



*`php_fpm.pool.processes.details.pid`*::
+
--
type: integer
...
*`php_fpm.pool.processes.details.state`*::
+
--
type: string
...
*`php_fpm.pool.processes.details.start_time`*::
+
--
type: date
...
*`php_fpm.pool.processes.details.start_since`*::
+
--
type: integer
...
*`php_fpm.pool.processes.details.requests`*::
+
--
type: integer
...
*`php_fpm.pool.processes.details.request_duration`*::
+
--
type: integer
...
*`php_fpm.pool.processes.details.request_method`*::
+
--
type: string
...
*`php_fpm.pool.processes.details.request_uri`*::
+
--
type: string
...
*`php_fpm.pool.processes.details.content_length`*::
+
--
type: integer
...
*`php_fpm.pool.processes.details.user`*::
+
--
type: string
...
*`php_fpm.pool.processes.details.script`*::
+
--
type: string
...
*`php_fpm.pool.processes.details.last_request_cpu`*::
+
--
type: long
...
*`php_fpm.pool.processes.details.last_request_memory`*::
+
--
type: integer
