...
*`system.services.resources.network.in.bytes`*::
+
--
bytes in
...
*`system.services.resources.network.in.packets`*::
+
--
packets in
...
*`system.services.resources.network.out.packets`*::
+
--
packets out
...
*`system.services.resources.network.out.bytes`*::
+
--
bytes out
