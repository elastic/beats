...
*`coredns.stats.runtime.memory.alloc.bytes`*::
+
--
type: long
...
*`coredns.stats.runtime.process.threads.count`*::
+
--
type: long
...
*`coredns.stats.runtime.process.go.routines.count`*::
+
--
type: long

Running Go routines count
