...
This group contains swap stats from vmstats on linux


*`system.memory.swap.vmstat.pswpin`*::
+
--
Pages swapped in
...
*`system.memory.swap.vmstat.pswpout`*::
+
--
Pages swapped out
...
*`system.memory.swap.vmstat.thp_swpout`*::
+
--
Huge page swap stats

type: long

--

*`system.memory.swap.vmstat.thp_swpout_fallback`*::
+
--
Huge page swap stats
...
*`system.memory.swap.vmstat.swap_ra`*::
+
--
Swap readahead stats

type: long

--

*`system.memory.swap.vmstat.swap_ra_hit`*::
+
--
Swap readahead stats
