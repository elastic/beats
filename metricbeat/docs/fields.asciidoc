...
[float]
== innodb_buffer_pool fields




*`mysql.status.innodb_buffer_pool.dump_status`*::
+
--
type: long
...
*`mysql.status.innodb_buffer_pool.load_status`*::
+
--
type: long
...
*`mysql.status.innodb_buffer_pool.bytes.data`*::
+
--
type: long
...
*`mysql.status.innodb_buffer_pool.bytes.dirty`*::
+
--
type: long
...
*`mysql.status.innodb_buffer_pool.pages.data`*::
+
--
type: long
...
*`mysql.status.innodb_buffer_pool.pages.dirty`*::
+
--
type: long
...
*`mysql.status.innodb_buffer_pool.pages.flushed`*::
+
--
type: long
...
*`mysql.status.innodb_buffer_pool.pages.free`*::
+
--
type: long
...
*`mysql.status.innodb_buffer_pool.pages.latched`*::
+
--
type: long
...
*`mysql.status.innodb_buffer_pool.pages.misc`*::
+
--
type: long
...
*`mysql.status.innodb_buffer_pool.pages.total`*::
+
--
type: long
...
*`mysql.status.innodb_buffer_pool.read.ahead`*::
+
--
type: long
...
*`mysql.status.innodb_buffer_pool.read.ahead_evicted`*::
+
--
type: long
...
*`mysql.status.innodb_buffer_pool.read.ahead_rnd`*::
+
--
type: long
...
*`mysql.status.innodb_buffer_pool.read.requests`*::
+
--
type: long
...
*`mysql.status.innodb_buffer_pool.pool.reads`*::
+
--
type: long
...
*`mysql.status.innodb_buffer_pool.pool.resize_status`*::
+
--
type: long
...
*`mysql.status.innodb_buffer_pool.pool.wait_free`*::
+
--
type: long
...
*`mysql.status.innodb_buffer_pool.write_requests`*::
+
--
type: long
