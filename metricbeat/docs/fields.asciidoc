...
*`aws.s3_daily_storage.bucket.storage.type`*::
+
--
type: keyword

Storage type specified for each S3 bucket.


--

*`aws.s3_daily_storage.object.count`*::
+
--
type: long
...
*`aws.s3_request.bucket.filter_id`*::
+
--
type: keyword

Filter id is a dimension configured to filter metrics on a bucket.


--

*`aws.s3_request.bucket.all_requests`*::
+
--
type: long
...
*`aws.s3_request.bucket.get_requests`*::
+
--
type: long
...
*`aws.s3_request.bucket.put_requests`*::
+
--
type: long
...
*`aws.s3_request.bucket.delete_requests`*::
+
--
type: long
...
*`aws.s3_request.bucket.head_requests`*::
+
--
type: long
...
*`aws.s3_request.bucket.post_requests`*::
+
--
type: long
...
*`aws.s3_request.bucket.select_requests`*::
+
--
type: long
...
*`aws.s3_request.bucket.select_scanned_bytes`*::
+
--
type: scaled_float
...
*`aws.s3_request.bucket.select_returned_bytes`*::
+
--
type: scaled_float
...
*`aws.s3_request.bucket.list_requests`*::
+
--
type: long
...
*`aws.s3_request.bucket.bytes_downloaded`*::
+
--
type: scaled_float
...
*`aws.s3_request.bucket.bytes_uploaded`*::
+
--
type: scaled_float
...
*`aws.s3_request.bucket.4xx_errors`*::
+
--
type: long
...
*`aws.s3_request.bucket.5xx_errors`*::
+
--
type: long
...
*`aws.s3_request.bucket.first_byte_latency`*::
+
--
type: scaled_float
...
*`aws.s3_request.bucket.total_request_latency`*::
+
--
type: scaled_float
