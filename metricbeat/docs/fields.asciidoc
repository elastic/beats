...
alias to: elasticsearch.index.summary.primaries.search.query.count
...
alias to: elasticsearch.index.summary.primaries.search.query.time.ms
...
alias to: elasticsearch.index.summary.primaries.bulk.operations.count
...
alias to: elasticsearch.index.summary.primaries.bulk.time.count.ms
...
alias to: elasticsearch.index.summary.primaries.bulk.time.avg.ms
...
alias to: elasticsearch.index.summary.primaries.bulk.time.avg.bytes
...
alias to: elasticsearch.index.summary.primaries.bulk.size.bytes
...
alias to: elasticsearch.index.summary.primaries.indexing.is_throttled
...
alias to: elasticsearch.index.summary.primaries.indexing.throttled_time.ms
...
alias to: elasticsearch.index.summary.total.bulk.operations.count
...
alias to: elasticsearch.index.summary.total.bulk.time.count.ms
...
alias to: elasticsearch.index.summary.total.bulk.time.avg.ms
...
alias to: elasticsearch.index.summary.total.bulk.time.avg.bytes
...
alias to: elasticsearch.index.summary.total.bulk.size.bytes
...
alias to: elasticsearch.index.summary.total.indexing.index.time.ms
...
alias to: elasticsearch.index.summary.total.indexing.is_throttled
...
alias to: elasticsearch.index.summary.total.indexing.throttled_time.ms
...
*`indices_stats.ccr.leader.index`*::
+
--
...
*`indices_stats.ccr.leader.max_seq_no`*::
+
--
...
*`indices_stats.ccr.follower.index`*::
+
--
...
*`indices_stats.ccr.follower.shard.number`*::
+
--
...
*`indices_stats.ccr.follower.operations_written`*::
+
--
...
*`indices_stats.ccr.follower.time_since_last_read.ms`*::
+
--
...
*`indices_stats.ccr.follower.global_checkpoint`*::
+
--
...
*`indices_stats.cluster.stats.status`*::
+
--
...
*`indices_stats.cluster.stats.nodes.count`*::
+
--
...
*`indices_stats.cluster.stats.nodes.master`*::
+
--
...
*`indices_stats.cluster.stats.nodes.data`*::
+
--
...
*`indices_stats.cluster.stats.indices.count`*::
+
--
...
*`indices_stats.cluster.stats.indices.shards.count`*::
+
--
...
*`indices_stats.cluster.stats.indices.shards.primaries`*::
+
--
...
*`indices_stats.cluster.stats.indices.fielddata.memory.bytes`*::
+
--
...
*`indices_stats.enrich.queue.size`*::
+
--
...
*`indices_stats.enrich.remote_requests.current`*::
+
--
...
*`indices_stats.enrich.remote_requests.total`*::
+
--
...
*`indices_stats.enrich.executed_searches.total`*::
+
--
...
*`indices_stats.index.total.docs.count`*::
+
--
...
*`indices_stats.index.total.docs.deleted`*::
+
--
...
*`indices_stats.index.total.store.size.bytes`*::
+
--
...
*`indices_stats.index.total.segments.count`*::
+
--
...
*`indices_stats.index.total.segments.memory.bytes`*::
+
--
...
*`indices_stats.index.recovery.id`*::
+
--
Shard recovery id.
...
*`indices_stats.index.recovery.type`*::
+
--
Shard recovery type.
...
*`indices_stats.index.recovery.primary`*::
+
--
...
*`indices_stats.index.recovery.stage`*::
+
--
Recovery stage.
...
*`indices_stats.index.recovery.target.id`*::
+
--
Target node id.
...
*`indices_stats.index.recovery.target.host`*::
+
--
...
*`indices_stats.index.recovery.target.name`*::
+
--
Target node name.
...
*`indices_stats.index.recovery.source.id`*::
+
--
Source node id.
...
*`indices_stats.index.recovery.source.host`*::
+
--
...
*`indices_stats.index.recovery.source.name`*::
+
--
Source node name.
...
*`indices_stats.index.summary.primaries.docs.count`*::
+
--
Total number of documents in the index.
...
*`indices_stats.index.summary.primaries.docs.deleted`*::
+
--
Total number of deleted documents in the index.
...
*`indices_stats.index.summary.primaries.store.size.bytes`*::
+
--
Total size of the index in bytes.
...
*`indices_stats.index.summary.primaries.segments.count`*::
+
--
Total number of index segments.
...
*`indices_stats.index.summary.primaries.segments.memory.bytes`*::
+
--
Total number of memory used by the segments in bytes.
...
*`indices_stats.index.summary.primaries.indexing.index.count`*::
+
--
TODO
...
*`indices_stats.index.summary.primaries.indexing.index.time.ms`*::
+
--
TODO
...
*`indices_stats.index.summary.primaries.indexing.is_throttled`*::
+
--
TODO
...
*`indices_stats.index.summary.primaries.indexing.throttle_time`*::
+
--
TODO
...
*`indices_stats.index.summary.primaries.search.query.count`*::
+
--
TODO
...
*`indices_stats.index.summary.primaries.search.query.time.ms`*::
+
--
TODO
...
*`indices_stats.index.summary.primaries.bulk.operations.count`*::
+
--
TODO
...
*`indices_stats.index.summary.primaries.bulk.size.bytes`*::
+
--
TODO
...
*`indices_stats.index.summary.primaries.bulk.time.count.ms`*::
+
--
TODO
...
*`indices_stats.index.summary.primaries.bulk.time.avg.ms`*::
+
--
TODO
...
*`indices_stats.index.summary.primaries.bulk.time.avg.bytes`*::
+
--
TODO
...
*`indices_stats.index.summary.total.docs.count`*::
+
--
Total number of documents in the index.
...
*`indices_stats.index.summary.total.docs.deleted`*::
+
--
Total number of deleted documents in the index.
...
*`indices_stats.index.summary.total.store.size.bytes`*::
+
--
Total size of the index in bytes.
...
*`indices_stats.index.summary.total.segments.count`*::
+
--
Total number of index segments.
...
*`indices_stats.index.summary.total.segments.memory.bytes`*::
+
--
Total number of memory used by the segments in bytes.
...
*`indices_stats.index.summary.total.indexing.index.count`*::
+
--
TODO
...
*`indices_stats.index.summary.total.indexing.index.time.ms`*::
+
--
TODO
...
*`indices_stats.index.summary.total.indexing.is_throttled`*::
+
--
TODO
...
*`indices_stats.index.summary.total.indexing.throttle_time`*::
+
--
TODO
...
*`indices_stats.index.summary.total.search.query.count`*::
+
--
TODO
...
*`indices_stats.index.summary.total.search.query.time.ms`*::
+
--
TODO
...
*`indices_stats.index.summary.total.bulk.operations.count`*::
+
--
TODO
...
*`indices_stats.index.summary.total.bulk.size.bytes`*::
+
--
TODO
...
*`indices_stats.index.summary.total.bulk.time.count.ms`*::
+
--
TODO
...
*`indices_stats.index.summary.total.bulk.time.avg.ms`*::
+
--
TODO
...
*`indices_stats.index.summary.total.bulk.time.avg.bytes`*::
+
--
TODO
...
*`indices_stats.ml.job.data_counts.processed_record_count`*::
+
--
...
*`indices_stats.ml.job.data_counts.invalid_date_count`*::
+
--
...
*`indices_stats.node.jvm.version`*::
+
--
JVM version.
...
*`indices_stats.node.jvm.memory.heap.init.bytes`*::
+
--
Heap init used by the JVM in bytes.
...
*`indices_stats.node.jvm.memory.heap.max.bytes`*::
+
--
...
*`indices_stats.node.jvm.memory.nonheap.init.bytes`*::
+
--
...
*`indices_stats.node.jvm.memory.nonheap.max.bytes`*::
+
--
...
*`indices_stats.node.process.mlockall`*::
+
--
...
*`indices_stats.node.stats.indices.docs.count`*::
+
--
...
*`indices_stats.node.stats.indices.docs.deleted`*::
+
--
...
*`indices_stats.node.stats.indices.segments.count`*::
+
--
...
*`indices_stats.node.stats.indices.segments.memory.bytes`*::
+
--
...
*`indices_stats.node.stats.indices.store.size.bytes`*::
+
--
...
*`indices_stats.node.stats.indices.fielddata.memory.bytes`*::
+
--
type: long
...
*`indices_stats.node.stats.indices.indexing.index_time.ms`*::
+
--
type: long
...
*`indices_stats.node.stats.indices.indexing.index_total.count`*::
+
--
type: long
...
*`indices_stats.node.stats.indices.indexing.throttle_time.ms`*::
+
--
type: long
...
*`indices_stats.node.stats.indices.query_cache.memory.bytes`*::
+
--
type: long
...
*`indices_stats.node.stats.indices.request_cache.memory.bytes`*::
+
--
type: long
...
*`indices_stats.node.stats.indices.search.query_time.ms`*::
+
--
type: long
...
*`indices_stats.node.stats.indices.search.query_total.count`*::
+
--
type: long
...
*`indices_stats.node.stats.indices.segments.doc_values.memory.bytes`*::
+
--
type: long
...
*`indices_stats.node.stats.indices.segments.fixed_bit_set.memory.bytes`*::
+
--
type: long
...
*`indices_stats.node.stats.indices.segments.index_writer.memory.bytes`*::
+
--
type: long
...
*`indices_stats.node.stats.indices.segments.norms.memory.bytes`*::
+
--
type: long
...
*`indices_stats.node.stats.indices.segments.points.memory.bytes`*::
+
--
type: long
...
*`indices_stats.node.stats.indices.segments.stored_fields.memory.bytes`*::
+
--
type: long
...
*`indices_stats.node.stats.indices.segments.term_vectors.memory.bytes`*::
+
--
type: long
...
*`indices_stats.node.stats.indices.segments.terms.memory.bytes`*::
+
--
type: long
...
*`indices_stats.node.stats.indices.segments.version_map.memory.bytes`*::
+
--
type: long
...
*`indices_stats.node.stats.jvm.mem.heap.max.bytes`*::
+
--
type: long
...
*`indices_stats.node.stats.jvm.mem.heap.used.bytes`*::
+
--
type: long
...
*`indices_stats.node.stats.jvm.mem.heap.used.pct`*::
+
--
type: long
...
*`indices_stats.node.stats.jvm.mem.pools.old.max.bytes`*::
+
--
Max bytes.
...
*`indices_stats.node.stats.jvm.mem.pools.old.peak.bytes`*::
+
--
Peak bytes.
...
*`indices_stats.node.stats.jvm.mem.pools.old.peak_max.bytes`*::
+
--
Peak max bytes.
...
*`indices_stats.node.stats.jvm.mem.pools.old.used.bytes`*::
+
--
Used bytes.
...
*`indices_stats.node.stats.jvm.mem.pools.young.max.bytes`*::
+
--
Max bytes.
...
*`indices_stats.node.stats.jvm.mem.pools.young.peak.bytes`*::
+
--
Peak bytes.
...
*`indices_stats.node.stats.jvm.mem.pools.young.peak_max.bytes`*::
+
--
Peak max bytes.
...
*`indices_stats.node.stats.jvm.mem.pools.young.used.bytes`*::
+
--
Used bytes.
...
*`indices_stats.node.stats.jvm.mem.pools.survivor.max.bytes`*::
+
--
Max bytes.
...
*`indices_stats.node.stats.jvm.mem.pools.survivor.peak.bytes`*::
+
--
Peak bytes.
...
*`indices_stats.node.stats.jvm.mem.pools.survivor.peak_max.bytes`*::
+
--
Peak max bytes.
...
*`indices_stats.node.stats.jvm.mem.pools.survivor.used.bytes`*::
+
--
Used bytes.
...
*`indices_stats.node.stats.jvm.gc.collectors.old.collection.count`*::
+
--
...
*`indices_stats.node.stats.jvm.gc.collectors.old.collection.ms`*::
+
--
...
*`indices_stats.node.stats.jvm.gc.collectors.young.collection.count`*::
+
--
...
*`indices_stats.node.stats.jvm.gc.collectors.young.collection.ms`*::
+
--
...
*`indices_stats.node.stats.fs.summary.total.bytes`*::
+
--
...
*`indices_stats.node.stats.fs.summary.free.bytes`*::
+
--
...
*`indices_stats.node.stats.fs.summary.available.bytes`*::
+
--
...
*`indices_stats.node.stats.fs.io_stats.total.operations.count`*::
+
--
type: long
...
*`indices_stats.node.stats.fs.io_stats.total.read.operations.count`*::
+
--
type: long
...
*`indices_stats.node.stats.fs.io_stats.total.write.operations.count`*::
+
--
type: long
...
*`indices_stats.node.stats.os.cpu.load_avg.1m`*::
+
--
type: long
...
*`indices_stats.node.stats.os.cgroup.cpuacct.usage.ns`*::
+
--
type: long
...
*`indices_stats.node.stats.os.cgroup.cpu.cfs.quota.us`*::
+
--
type: long
...
*`indices_stats.node.stats.os.cgroup.cpu.stat.elapsed_periods.count`*::
+
--
type: long
...
*`indices_stats.node.stats.os.cgroup.cpu.stat.times_throttled.count`*::
+
--
type: long
...
*`indices_stats.node.stats.os.cgroup.cpu.stat.time_throttled.ns`*::
+
--
type: long
...
*`indices_stats.node.stats.os.cgroup.memory.control_group`*::
+
--
type: keyword
...
*`indices_stats.node.stats.os.cgroup.memory.limit.bytes`*::
+
--
type: long
...
*`indices_stats.node.stats.os.cgroup.memory.usage.bytes`*::
+
--
type: long
...
*`indices_stats.node.stats.process.cpu.pct`*::
+
--
type: long
...
*`indices_stats.node.stats.thread_pool.bulk.queue.count`*::
+
--
type: long
...
*`indices_stats.node.stats.thread_pool.bulk.rejected.count`*::
+
--
type: long
...
*`indices_stats.node.stats.thread_pool.get.queue.count`*::
+
--
type: long
...
*`indices_stats.node.stats.thread_pool.get.rejected.count`*::
+
--
type: long
...
*`indices_stats.node.stats.thread_pool.index.queue.count`*::
+
--
type: long
...
*`indices_stats.node.stats.thread_pool.index.rejected.count`*::
+
--
type: long
...
*`indices_stats.node.stats.thread_pool.search.queue.count`*::
+
--
type: long
...
*`indices_stats.node.stats.thread_pool.search.rejected.count`*::
+
--
type: long
...
*`indices_stats.node.stats.thread_pool.write.queue.count`*::
+
--
type: long
...
*`indices_stats.node.stats.thread_pool.write.rejected.count`*::
+
--
type: long
...
*`indices_stats.cluster.pending_task.insert_order`*::
+
--
Insert order
...
*`indices_stats.cluster.pending_task.priority`*::
+
--
Priority
...
*`indices_stats.cluster.pending_task.source`*::
+
--
...
*`indices_stats.cluster.pending_task.time_in_queue.ms`*::
+
--
Time in queue
...
*`indices_stats.shard.relocating_node.name`*::
+
--
