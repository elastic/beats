...
*`host.billing.metrics.EstimatedCharges.max`*::
+
--
...
*`host.dynamodb.metrics.SuccessfulRequestLatency.avg`*::
+
--
...
*`host.dynamodb.metrics.SuccessfulRequestLatency.max`*::
+
--
...
*`host.dynamodb.metrics.OnlineIndexPercentageProgress.avg`*::
+
--
...
*`host.dynamodb.metrics.ProvisionedWriteCapacityUnits.avg`*::
+
--
...
*`host.dynamodb.metrics.ProvisionedReadCapacityUnits.avg`*::
+
--
...
*`host.dynamodb.metrics.ConsumedReadCapacityUnits.avg`*::
+
--
...
*`host.dynamodb.metrics.ConsumedReadCapacityUnits.sum`*::
+
--
...
*`host.dynamodb.metrics.ConsumedWriteCapacityUnits.avg`*::
+
--
...
*`host.dynamodb.metrics.ConsumedWriteCapacityUnits.sum`*::
+
--
...
*`host.dynamodb.metrics.ReplicationLatency.avg`*::
+
--
...
*`host.dynamodb.metrics.ReplicationLatency.max`*::
+
--
...
*`host.dynamodb.metrics.TransactionConflict.avg`*::
+
--
...
*`host.dynamodb.metrics.AccountProvisionedReadCapacityUtilization.avg`*::
+
--
...
*`host.dynamodb.metrics.AccountProvisionedWriteCapacityUtilization.avg`*::
+
--
...
*`host.dynamodb.metrics.SystemErrors.sum`*::
+
--
...
*`host.dynamodb.metrics.ConditionalCheckFailedRequests.sum`*::
+
--
...
*`host.dynamodb.metrics.PendingReplicationCount.sum`*::
+
--
...
*`host.dynamodb.metrics.ReadThrottleEvents.sum`*::
+
--
...
*`host.dynamodb.metrics.ThrottledRequests.sum`*::
+
--
...
*`host.dynamodb.metrics.WriteThrottleEvents.sum`*::
+
--
...
*`host.dynamodb.metrics.AccountMaxReads.max`*::
+
--
...
*`host.dynamodb.metrics.AccountMaxTableLevelReads.max`*::
+
--
...
*`host.dynamodb.metrics.AccountMaxTableLevelWrites.max`*::
+
--
...
*`host.dynamodb.metrics.AccountMaxWrites.max`*::
+
--
...
*`host.dynamodb.metrics.MaxProvisionedTableReadCapacityUtilization.max`*::
+
--
...
*`host.dynamodb.metrics.MaxProvisionedTableWriteCapacityUtilization.max`*::
+
--
...
*`host.ebs.metrics.VolumeReadBytes.avg`*::
+
--
...
*`host.ebs.metrics.VolumeWriteBytes.avg`*::
+
--
...
*`host.ebs.metrics.VolumeReadOps.avg`*::
+
--
...
*`host.ebs.metrics.VolumeWriteOps.avg`*::
+
--
...
*`host.ebs.metrics.VolumeQueueLength.avg`*::
+
--
...
*`host.ebs.metrics.VolumeThroughputPercentage.avg`*::
+
--
...
*`host.ebs.metrics.VolumeConsumedReadWriteOps.avg`*::
+
--
...
*`host.ebs.metrics.BurstBalance.avg`*::
+
--
...
*`host.ebs.metrics.VolumeTotalReadTime.sum`*::
+
--
...
*`host.ebs.metrics.VolumeTotalWriteTime.sum`*::
+
--
...
*`host.ebs.metrics.VolumeIdleTime.sum`*::
+
--
...
*`host.ec2.cpu.surplus_credit_balance`*::
+
--
...
*`host.ec2.cpu.surplus_credits_charged`*::
+
--
...
*`host.ec2.network.in.packets_per_sec`*::
+
--
...
*`host.ec2.network.out.packets_per_sec`*::
+
--
The number of packets per second sent out on all network interfaces by the instance.
...
*`host.ec2.network.in.bytes_per_sec`*::
+
--
...
*`host.ec2.network.out.bytes_per_sec`*::
+
--
...
*`host.ec2.diskio.read.bytes_per_sec`*::
+
--
...
*`host.ec2.diskio.write.bytes_per_sec`*::
+
--
...
*`host.ec2.diskio.read.ops_per_sec`*::
+
--
...
*`host.ec2.diskio.write.ops_per_sec`*::
+
--
...
*`host.ec2.status.check_failed_system`*::
+
--
...
*`host.ec2.status.check_failed_instance`*::
+
--
...
*`host.ec2.instance.monitoring.state`*::
+
--
...
*`host.ec2.instance.public.dns_name`*::
+
--
...
*`host.ec2.instance.threads_per_core`*::
+
--
...
*`host.elb.metrics.BackendConnectionErrors.sum`*::
+
--
...
*`host.elb.metrics.HTTPCode_Backend_2XX.sum`*::
+
--
...
*`host.elb.metrics.HTTPCode_Backend_3XX.sum`*::
+
--
...
*`host.elb.metrics.HTTPCode_Backend_4XX.sum`*::
+
--
...
*`host.elb.metrics.HTTPCode_Backend_5XX.sum`*::
+
--
...
*`host.elb.metrics.HTTPCode_ELB_4XX.sum`*::
+
--
...
*`host.elb.metrics.HTTPCode_ELB_5XX.sum`*::
+
--
...
*`host.elb.metrics.RequestCount.sum`*::
+
--
...
*`host.elb.metrics.SpilloverCount.sum`*::
+
--
...
*`host.elb.metrics.HealthyHostCount.max`*::
+
--
...
*`host.elb.metrics.SurgeQueueLength.max`*::
+
--
...
*`host.elb.metrics.UnHealthyHostCount.max`*::
+
--
...
*`host.elb.metrics.EstimatedALBActiveConnectionCount.avg`*::
+
--
...
*`host.elb.metrics.EstimatedALBConsumedLCUs.avg`*::
+
--
...
*`host.elb.metrics.EstimatedALBNewConnectionCount.avg`*::
+
--
...
*`host.elb.metrics.EstimatedProcessedBytes.avg`*::
+
--
...
*`host.applicationelb.metrics.ActiveConnectionCount.sum`*::
+
--
...
*`host.applicationelb.metrics.ClientTLSNegotiationErrorCount.sum`*::
+
--
...
*`host.applicationelb.metrics.HTTP_Fixed_Response_Count.sum`*::
+
--
...
*`host.applicationelb.metrics.HTTP_Redirect_Count.sum`*::
+
--
...
*`host.applicationelb.metrics.HTTP_Redirect_Url_Limit_Exceeded_Count.sum`*::
+
--
...
*`host.applicationelb.metrics.HTTPCode_ELB_3XX_Count.sum`*::
+
--
...
*`host.applicationelb.metrics.HTTPCode_ELB_5XX_Count.sum`*::
+
--
...
*`host.applicationelb.metrics.HTTPCode_ELB_500_Count.sum`*::
+
--
...
*`host.applicationelb.metrics.HTTPCode_ELB_502_Count.sum`*::
+
--
...
*`host.applicationelb.metrics.HTTPCode_ELB_503_Count.sum`*::
+
--
...
*`host.applicationelb.metrics.HTTPCode_ELB_504_Count.sum`*::
+
--
...
*`host.applicationelb.metrics.IPv6ProcessedBytes.sum`*::
+
--
...
*`host.applicationelb.metrics.IPv6RequestCount.sum`*::
+
--
...
*`host.applicationelb.metrics.ProcessedBytes.sum`*::
+
--
...
*`host.applicationelb.metrics.RejectedConnectionCount.sum`*::
+
--
...
*`host.applicationelb.metrics.RequestCount.sum`*::
+
--
...
*`host.applicationelb.metrics.RuleEvaluations.sum`*::
+
--
...
*`host.applicationelb.metrics.ConsumedLCUs.avg`*::
+
--
...
*`host.networkelb.metrics.ActiveFlowCount.avg`*::
+
--
...
*`host.networkelb.metrics.ActiveFlowCount_TCP.avg`*::
+
--
...
*`host.networkelb.metrics.ActiveFlowCount_TLS.avg`*::
+
--
...
*`host.networkelb.metrics.ActiveFlowCount_UDP.avg`*::
+
--
...
*`host.networkelb.metrics.ConsumedLCUs.avg`*::
+
--
The number of load balancer capacity units (LCU) used by your load balancer.
...
*`host.networkelb.metrics.ClientTLSNegotiationErrorCount.sum`*::
+
--
...
*`host.networkelb.metrics.NewFlowCount.sum`*::
+
--
...
*`host.networkelb.metrics.NewFlowCount_TLS.sum`*::
+
--
...
*`host.networkelb.metrics.ProcessedBytes.sum`*::
+
--
...
*`host.networkelb.metrics.ProcessedBytes_TLS.sum`*::
+
--
...
*`host.networkelb.metrics.TargetTLSNegotiationErrorCount.sum`*::
+
--
...
*`host.networkelb.metrics.TCP_Client_Reset_Count.sum`*::
+
--
...
*`host.networkelb.metrics.TCP_ELB_Reset_Count.sum`*::
+
--
...
*`host.networkelb.metrics.TCP_Target_Reset_Count.sum`*::
+
--
...
*`host.networkelb.metrics.HealthyHostCount.max`*::
+
--
...
*`host.networkelb.metrics.UnHealthyHostCount.max`*::
+
--
...
*`host.lambda.metrics.Invocations.avg`*::
+
--
...
*`host.lambda.metrics.Errors.avg`*::
+
--
...
*`host.lambda.metrics.DeadLetterErrors.avg`*::
+
--
...
*`host.lambda.metrics.DestinationDeliveryFailures.avg`*::
+
--
...
*`host.lambda.metrics.Duration.avg`*::
+
--
...
*`host.lambda.metrics.Throttles.avg`*::
+
--
...
*`host.lambda.metrics.IteratorAge.avg`*::
+
--
...
*`host.lambda.metrics.ConcurrentExecutions.avg`*::
+
--
...
*`host.lambda.metrics.UnreservedConcurrentExecutions.avg`*::
+
--
...
*`host.lambda.metrics.ProvisionedConcurrentExecutions.max`*::
+
--
...
*`host.lambda.metrics.ProvisionedConcurrencyUtilization.max`*::
+
--
...
*`host.lambda.metrics.ProvisionedConcurrencyInvocations.sum`*::
+
--
...
*`host.lambda.metrics.ProvisionedConcurrencySpilloverInvocations.sum`*::
+
--
...
*`host.natgateway.metrics.BytesInFromDestination.sum`*::
+
--
...
*`host.natgateway.metrics.BytesInFromSource.sum`*::
+
--
...
*`host.natgateway.metrics.BytesOutToDestination.sum`*::
+
--
...
*`host.natgateway.metrics.BytesOutToSource.sum`*::
+
--
...
*`host.natgateway.metrics.ConnectionAttemptCount.sum`*::
+
--
...
*`host.natgateway.metrics.ConnectionEstablishedCount.sum`*::
+
--
...
*`host.natgateway.metrics.ErrorPortAllocation.sum`*::
+
--
...
*`host.natgateway.metrics.IdleTimeoutCount.sum`*::
+
--
...
*`host.natgateway.metrics.PacketsDropCount.sum`*::
+
--
...
*`host.natgateway.metrics.PacketsInFromDestination.sum`*::
+
--
...
*`host.natgateway.metrics.PacketsInFromSource.sum`*::
+
--
...
*`host.natgateway.metrics.PacketsOutToDestination.sum`*::
+
--
...
*`host.natgateway.metrics.PacketsOutToSource.sum`*::
+
--
...
*`host.natgateway.metrics.ActiveConnectionCount.max`*::
+
--
...
*`host.rds.db_instance.identifier`*::
+
--
...
*`host.rds.failed_sql_server_agent_jobs`*::
+
--
...
*`host.rds.freeable_memory.bytes`*::
+
--
...
*`host.rds.maximum_used_transaction_ids`*::
+
--
...
*`host.rds.oldest_replication_slot_lag.mb`*::
+
--
...
*`host.rds.transaction_logs_generation`*::
+
--
...
*`host.rds.free_local_storage.bytes`*::
+
--
...
*`host.rds.throughput.network_receive`*::
+
--
...
*`host.rds.throughput.network_transmit`*::
+
--
...
*`host.rds.disk_usage.bin_log.bytes`*::
+
--
...
*`host.rds.disk_usage.replication_slot.mb`*::
+
--
...
*`host.rds.disk_usage.transaction_logs.mb`*::
+
--
The disk space used by transaction logs. Applies to PostgreSQL.
...
*`host.rds.db_instance.engine_name`*::
+
--
...
*`host.rds.aurora_bin_log_replica_lag`*::
+
--
...
*`host.rds.aurora_global_db.replicated_write_io.bytes`*::
+
--
...
*`host.rds.aurora_global_db.replication_lag.ms`*::
+
--
...
*`host.rds.aurora_replica.lag.ms`*::
+
--
...
*`host.rds.aurora_replica.lag_min.ms`*::
+
--
...
*`host.rds.backtrack_change_records.creation_rate`*::
+
--
...
*`host.rds.backtrack_change_records.stored`*::
+
--
...
*`host.rds.backtrack_window.actual`*::
+
--
...
*`host.rds.backtrack_window.alert`*::
+
--
...
*`host.rds.storage_used.backup_retention_period.bytes`*::
+
--
...
*`host.rds.storage_used.snapshot.bytes`*::
+
--
...
*`host.rds.cache_hit_ratio.buffer`*::
+
--
...
*`host.rds.cache_hit_ratio.result_set`*::
+
--
...
*`host.rds.rds_to_aurora_postgresql_replica_lag.sec`*::
+
--
...
*`host.rds.backup_storage_billed_total.bytes`*::
+
--
...
*`host.rds.aurora_volume_left_total.bytes`*::
+
--
...
*`host.s3_daily_storage.bucket.size.bytes`*::
+
--
...
*`host.s3_daily_storage.number_of_objects`*::
+
--
...
*`host.s3_request.requests.total`*::
+
--
...
*`host.s3_request.requests.delete`*::
+
--
...
*`host.s3_request.requests.select`*::
+
--
...
*`host.s3_request.requests.select_scanned.bytes`*::
+
--
...
*`host.s3_request.requests.select_returned.bytes`*::
+
--
...
*`host.s3_request.downloaded.bytes`*::
+
--
...
*`host.s3_request.uploaded.bytes`*::
+
--
...
*`host.s3_request.latency.first_byte.ms`*::
+
--
...
*`host.s3_request.latency.total_request.ms`*::
+
--
...
*`host.sns.metrics.PublishSize.avg`*::
+
--
...
*`host.sns.metrics.SMSSuccessRate.avg`*::
+
--
...
*`host.sns.metrics.NumberOfMessagesPublished.sum`*::
+
--
...
*`host.sns.metrics.NumberOfNotificationsDelivered.sum`*::
+
--
...
*`host.sns.metrics.NumberOfNotificationsFailed.sum`*::
+
--
...
*`host.sns.metrics.NumberOfNotificationsFilteredOut.sum`*::
+
--
...
*`host.sns.metrics.NumberOfNotificationsFilteredOut-InvalidAttributes.sum`*::
+
--
...
*`host.sns.metrics.NumberOfNotificationsFilteredOut-NoMessageAttributes.sum`*::
+
--
...
*`host.sns.metrics.NumberOfNotificationsRedrivenToDlq.sum`*::
+
--
...
*`host.sns.metrics.NumberOfNotificationsFailedToRedriveToDlq.sum`*::
+
--
...
*`host.sns.metrics.SMSMonthToDateSpentUSD.sum`*::
+
--
...
*`host.sqs.oldest_message_age.sec`*::
+
--
...
*`host.sqs.sent_message_size.bytes`*::
+
--
...
*`host.transitgateway.metrics.BytesIn.sum`*::
+
--
...
*`host.transitgateway.metrics.BytesOut.sum`*::
+
--
...
*`host.transitgateway.metrics.PacketsIn.sum`*::
+
--
...
*`host.transitgateway.metrics.PacketsOut.sum`*::
+
--
...
*`host.transitgateway.metrics.PacketDropCountBlackhole.sum`*::
+
--
...
*`host.transitgateway.metrics.PacketDropCountNoRoute.sum`*::
+
--
...
*`host.usage.metrics.CallCount.sum`*::
+
--
...
*`host.usage.metrics.ResourceCount.sum`*::
+
--
...
*`host.vpn.metrics.TunnelState.avg`*::
+
--
...
*`host.vpn.metrics.TunnelDataIn.sum`*::
+
--
...
*`host.vpn.metrics.TunnelDataOut.sum`*::
+
--
