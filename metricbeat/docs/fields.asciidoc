...
*`couchbase.syncgateway.replication.name`*::
+
--
TODO
...
*`couchbase.syncgateway.database.docs.writes.conflict.count`*::
+
--
TODO
...
*`couchbase.syncgateway.database.docs.writes.count`*::
+
--
TODO
...
*`couchbase.syncgateway.database.docs.writes.bytes`*::
+
--
TODO
...
*`couchbase.syncgateway.database.replications.active`*::
+
--
TODO
...
*`couchbase.syncgateway.database.replications.total`*::
+
--
TODO
