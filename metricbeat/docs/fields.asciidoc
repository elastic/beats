...
Galera Cluster status metrics collected from the Galera Cluster.
...
`galera` contains the metrics that were obtained from the galera cluster via MySQL query.
...
[float]
=== `galera.status.cert.deps_distance`
...
[float]
=== `galera.status.flow_ctl.paused_ns`
...
[float]
=== `galera.status.local.cert_failures`
...
[float]
=== `galera.status.local.recv.queue`
...
[float]
=== `galera.status.local.recv.queue_avg`
...
[float]
=== `galera.status.local.recv.queue_max`
...
[float]
=== `galera.status.local.recv.queue_min`
...
[float]
=== `galera.status.local.send.queue`
...
[float]
=== `galera.status.local.send.queue_avg`
...
[float]
=== `galera.status.local.send.queue_max`
...
[float]
=== `galera.status.local.send.queue_min`
...
[float]
=== `galera.status.repl.other_bytes`
