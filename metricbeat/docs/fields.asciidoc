...
*`system.socket.summary.tcp.orphan_sockets`*::
+
--
type: integer
...
*`system.socket.summary.tcp.socket_memory`*::
+
--
type: integer

Memory used by TCP sockets. Corresponds to limits set in /proc/sys/net/ipv4/tcp_mem. Only available on linux. 
