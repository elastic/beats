...
*`kubernetes.statemetrics.certificatesigningrequest.labels`*::
+
--
type: long
...
*`kubernetes.statemetrics.certificatesigningrequest.condition`*::
+
--
type: long
...
*`kubernetes.statemetrics.label_rotting`*::
+
--
type: keyword
...
*`kubernetes.statemetrics.condition`*::
+
--
type: keyword
...
*`kubernetes.statemetrics.labels.*`*::
+
--
each label found at the certificate signing request
