...
*`traefik.health.response.avg_time.sec`*::
+
--
type: float
...
*`traefik.health.response.status_codes.code`*::
+
--
type: keyword
...
*`traefik.health.response.status_codes.count`*::
+
--
type: int

Number of responses for status code
