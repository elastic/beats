...
*`elasticsearch.node.stats.thread_pool.*.threads`*::
+
--
type: object
...
*`elasticsearch.node.stats.thread_pool.*.queue`*::
+
--
type: object
...
*`elasticsearch.node.stats.thread_pool.*.active`*::
+
--
type: object
...
*`elasticsearch.node.stats.thread_pool.*.rejected`*::
+
--
type: object
...
*`elasticsearch.node.stats.thread_pool.*.largest`*::
+
--
type: object
...
*`elasticsearch.node.stats.thread_pool.*.completed`*::
+
--
type: object
...
*`elasticsearch.node.stats.breakers.fielddata.limit.bytes`*::
+
--
type: long
...
*`elasticsearch.node.stats.breakers.fielddata.estimated.bytes`*::
+
--
type: long
...
*`elasticsearch.node.stats.breakers.fielddata.overhead`*::
+
--
type: float
...
*`elasticsearch.node.stats.breakers.fielddata.tripped`*::
+
--
type: long
...
[float]
== cluster_state_queue fields

Cluster state queue stats



*`elasticsearch.node.stats.discovery.cluster_state_queue.total`*::
+
--
type: long
...
*`elasticsearch.node.stats.discovery.cluster_state_queue.pending`*::
+
--
type: long
...
*`elasticsearch.node.stats.discovery.cluster_state_queue.committed`*::
+
--
type: long
...
[float]
== published_cluster_states fields

Published cluster states stats



*`elasticsearch.node.stats.discovery.published_cluster_states.full_states`*::
+
--
type: long
...
*`elasticsearch.node.stats.discovery.published_cluster_states.incompatible_diffs`*::
+
--
type: long
...
*`elasticsearch.node.stats.discovery.published_cluster_states.compatible_diffs`*::
+
--
type: long
...
*`elasticsearch.node.stats.ingest.total.ms`*::
+
--
type: long
...
*`elasticsearch.node.stats.ingest.pipelines.*`*::
+
--
type: object
...
[float]
== adaptive_selection fields




*`elasticsearch.node.stats.ingest.adaptive_selection.outgoing_searches`*::
+
--
type: long
...
*`elasticsearch.node.stats.ingest.adaptive_selection.queue_size.avg`*::
+
--
type: long
...
*`elasticsearch.node.stats.ingest.adaptive_selection.service_time.avg.ns`*::
+
--
type: long
...
*`elasticsearch.node.stats.ingest.adaptive_selection.response_time.avg.ns`*::
+
--
type: long
...
*`elasticsearch.node.stats.ingest.adaptive_selection.rank`*::
+
--
type: keyword
