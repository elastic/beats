...
*`beats.stats.runtime.goroutines`*::
+
--
type: long
...
*`beats.stats.libbeat.output.type`*::
+
--
type: keyword
...
*`beats.stats.libbeat.output.events.acked`*::
+
--
type: long
...
*`beats.stats.libbeat.output.events.active`*::
+
--
type: long
...
*`beats.stats.libbeat.output.events.batches`*::
+
--
type: long
...
*`beats.stats.libbeat.output.events.dropped`*::
+
--
type: long
...
*`beats.stats.libbeat.output.events.duplicates`*::
+
--
type: long
...
*`beats.stats.libbeat.output.events.failed`*::
+
--
type: long
...
*`beats.stats.libbeat.output.events.toomany`*::
+
--
type: long
...
*`beats.stats.libbeat.output.events.total`*::
+
--
type: long
...
*`beats.stats.libbeat.output.read.bytes`*::
+
--
type: long
...
*`beats.stats.libbeat.output.read.errors`*::
+
--
type: long
...
*`beats.stats.libbeat.output.write.bytes`*::
+
--
type: long
...
*`beats.stats.libbeat.output.write.errors`*::
+
--
type: long
