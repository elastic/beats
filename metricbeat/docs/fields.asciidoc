...
[float]
=== `elasticsearch.pending_tasks.max_time_in_queue_millis`
...
[float]
=== `elasticsearch.pending_tasks.pending_tasks_priority_high`
...
[float]
=== `elasticsearch.pending_tasks.pending_tasks_priority_urgent`
...
[float]
=== `elasticsearch.pending_tasks.pending_tasks_total`

type: long

Number of pendings tasks (total)
