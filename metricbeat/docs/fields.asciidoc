...
*`kibana_stats.kibana.response_times.max`*::
+
--
type: alias

alias to: kibana.stats.response_times.max.ms
...
*`kibana_stats.stats.usage.index`*::
+
--
type: keyword
...
*`kibana_stats.stats.transport_address`*::
+
--
...
*`kibana_stats.stats.concurrent_connections`*::
+
--
...
*`kibana_stats.stats.process.event_loop_delay.ms`*::
+
--
...
*`kibana_stats.stats.process.memory.heap.total.bytes`*::
+
--
...
*`kibana_stats.stats.process.memory.heap.used.bytes`*::
+
--
...
*`kibana_stats.stats.process.memory.heap.size_limit.bytes`*::
+
--
...
*`kibana_stats.stats.process.memory.heap.uptime.ms`*::
+
--
...
*`kibana_stats.stats.request.disconnects`*::
+
--
...
*`kibana_stats.stats.request.total`*::
+
--
Total number of requests
...
*`kibana_stats.stats.response_time.avg.ms`*::
+
--
Average response time in milliseconds
...
*`kibana_stats.stats.response_time.max.ms`*::
+
--
...
*`kibana_stats.status.version.number`*::
+
--
...
*`kibana_stats.status.status.overall.state`*::
+
--
...
*`kibana_stats.status.metrics.concurrent_connections`*::
+
--
...
*`kibana_stats.status.metrics.requests.disconnects`*::
+
--
...
*`kibana_stats.status.metrics.requests.total`*::
+
--
Total number of connections.
...
*`logstash_stats.pipelines.id`*::
+
--
type: alias

alias to: logstash.node.stats.pipelines.id
...
alias to: logstash.node.stats.pipelines.hash

--


*`logstash_stats.pipelines.queue.type`*::
+
--
type: alias

alias to: logstash.node.stats.pipelines.queue.type

--

*`logstash_stats.pipelines.queue.queue_size_in_bytes`*::
+
--
type: alias

alias to: logstash.node.stats.pipelines.queue.queue_size_in_bytes

--

*`logstash_stats.pipelines.queue.max_queue_size_in_bytes`*::
+
--
type: alias

alias to: logstash.node.stats.pipelines.queue.max_queue_size_in_bytes

--


*`logstash_stats.pipelines.events.out`*::
+
--
type: alias

alias to: logstash.node.stats.pipelines.events.out

--

*`logstash_stats.pipelines.events.duration_in_millis`*::
+
--
type: alias

alias to: logstash.node.stats.pipelines.events.duration_in_millis

--


*`logstash_stats.pipelines.vertices.duration_in_millis`*::
+
--
type: alias

alias to: logstash.node.stats.pipelines.vertices.duration_in_millis

--

*`logstash_stats.pipelines.vertices.events_in`*::
+
--
type: alias

alias to: logstash.node.stats.pipelines.vertices.events_in

--

*`logstash_stats.pipelines.vertices.pipeline_ephemeral_id`*::
+
--
type: alias

alias to: logstash.node.stats.pipelines.vertices.pipeline_ephemeral_id

--

*`logstash_stats.pipelines.vertices.events_out`*::
+
--
type: alias

alias to: logstash.node.stats.pipelines.vertices.events_out

--

*`logstash_stats.pipelines.vertices.id`*::
+
--
type: alias

alias to: logstash.node.stats.pipelines.vertices.id

--

*`logstash_stats.pipelines.vertices.queue_push_duration_in_millis`*::
+
--
type: alias

alias to: logstash.node.stats.pipelines.vertices.queue_push_duration_in_millis
