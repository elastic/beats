...
Kibana actions metrics.




*`kibana.actions.kibana.status`*::
+
--
type: keyword
...
*`kibana.actions.overdue.duration.p50`*::
+
--
type: float
...
*`kibana.actions.overdue.duration.p99`*::
+
--
type: float
...
*`kibana.rules.overdue.duration.p50`*::
+
--
type: float
...
*`kibana.rules.overdue.duration.p99`*::
+
--
type: float
