...
[float]
=== vsphere.datastore_usage.datacenter
...
[float]
=== vsphere.datastore_usage.fstype
...
[float]
=== vsphere.datastore_usage.capacity.total.bytes
...
[float]
=== vsphere.datastore_usage.capacity.free.bytes
...
[float]
=== vsphere.datastore_usage.capacity.used.bytes
...
[float]
=== vsphere.datastore_usage.capacity.used.pct
...
[float]
=== vsphere.host_usage.cpu.used.mhz
...
[float]
=== vsphere.host_usage.cpu.total.mhz
...
[float]
=== vsphere.host_usage.cpu.free.mhz
...
[float]
=== vsphere.host_usage.memory.used.bytes
...
[float]
=== vsphere.host_usage.memory.total.bytes
...
[float]
=== vsphere.host_usage.memory.free.bytes
...
[float]
=== vsphere.virtualmachine_usage.datacenter
...
[float]
=== vsphere.virtualmachine_usage.name
...
[float]
=== vsphere.virtualmachine_usage.cpu.used.mhz
...
[float]
=== vsphere.virtualmachine_usage.cpu.total.mhz
...
[float]
=== vsphere.virtualmachine_usage.cpu.free.mhz
...
[float]
=== vsphere.virtualmachine_usage.memory.used.guest.bytes
...
[float]
=== vsphere.virtualmachine_usage.memory.used.host.bytes
...
[float]
=== vsphere.virtualmachine_usage.memory.total.guest.bytes
...
[float]
=== vsphere.virtualmachine_usage.memory.free.guest.bytes
