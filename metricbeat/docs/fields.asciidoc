...
*`mysql.status.connection.errors.max_connections`*::
+
--
...
*`mysql.status.cache.ssl.session.hits`*::
+
--
...
*`mysql.status.cache.ssl.session.misses`*::
+
--
...
*`mysql.status.cache.ssl.session.size`*::
+
--
