...
*`oracle.sysmetric.metrics.session_count`*::
+
--
Session Count.
...
*`oracle.sysmetric.metrics.average_active_sessions`*::
+
--
...
*`oracle.sysmetric.metrics.current_os_load`*::
+
--
Current OS Load.
...
*`oracle.sysmetric.metrics.physical_reads_per_sec`*::
+
--
...
*`oracle.sysmetric.metrics.user_transaction_per_sec`*::
+
--
...
*`oracle.sysmetric.metrics.total_table_scans_per_txn`*::
+
--
...
*`oracle.sysmetric.metrics.physical_writes_per_sec`*::
+
--
...
*`oracle.sysmetric.metrics.total_index_scans_per_txn`*::
+
--
...
*`oracle.sysmetric.metrics.host_cpu_utilization_pct`*::
+
--
...
*`oracle.sysmetric.metrics.network_traffic_volume_per_sec`*::
+
--
...
*`oracle.sysmetric.metrics.user_rollbacks_per_sec`*::
+
--
...
*`oracle.sysmetric.metrics.cpu_usage_per_sec`*::
+
--
...
*`oracle.sysmetric.metrics.db_block_changes_per_sec`*::
+
--
...
*`oracle.sysmetric.metrics.physical_read_total_bytes_per_sec`*::
+
--
...
*`oracle.sysmetric.metrics.response_time_per_txn`*::
+
--
