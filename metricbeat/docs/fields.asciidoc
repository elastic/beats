...
*`ceph.mgr_osd_disk.stats.available.bytes`*::
+
--
...
*`ceph.mgr_osd_disk.stats.objects`*::
+
--
...
*`ceph.mgr_osd_disk.stats.used.bytes`*::
+
--
...
*`ceph.mgr_osd_disk.stats.used.kb`*::
+
--
Used kb of the pool
