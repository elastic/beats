...
alias to: elasticsearch.node.stats.fs.summary.free.bytes
...
alias to: elasticsearch.node.stats.fs.io_stats.total.read.kb
...
alias to: elasticsearch.node.stats.fs.io_stats.total.write.kb
...
alias to: elasticsearch.node.stats.indices.bulk.avg_size.bytes
...
alias to: elasticsearch.node.stats.indices.bulk.avg_time.ms
...
alias to: elasticsearch.node.stats.indices.bulk.operations.total.count
...
alias to: elasticsearch.node.stats.indices.bulk.total_size.bytes
...
alias to: elasticsearch.node.stats.indices.bulk.total_time.ms
...
alias to: elasticsearch.node.stats.indices.fielddata.evictions.count
...
alias to: elasticsearch.node.stats.indices.query_cache.evictions.count
...
alias to: elasticsearch.node.stats.indices.query_cache.hits.count
...
alias to: elasticsearch.node.stats.indices.query_cache.misses.count
...
alias to: elasticsearch.node.stats.indices.request_cache.evictions.count
...
alias to: elasticsearch.node.stats.indices.request_cache.hits.count
...
alias to: elasticsearch.node.stats.indices.request_cache.misses.count
...
alias to: elasticsearch.node.mlockall
...
alias to: elasticsearch.node.master
...
alias to: elasticsearch.node.stats.os.cpu.load_avg.5m
...
alias to: elasticsearch.node.stats.os.cpu.load_avg.15m
...
alias to: elasticsearch.node.stats.os.cgroup.cpuacct.control_group
...
alias to: elasticsearch.node.stats.os.cgroup.cpu.control_group
...
alias to: elasticsearch.node.stats.os.cgroup.cpu.cfs.period.us
...
alias to: elasticsearch.node.stats.process.file_descriptors.max.count
...
alias to: elasticsearch.node.stats.process.file_descriptors.open.count
...
alias to: elasticsearch.node.stats.thread_pool.bulk.threads.count
...
alias to: elasticsearch.node.stats.thread_pool.generic.queue.count
...
alias to: elasticsearch.node.stats.thread_pool.generic.rejected.count
...
alias to: elasticsearch.node.stats.thread_pool.generic.threads.count
...
alias to: elasticsearch.node.stats.thread_pool.get.threads.count
...
alias to: elasticsearch.node.stats.thread_pool.index.threads.count
...
alias to: elasticsearch.node.stats.thread_pool.management.queue.count
...
alias to: elasticsearch.node.stats.thread_pool.management.rejected.count
...
alias to: elasticsearch.node.stats.thread_pool.management.threads.count
...
alias to: elasticsearch.node.stats.thread_pool.search.threads.count
...
alias to: elasticsearch.node.stats.thread_pool.watcher.queue.count
...
alias to: elasticsearch.node.stats.thread_pool.watcher.rejected.count
...
alias to: elasticsearch.node.stats.thread_pool.watcher.threads.count
...
alias to: elasticsearch.node.stats.thread_pool.write.threads.count
...
*`node_stats.ccr.leader.max_seq_no`*::
+
--
...
*`node_stats.ccr.follower.shard.number`*::
+
--
...
*`node_stats.ccr.follower.operations_written`*::
+
--
...
*`node_stats.ccr.follower.time_since_last_read.ms`*::
+
--
...
*`node_stats.ccr.follower.global_checkpoint`*::
+
--
...
*`node_stats.cluster.stats.status`*::
+
--
...
*`node_stats.cluster.stats.nodes.count`*::
+
--
...
*`node_stats.cluster.stats.nodes.master`*::
+
--
...
*`node_stats.cluster.stats.nodes.data`*::
+
--
...
*`node_stats.cluster.stats.indices.count`*::
+
--
...
*`node_stats.cluster.stats.indices.shards.count`*::
+
--
...
*`node_stats.cluster.stats.indices.shards.primaries`*::
+
--
...
*`node_stats.cluster.stats.indices.fielddata.memory.bytes`*::
+
--
...
*`node_stats.enrich.remote_requests.current`*::
+
--
...
*`node_stats.enrich.remote_requests.total`*::
+
--
...
*`node_stats.enrich.executed_searches.total`*::
+
--
...
*`node_stats.index.total.docs.count`*::
+
--
...
*`node_stats.index.total.docs.deleted`*::
+
--
...
*`node_stats.index.total.store.size.bytes`*::
+
--
...
*`node_stats.index.total.segments.count`*::
+
--
...
*`node_stats.index.total.segments.memory.bytes`*::
+
--
...
*`node_stats.index.recovery.type`*::
+
--
Shard recovery type.
...
*`node_stats.index.recovery.primary`*::
+
--
...
*`node_stats.index.recovery.stage`*::
+
--
Recovery stage.
...
*`node_stats.index.recovery.target.id`*::
+
--
Target node id.
...
*`node_stats.index.recovery.target.host`*::
+
--
...
*`node_stats.index.recovery.target.name`*::
+
--
Target node name.
...
*`node_stats.index.recovery.source.id`*::
+
--
Source node id.
...
*`node_stats.index.recovery.source.name`*::
+
--
Source node name.
...
*`node_stats.index.summary.primaries.docs.count`*::
+
--
Total number of documents in the index.
...
*`node_stats.index.summary.primaries.docs.deleted`*::
+
--
Total number of deleted documents in the index.
...
*`node_stats.index.summary.primaries.store.size.bytes`*::
+
--
Total size of the index in bytes.
...
*`node_stats.index.summary.primaries.segments.count`*::
+
--
Total number of index segments.
...
*`node_stats.index.summary.primaries.segments.memory.bytes`*::
+
--
Total number of memory used by the segments in bytes.
...
*`node_stats.index.summary.total.docs.count`*::
+
--
Total number of documents in the index.
...
*`node_stats.index.summary.total.docs.deleted`*::
+
--
Total number of deleted documents in the index.
...
*`node_stats.index.summary.total.store.size.bytes`*::
+
--
Total size of the index in bytes.
...
*`node_stats.index.summary.total.segments.count`*::
+
--
Total number of index segments.
...
*`node_stats.index.summary.total.segments.memory.bytes`*::
+
--
Total number of memory used by the segments in bytes.
...
*`node_stats.ml.job.data_counts.processed_record_count`*::
+
--
...
*`node_stats.ml.job.data_counts.invalid_date_count`*::
+
--
...
*`node_stats.node.jvm.memory.heap.init.bytes`*::
+
--
Heap init used by the JVM in bytes.
...
*`node_stats.node.jvm.memory.heap.max.bytes`*::
+
--
...
*`node_stats.node.jvm.memory.nonheap.init.bytes`*::
+
--
...
*`node_stats.node.jvm.memory.nonheap.max.bytes`*::
+
--
...
*`node_stats.node.process.mlockall`*::
+
--
...
*`node_stats.node.stats.indices.docs.count`*::
+
--
...
*`node_stats.node.stats.indices.docs.deleted`*::
+
--
...
*`node_stats.node.stats.indices.segments.count`*::
+
--
...
*`node_stats.node.stats.indices.segments.memory.bytes`*::
+
--
...
*`node_stats.node.stats.indices.store.size.bytes`*::
+
--
...
*`node_stats.node.stats.indices.bulk.avg_size.bytes`*::
+
--
type: long
...
*`node_stats.node.stats.indices.bulk.avg_time.ms`*::
+
--
type: long
...
*`node_stats.node.stats.indices.bulk.operations.total.count`*::
+
--
type: long
...
*`node_stats.node.stats.indices.bulk.total_size.bytes`*::
+
--
type: long
...
*`node_stats.node.stats.indices.bulk.total_time.ms`*::
+
--
type: long
...
*`node_stats.node.stats.indices.fielddata.evictions.count`*::
+
--
type: long
...
*`node_stats.node.stats.indices.fielddata.memory.bytes`*::
+
--
type: long
...
*`node_stats.node.stats.indices.indexing.index_time.ms`*::
+
--
type: long
...
*`node_stats.node.stats.indices.indexing.index_total.count`*::
+
--
type: long
...
*`node_stats.node.stats.indices.indexing.throttle_time.ms`*::
+
--
type: long
...
*`node_stats.node.stats.indices.query_cache.evictions.count`*::
+
--
type: long
...
*`node_stats.node.stats.indices.query_cache.hits.count`*::
+
--
type: long
...
*`node_stats.node.stats.indices.query_cache.memory.bytes`*::
+
--
type: long
...
*`node_stats.node.stats.indices.query_cache.misses.count`*::
+
--
type: long
...
*`node_stats.node.stats.indices.request_cache.evictions.count`*::
+
--
type: long
...
*`node_stats.node.stats.indices.request_cache.hits.count`*::
+
--
type: long
...
*`node_stats.node.stats.indices.request_cache.memory.bytes`*::
+
--
type: long
...
*`node_stats.node.stats.indices.request_cache.misses.count`*::
+
--
type: long
...
*`node_stats.node.stats.indices.search.query_time.ms`*::
+
--
type: long
...
*`node_stats.node.stats.indices.search.query_total.count`*::
+
--
type: long
...
*`node_stats.node.stats.indices.segments.doc_values.memory.bytes`*::
+
--
type: long
...
*`node_stats.node.stats.indices.segments.fixed_bit_set.memory.bytes`*::
+
--
type: long
...
*`node_stats.node.stats.indices.segments.index_writer.memory.bytes`*::
+
--
type: long
...
*`node_stats.node.stats.indices.segments.norms.memory.bytes`*::
+
--
type: long
...
*`node_stats.node.stats.indices.segments.points.memory.bytes`*::
+
--
type: long
...
*`node_stats.node.stats.indices.segments.stored_fields.memory.bytes`*::
+
--
type: long
...
*`node_stats.node.stats.indices.segments.term_vectors.memory.bytes`*::
+
--
type: long
...
*`node_stats.node.stats.indices.segments.terms.memory.bytes`*::
+
--
type: long
...
*`node_stats.node.stats.indices.segments.version_map.memory.bytes`*::
+
--
type: long
...
*`node_stats.node.stats.jvm.mem.heap.max.bytes`*::
+
--
type: long
...
*`node_stats.node.stats.jvm.mem.heap.used.bytes`*::
+
--
type: long
...
*`node_stats.node.stats.jvm.mem.heap.used.pct`*::
+
--
type: long
...
*`node_stats.node.stats.jvm.mem.pools.old.max.bytes`*::
+
--
Max bytes.
...
*`node_stats.node.stats.jvm.mem.pools.old.peak.bytes`*::
+
--
Peak bytes.
...
*`node_stats.node.stats.jvm.mem.pools.old.peak_max.bytes`*::
+
--
Peak max bytes.
...
*`node_stats.node.stats.jvm.mem.pools.old.used.bytes`*::
+
--
Used bytes.
...
*`node_stats.node.stats.jvm.mem.pools.young.max.bytes`*::
+
--
Max bytes.
...
*`node_stats.node.stats.jvm.mem.pools.young.peak.bytes`*::
+
--
Peak bytes.
...
*`node_stats.node.stats.jvm.mem.pools.young.peak_max.bytes`*::
+
--
Peak max bytes.
...
*`node_stats.node.stats.jvm.mem.pools.young.used.bytes`*::
+
--
Used bytes.
...
*`node_stats.node.stats.jvm.mem.pools.survivor.max.bytes`*::
+
--
Max bytes.
...
*`node_stats.node.stats.jvm.mem.pools.survivor.peak.bytes`*::
+
--
Peak bytes.
...
*`node_stats.node.stats.jvm.mem.pools.survivor.peak_max.bytes`*::
+
--
Peak max bytes.
...
*`node_stats.node.stats.jvm.mem.pools.survivor.used.bytes`*::
+
--
Used bytes.
...
*`node_stats.node.stats.jvm.gc.collectors.old.collection.count`*::
+
--
...
*`node_stats.node.stats.jvm.gc.collectors.old.collection.ms`*::
+
--
...
*`node_stats.node.stats.jvm.gc.collectors.young.collection.count`*::
+
--
...
*`node_stats.node.stats.jvm.gc.collectors.young.collection.ms`*::
+
--
...
*`node_stats.node.stats.fs.summary.total.bytes`*::
+
--
...
*`node_stats.node.stats.fs.summary.free.bytes`*::
+
--
...
*`node_stats.node.stats.fs.summary.available.bytes`*::
+
--
...
*`node_stats.node.stats.fs.io_stats.total.operations.count`*::
+
--
type: long
...
*`node_stats.node.stats.fs.io_stats.total.read.kb`*::
+
--
type: long
...
*`node_stats.node.stats.fs.io_stats.total.read.operations.count`*::
+
--
type: long
...
*`node_stats.node.stats.fs.io_stats.total.write.kb`*::
+
--
type: long
...
*`node_stats.node.stats.fs.io_stats.total.write.operations.count`*::
+
--
type: long
...
*`node_stats.node.stats.os.cpu.load_avg.1m`*::
+
--
type: long
...
*`node_stats.node.stats.os.cpu.load_avg.5m`*::
+
--
type: long
...
*`node_stats.node.stats.os.cpu.load_avg.15m`*::
+
--
type: long
...
*`node_stats.node.stats.os.cpu.cgroup.cpuacct.control_group`*::
+
--
type: long
...
*`node_stats.node.stats.os.cpu.cgroup.cpuacct.usage.ns`*::
+
--
type: long
...
*`node_stats.node.stats.os.cpu.cgroup.cpu.control_group`*::
+
--
type: long
...
*`node_stats.node.stats.os.cpu.cgroup.cpu.cfs.period.us`*::
+
--
type: long
...
*`node_stats.node.stats.os.cpu.cgroup.cpu.cfs.quota.us`*::
+
--
type: long
...
*`node_stats.node.stats.os.cpu.cgroup.cpu.stat.elapsed_periods.count`*::
+
--
type: long
...
*`node_stats.node.stats.os.cpu.cgroup.cpu.stat.times_throttled.count`*::
+
--
type: long
...
*`node_stats.node.stats.os.cpu.cgroup.cpu.stat.time_throttled.ns`*::
+
--
type: long
...
*`node_stats.node.stats.os.cpu.cgroup.memory.control_group`*::
+
--
type: long
...
*`node_stats.node.stats.os.cpu.cgroup.memory.limit.bytes`*::
+
--
type: long
...
*`node_stats.node.stats.os.cpu.cgroup.memory.usage.bytes`*::
+
--
type: long
...
*`node_stats.node.stats.process.cpu.pct`*::
+
--
type: long
...
*`node_stats.node.stats.process.file_descriptors.max.count`*::
+
--
type: long
...
*`node_stats.node.stats.process.file_descriptors.open.count`*::
+
--
type: long
...
*`node_stats.node.stats.thread_pool.bulk.queue.count`*::
+
--
type: long
...
*`node_stats.node.stats.thread_pool.bulk.rejected.count`*::
+
--
type: long
...
*`node_stats.node.stats.thread_pool.bulk.threads.count`*::
+
--
type: long
...
*`node_stats.node.stats.thread_pool.generic.queue.count`*::
+
--
type: long
...
*`node_stats.node.stats.thread_pool.generic.rejected.count`*::
+
--
type: long
...
*`node_stats.node.stats.thread_pool.generic.threads.count`*::
+
--
type: long
...
*`node_stats.node.stats.thread_pool.get.queue.count`*::
+
--
type: long
...
*`node_stats.node.stats.thread_pool.get.rejected.count`*::
+
--
type: long
...
*`node_stats.node.stats.thread_pool.get.threads.count`*::
+
--
type: long
...
*`node_stats.node.stats.thread_pool.index.queue.count`*::
+
--
type: long
...
*`node_stats.node.stats.thread_pool.index.rejected.count`*::
+
--
type: long
...
*`node_stats.node.stats.thread_pool.index.threads.count`*::
+
--
type: long
...
*`node_stats.node.stats.thread_pool.management.queue.count`*::
+
--
type: long
...
*`node_stats.node.stats.thread_pool.management.rejected.count`*::
+
--
type: long
...
*`node_stats.node.stats.thread_pool.management.threads.count`*::
+
--
type: long
...
*`node_stats.node.stats.thread_pool.search.queue.count`*::
+
--
type: long
...
*`node_stats.node.stats.thread_pool.search.rejected.count`*::
+
--
type: long
...
*`node_stats.node.stats.thread_pool.search.threads.count`*::
+
--
type: long
...
*`node_stats.node.stats.thread_pool.watcher.queue.count`*::
+
--
type: long
...
*`node_stats.node.stats.thread_pool.watcher.rejected.count`*::
+
--
type: long
...
*`node_stats.node.stats.thread_pool.watcher.threads.count`*::
+
--
type: long
...
*`node_stats.node.stats.thread_pool.write.queue.count`*::
+
--
type: long
...
*`node_stats.node.stats.thread_pool.write.rejected.count`*::
+
--
type: long
...
*`node_stats.node.stats.thread_pool.write.threads.count`*::
+
--
type: long
...
*`node_stats.cluster.pending_task.insert_order`*::
+
--
Insert order
...
*`node_stats.cluster.pending_task.priority`*::
+
--
Priority
...
*`node_stats.cluster.pending_task.source`*::
+
--
...
*`node_stats.cluster.pending_task.time_in_queue.ms`*::
+
--
Time in queue
...
*`node_stats.shard.relocating_node.name`*::
+
--
