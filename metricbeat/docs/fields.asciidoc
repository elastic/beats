...
*`kubernetes.kubeproxy.client.request.status_code`*::
+
--
type: keyword
...
*`kubernetes.kubeproxy.client.request.host`*::
+
--
type: keyword
...
*`kubernetes.kubeproxy.client.request.method`*::
+
--
type: keyword
...
*`kubernetes.kubeproxy.client.request.verb`*::
+
--
type: keyword
...
*`kubernetes.kubeproxy.client.request.url`*::
+
--
type: keyword
...
*`kubernetes.kubeproxy.client.request.latency.us.sum`*::
+
--
type: long
...
*`kubernetes.kubeproxy.client.request.latency.us.count`*::
+
--
type: long
...
*`kubernetes.kubeproxy.client.request.latency.us.bucket.*`*::
+
--
type: object
...
*`kubernetes.kubeproxy.sync.rules.latency.us.sum`*::
+
--
type: long
...
*`kubernetes.kubeproxy.sync.rules.latency.us.count`*::
+
--
type: long
...
*`kubernetes.kubeproxy.sync.rules.latency.us.bucket.*`*::
+
--
type: object
