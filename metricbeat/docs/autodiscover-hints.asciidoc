...
Define a processor to be added to the {beatname_uc} module configuration. See <<metricbeat-filtering>> for the list
...
["source","yaml",subs="attributes"]
-------------------------------------------------------------------------------------
co.elastic.logs/processor.1.add_locale.abbrevation: "MST"
co.elastic.logs/processor.add_locale.abbrevation: "PST"
-------------------------------------------------------------------------------------
