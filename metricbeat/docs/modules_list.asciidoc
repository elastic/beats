...
.4+| .4+|  |<<metricbeat-metricset-nats-connz,connz>> experimental[]  
|<<metricbeat-metricset-nats-routez,routez>> experimental[]  
|<<metricbeat-metricset-nats-subsz,subsz>> experimental[]  
|<<metricbeat-metricset-nats-varz,varz>> experimental[]  
