...
.8+| .8+|  |<<metricbeat-metricset-kibana-cluster_actions,cluster_actions>> beta[]  
...
|<<metricbeat-metricset-kibana-task_manager_utilization,task_manager_utilization>> beta[]  
