...
.15+| .15+|  |<<metricbeat-metricset-kubernetes-apiserver,apiserver>>   
...
|<<metricbeat-module-oracle,Oracle>>  experimental[]   |image:./images/icon-no.png[No prebuilt dashboards]    |  
.1+| .1+|  |<<metricbeat-metricset-oracle-tablespace,tablespace>> experimental[]  
