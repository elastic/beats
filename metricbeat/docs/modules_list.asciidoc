...
.24+| .24+|  |<<metricbeat-metricset-kubernetes-apiserver,apiserver>>   
...
|<<metricbeat-metricset-kubernetes-state_horizontalpodautoscaler,state_horizontalpodautoscaler>> beta[]  
...
|<<metricbeat-module-linux,Linux>>     |image:./images/icon-no.png[No prebuilt dashboards]    |  
.7+| .7+|  |<<metricbeat-metricset-linux-conntrack,conntrack>>   
...
.2+| .2+|  |<<metricbeat-metricset-meraki-device_health,device_health>> beta[]  
|<<metricbeat-metricset-meraki-network_health,network_health>> beta[]  
