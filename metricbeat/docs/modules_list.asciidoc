...
|<<metricbeat-module-cisco,cisco>>  beta[]   |image:./images/icon-no.png[No prebuilt dashboards]    |  
.2+| .2+|  |<<metricbeat-metricset-cisco-interfaces,interfaces>> beta[]  
|<<metricbeat-metricset-cisco-uptime,uptime>> beta[]  
