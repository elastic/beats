...
|<<metricbeat-module-k6,k6>>  beta[]   |image:./images/icon-no.png[No prebuilt dashboards]    |  
.1+| .1+|  |<<metricbeat-metricset-k6-k6metricset,k6metricset>> beta[]  
