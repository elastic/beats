...
|<<metricbeat-module-iis,iis>>  experimental[]   |image:./images/icon-no.png[No prebuilt dashboards]    |  
.2+| .2+|  |<<metricbeat-metricset-iis-webserver,webserver>> experimental[]  
|<<metricbeat-metricset-iis-website,website>> experimental[]  
