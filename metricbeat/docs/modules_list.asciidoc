...
|<<metricbeat-module-logstash,Logstash>>  beta[]   |    
.2+|   |<<metricbeat-metricset-logstash-node,node>> beta[]  
...
|<<metricbeat-module-uwsgi,uwsgi>>  beta[]   |    
.1+|   |<<metricbeat-metricset-uwsgi-status,status>> beta[]  
