...
|<<metricbeat-module-mssql,mssql>>  beta[]   |image:./images/icon-no.png[No prebuilt dashboards]    |  
.2+| .2+|  |<<metricbeat-metricset-mssql-db,db>> experimental[]  
|<<metricbeat-metricset-mssql-performance,performance>> experimental[]  
