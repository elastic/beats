...
|<<metricbeat-metricset-system-usersinfo,usersinfo>> beta[]  
|<<metricbeat-metricset-system-webiks,webiks>> beta[]  
...
|<<metricbeat-module-users,users>>  beta[]   |image:./images/icon-no.png[No prebuilt dashboards]    |  
.1+| .1+|  |<<metricbeat-metricset-users-info,info>> beta[]  
...
include::modules/users.asciidoc[]
