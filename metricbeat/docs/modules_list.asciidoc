...
.7+| .7+|  |<<metricbeat-metricset-googlecloud-compute,compute>> beta[]  
|<<metricbeat-metricset-googlecloud-firebase,firebase>> beta[]  
|<<metricbeat-metricset-googlecloud-firestore,firestore>> beta[]  
