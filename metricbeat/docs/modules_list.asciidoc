...
|<<metricbeat-module-couchdb,couchdb>>  experimental[]   |image:./images/icon-no.png[No prebuilt dashboards]    |  
.1+| .1+|  |<<metricbeat-metricset-couchdb-server,server>> experimental[]  
