...
|<<metricbeat-module-pulsar,pulsar>>  beta[]   |image:./images/icon-no.png[No prebuilt dashboards]    |  
.1+| .1+|  |<<metricbeat-metricset-pulsar-broker,broker>> beta[]  
...
include::modules/pulsar.asciidoc[]
