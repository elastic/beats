...
with all the changes. There is a fields.yml file under `module/{module}/_beat/fields.yml´ which contains
...
[source,yaml]
----
include::../../module/mysql/_beat/fields.yml[]
----

The second file is under `module/{module}/{metricset}_beat/fields.yml´ which contains all fields retrieved
...
the file `module/{module}/_beat/docs.asciidoc` for the module and in `module/{module}/{metricset}/_beat/docs.asciidoc`
