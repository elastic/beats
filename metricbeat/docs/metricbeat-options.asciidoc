...
Note: If you wish to use different settings for the System module which is 
enabled by default, then edit the existing System module. Don't add another System module
(unless you want to run different combinations).
There isn't a concept of inheritance.
