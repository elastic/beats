...
//REVIEWERS: I removed the "basic configuration" section because we were duplicating content, and it was getting out of sync

//REVIEWERS: Moved section about config combinations because it seems premature to talk about detailed config settings in an overview. I think users will expect to see this info under the section called "Specify which modules to run".
