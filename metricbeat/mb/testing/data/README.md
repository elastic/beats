...
- `path`: (string) Path to reach the directory containing the files to read form
- `wirtepath`: (string) Path to the directory where the expected files are going to be written
