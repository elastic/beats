...
[here](https://www.elastic.co/guide/en/beats/libbeat/8.0/community-beats.html).
...
list of [community
Beats](https://github.com/elastic/beats/blob/8.0/libbeat/docs/communitybeats.asciidoc).
