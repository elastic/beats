...
[![GoReportCard](http://goreportcard.com/badge/menderesk/beats)](http://goreportcard.com/report/menderesk/beats)
...
[libbeat](https://github.com/menderesk/beats/tree/main/libbeat), our Go
framework for creating Beats, and all the officially supported Beats:

Beat  | Description
--- | ---
[Auditbeat](https://github.com/menderesk/beats/tree/main/auditbeat) | Collect your Linux audit framework data and monitor the integrity of your files.
[Filebeat](https://github.com/menderesk/beats/tree/main/filebeat) | Tails and ships log files
[Functionbeat](https://github.com/menderesk/beats/tree/main/x-pack/functionbeat) | Read and ships events from serverless infrastructure.
[Heartbeat](https://github.com/menderesk/beats/tree/main/heartbeat) | Ping remote services for availability
[Metricbeat](https://github.com/menderesk/beats/tree/main/metricbeat) | Fetches sets of metrics from the operating system and services
[Packetbeat](https://github.com/menderesk/beats/tree/main/packetbeat) | Monitors the network and applications by sniffing packets
[Winlogbeat](https://github.com/menderesk/beats/tree/main/winlogbeat) | Fetches and ships Windows Event logs
[Osquerybeat](https://github.com/menderesk/beats/tree/main/x-pack/osquerybeat) | Runs Osquery and manages interraction with it.
