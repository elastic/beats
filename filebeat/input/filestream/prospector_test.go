...
func (m *mockFileWatcher) GetFiles(loginp.FileScanOptions) (map[string]loginp.FileDescriptor, loginp.FileScanMetrics, []string) {
	return m.filesOnDisk, loginp.FileScanMetrics{}, nil
}
