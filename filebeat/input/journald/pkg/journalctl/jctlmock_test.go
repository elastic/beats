...
func (mock *JctlMock) Error() <-chan string {
	if mock.ErrorFunc == nil {
		panic("JctlMock.ErrorFunc: method is nil but Jctl.Error was just called")
	}
	callInfo := struct {
	}{}
	mock.lockError.Lock()
...
//
//	len(mockedJctl.ErrorCalls())
func (mock *JctlMock) ErrorCalls() []struct {
} {
	var calls []struct {
	}
