...
func customizePackaging() {
	...
	for _, args := range mage.Packages {
		...
		if args.Spec.License == "Elastic License" {
			...
			// x-pack/filebeat/fields.yml
			// x-pack/filebeat/filebeat.yml
			// x-pack/filebeat/filebeat.reference.yml
			// dashboards with x-pack/filebeat/build/kibana
			//
			// These are all generated by 'mage update' in the x-pack dir and
			// this is invoked by the OSS side during packaging.
		}
