...
[source,shell]
----------------------------------------------------------------------
./filebeat setup -e -modules=system,nginx
----------------------------------------------------------------------
+
...
//REVIEWERS: Do we have an updated screen capture of this dashboard? If not, I can update it myself, but it would be good if you could point me to a good example log file that will populate the visualization with interesting information.
