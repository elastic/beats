...
//TODO: DELETE THIS TOPIC AND REDIRECT IT TO THE GETTING STARTED TOPIC
...
<<{beatname_lc}-installation-configuration>> to set up and configure {beatname_uc} manually.
