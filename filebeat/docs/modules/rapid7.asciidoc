...
This is a module for receiving Rapid7 NeXpose logs over Syslog or a file.
...
[float]
==== `nexpose` fileset settings

experimental[]

NOTE: This was converted from RSA NetWitness log parser XML "nexpose" device revision 134.
...
The port to listen for syslog traffic. Defaults to `9517`
...
<<exported-fields-rapid7,exported fields>> section.
