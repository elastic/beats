...
NOTE: While Filebeat is able to parse logs using the `auditd` module, more advanced features are available in {auditbeat-ref}/auditbeat-module-auditd.html[Auditbeat].
