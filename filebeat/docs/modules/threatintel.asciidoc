...
* `malwarebazaar`: Supports gathering threat intel attributes from Malware Bazaar.
...
This fileset contacts the Malware Bazaar API and fetches all new malicious indicators found
the last 60 minutes.
...
[options="header"]
|==============================================================
| Threat Intel Fields        | ECS Fields
| first_seen                 | threatintel.indicator.first_seen
| last_seen                  | threatintel.indicator.last_seen
...
| file_size                  | threatintel.indicator.file.size
| file_type                  | threatintel.indicator.file.extension
| md5_hash                   | threatintel.indicator.file.hash.md5
| sha256_hash                | threatintel.indicator.file.hash.sha256
| sha1_hash                  | threatintel.indicator.file.hash.sha1
...
[role="screenshot"]
image::./images/filebeat-threatintel-malware-bazaar.png[]
