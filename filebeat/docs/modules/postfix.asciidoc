...
:edit_url: https://github.com/elastic/beats/edit/main/filebeat/module/postfix/_meta/docs.asciidoc
...
<<exported-fields-postfix,exported fields>> section.
