...
This is a module for receiving Citrix NetScaler logs over Syslog or a file.

include::../include/gs-link.asciidoc[]

include::../include/configuring-intro.asciidoc[]

:fileset_ex: netscaler

include::../include/config-option-intro.asciidoc[]

[float]
==== `netscaler` fileset settings

experimental[]

NOTE: This was converted from RSA NetWitness log parser XML "citrixns" device revision 134.
...
The port to listen for syslog traffic. Defaults to `9526`
