...
NOTE: `pattern` is not compatible with format used in `logstash`. See <<regexp-support>> for details or you will face with errors like: `ERR Stop Harvesting. Unexpected encoding line reader error: error parsing regexp: invalid escape sequence: '\d'`
