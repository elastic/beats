...
connections groups various counts of connections active in the process.
...
*`haproxy.connections.http.response.status_code`*::
+
--
type: long
...
*`haproxy.connections.http.response.bytes_read`*::
+
--
type: long
...
*`haproxy.connections.http.response.captured_cookie`*::
+
--
...
*`haproxy.connections.http.response.captured_headers`*::
+
--
type: text
...
*`haproxy.connections.http.request.captured_cookie`*::
+
--
...
*`haproxy.connections.http.request.captured_headers`*::
+
--
type: text
...
*`haproxy.connections.http.request.raw_request_line`*::
+
--
type: text
