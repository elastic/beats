...
*`elasticsearch.server.gc.old.overhead_seq`*::
+
--
type: long
...
[float]
== collection_duration fields

Time spent in GC


*`elasticsearch.server.gc.old.collection_duration.time`*::
+
--
type: float
...
Time duration in some units

--

*`elasticsearch.server.gc.old.collection_duration.unit`*::
+
--
type: keyword
...
*`elasticsearch.server.gc.old.collection_duration.time_in_millis`*::
+
--
type: float
...
[float]
== observation_duration fields

Total time over which collection was observed


*`elasticsearch.server.gc.old.observation_duration.time`*::
+
--
type: float
...
*`elasticsearch.server.gc.old.observation_duration.unit`*::
+
--
type: keyword
...
*`elasticsearch.server.gc.old.observation_duration.time_in_millis`*::
+
--
type: float
