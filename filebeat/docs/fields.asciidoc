...
geoip contains information gathered based on the client.ip field. Only present if the GeoIP Elasticsearch plugin is available and used.
...
Default HAProxy log format https://cbonte.github.io/haproxy-dconv/1.7/configuration.html#8.2.1
