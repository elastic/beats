...
Common fields exported by the snapshot metricset.



*`osquery.snapshot.name`*::
+
--
type: keyword
...
*`osquery.snapshot.host_identifier`*::
+
--
type: keyword
...
*`osquery.snapshot.calendar_time`*::
+
--
String representation of the collection time, as formatted by osquery.
