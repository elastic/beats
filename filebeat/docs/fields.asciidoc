...
*`saved.log.geoip.continent_name`*::
+
--
type: alias
...
*`saved.log.geoip.country_iso_code`*::
+
--
type: alias
...
*`saved.log.geoip.region_iso_code`*::
+
--
type: alias
