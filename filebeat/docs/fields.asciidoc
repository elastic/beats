...
*`apache.access.user_agent.device`*::
+
--
type: alias
...
*`apache.access.user_agent.major`*::
+
--
type: alias
...
*`apache.access.user_agent.minor`*::
+
--
type: alias
...
*`apache.access.user_agent.patch`*::
+
--
type: alias
...
*`apache.access.user_agent.os_major`*::
+
--
type: alias
...
*`apache.access.user_agent.os_minor`*::
+
--
type: alias
...
*`apache.access.user_agent.os_name`*::
+
--
type: alias
...
*`apache.access.geoip.continent_name`*::
+
--
type: alias
...
*`apache.access.geoip.country_iso_code`*::
+
--
type: alias
...
*`apache.access.geoip.region_name`*::
+
--
type: alias
...
*`apache.access.geoip.region_iso_code`*::
+
--
type: alias
