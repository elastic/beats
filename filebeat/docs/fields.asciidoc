...
+
--
The translated source IP address. Use ECS source.ip.
...
+
--
The translated source port. Use ECS source.port.
...
+
--
The translated destination IP address. Use ECS destination.ip.
...
+
--
The translated destination port. Use ECS destination.port.
