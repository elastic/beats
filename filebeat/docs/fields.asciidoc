...
*`aws.s3_server_access_log.bucket_owner`*::
+
--
...
*`aws.s3_server_access_log.bucket`*::
+
--
...
*`aws.s3_server_access_log.remote_ip`*::
+
--
...
*`aws.s3_server_access_log.requester`*::
+
--
...
*`aws.s3_server_access_log.request_id`*::
+
--
...
*`aws.s3_server_access_log.operation`*::
+
--
...
*`aws.s3_server_access_log.request_uri`*::
+
--
...
*`aws.s3_server_access_log.http_status`*::
+
--
...
*`aws.s3_server_access_log.error_code`*::
+
--
...
*`aws.s3_server_access_log.bytes_sent`*::
+
--
...
*`aws.s3_server_access_log.object_size`*::
+
--
...
*`aws.s3_server_access_log.total_time`*::
+
--
...
*`aws.s3_server_access_log.turn_around_time`*::
+
--
...
*`aws.s3_server_access_log.referrer`*::
+
--
...
*`aws.s3_server_access_log.user_agent`*::
+
--
...
*`aws.s3_server_access_log.version_id`*::
+
--
...
*`aws.s3_server_access_log.host_id`*::
+
--
...
*`aws.s3_server_access_log.signature_version`*::
+
--
...
*`aws.s3_server_access_log.cipher_suite`*::
+
--
...
*`aws.s3_server_access_log.authentication_type`*::
+
--
...
*`aws.s3_server_access_log.host_header`*::
+
--
...
*`aws.s3_server_access_log.tls_version`*::
+
--
