...
*`azure.auditlogs.properties.targetResources.displayName`*::
+
--
Display name
...
*`azure.auditlogs.properties.targetResources.id`*::
+
--
ID
...
*`azure.auditlogs.properties.targetResources.type`*::
+
--
Type
...
*`azure.auditlogs.properties.targetResources.ipAddress`*::
+
--
ip Address
...
*`azure.auditlogs.properties.targetResources.userPrincipalName`*::
+
--
User principal name
...
*`azure.auditlogs.properties.targetResources.modifiedProperties.newValue`*::
+
--
New value
...
*`azure.auditlogs.properties.targetResources.modifiedProperties.displayName`*::
+
--
Display value
...
*`azure.auditlogs.properties.targetResources.modifiedProperties.oldValue`*::
+
--
Old value
...
*`azure.auditlogs.properties.initiatedBy.app.servicePrincipalName`*::
+
--
...
*`azure.auditlogs.properties.initiatedBy.app.displayName`*::
+
--
Display name
...
*`azure.auditlogs.properties.initiatedBy.app.appId`*::
+
--
App ID
...
*`azure.auditlogs.properties.initiatedBy.app.servicePrincipalId`*::
+
--
...
*`azure.auditlogs.properties.initiatedBy.user.userPrincipalName`*::
+
--
User principal name
...
*`azure.auditlogs.properties.initiatedBy.user.displayName`*::
+
--
Display name
...
*`azure.auditlogs.properties.initiatedBy.user.id`*::
+
--
ID
...
*`azure.auditlogs.properties.initiatedBy.user.ipAddress`*::
+
--
ip Address
...
*`azure.signinlogs.operationVersion`*::
+
--
The operation version
...
*`azure.signinlogs.resultSignature`*::
+
--
Result signature
...
*`azure.signinlogs.correlationId`*::
+
--
Correlation ID
...
*`azure.signinlogs.callerIpAddress`*::
+
--
Caller Ip address
...
*`azure.signinlogs.properties.createdDateTime`*::
+
--
Created date time
...
*`azure.signinlogs.properties.userDisplayName`*::
+
--
User display name
...
*`azure.signinlogs.properties.correlationId`*::
+
--
Correlation ID
...
*`azure.signinlogs.properties.userPrincipalName`*::
+
--
User principal name
...
*`azure.signinlogs.properties.userId`*::
+
--
User ID
...
*`azure.signinlogs.properties.appId`*::
+
--
App ID
...
*`azure.signinlogs.properties.appDisplayName`*::
+
--
App display name
...
*`azure.signinlogs.properties.clientAppUsed`*::
+
--
Client app used
...
*`azure.signinlogs.properties.conditionalAccessStatus`*::
+
--
...
*`azure.signinlogs.properties.originalRequestId`*::
+
--
Original request ID
...
*`azure.signinlogs.properties.isInteractive`*::
+
--
Is interactive
...
*`azure.signinlogs.properties.tokenIssuerName`*::
+
--
Token issuer name
...
*`azure.signinlogs.properties.tokenIssuerType`*::
+
--
Token issuer type
...
*`azure.signinlogs.properties.processingTimeInMilliseconds`*::
+
--
...
*`azure.signinlogs.properties.riskDetail`*::
+
--
Risk detail
...
*`azure.signinlogs.properties.riskLevelAggregated`*::
+
--
...
*`azure.signinlogs.properties.riskLevelDuringSignIn`*::
+
--
...
*`azure.signinlogs.properties.riskState`*::
+
--
Risk state
...
*`azure.signinlogs.properties.resourceDisplayName`*::
+
--
...
*`azure.signinlogs.properties.status.errorCode`*::
+
--
Error code
...
*`azure.signinlogs.properties.deviceDetail.operatingSystem`*::
+
--
Operating system
...
*`azure.signinlogs.properties.deviceDetail.browser`*::
+
--
Browser
...
*`azure.signinlogs.properties.location.geoCoordinates.latitude`*::
+
--
Latitude
...
*`azure.signinlogs.properties.location.geoCoordinates.longitude`*::
+
--
Longitude
