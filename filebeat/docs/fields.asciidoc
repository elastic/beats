...
*`haproxy.http.time_backend_connect`*::
+
--
type: long
...
*`haproxy.http.time_server_response`*::
+
--
type: long
...
*`haproxy.http.captured_request_cookie`*::
+
--
...
*`haproxy.http.captured_response_cookie`*::
+
--
...
*`haproxy.http.termination_state`*::
+
--
...
actconn is the total number of concurrent connections on the process when the session was logged.
...
feconn is the total number of concurrent connections on the frontend when the session was logged.
...
beconn is the total number of concurrent connections handled by the backend when the session was logged.

--

*`haproxy.http.srvconn`*::
+
--
type: long

srv_conn is the total number of concurrent connections still active on the server when the session was logged.
...
srv_queue is the total number of requests which were processed before this one in the server queue.
...
*`haproxy.http.captured_request_headers`*::
+
--
type: text
...
*`haproxy.http.captured_response_headers`*::
+
--
type: text
...
*`haproxy.http.http_request`*::
+
--
type: text

http_request is the complete HTTP request line, including the method, request and HTTP version string.

--

*`haproxy.http.bind_name`*::
+
--
Please add description
...
*`haproxy.http.geoip.continent_name`*::
+
--
type: keyword
...
*`haproxy.http.geoip.country_iso_code`*::
+
--
type: keyword
...
*`haproxy.http.geoip.region_name`*::
+
--
type: keyword
...
*`haproxy.http.geoip.region_iso_code`*::
+
--
type: keyword
