...
*`panw.pan_os.destination.interface`*::
+
--
type: keyword
...
*`panw.pan_os.destination.nat.ip`*::
+
--
type: ip
...
*`panw.pan_os.destination.nat.port`*::
+
--
type: long
...
*`panw.pan_os.network.nat.community_id`*::
+
--
type: keyword
