...
Module for parsing the MariaDB log files.
...
Fields from the MariaDB log files.
...
*`mariadb.slowlog.query_time.sec`*::
+
--
type: float
...
*`mariadb.slowlog.schema`*::
+
--
type: keyword

The schema where the query was executed


--

*`mariadb.slowlog.lock_time`*::
+
--
type: date
...
*`mariadb.slowlog.time`*::
+
--
type: date

Time where the query was executed


--

*`mariadb.slowlog.query_cache_hit`*::
+
--
type: keyword

If the query hit cache


--

*`mariadb.slowlog.thread_id`*::
+
--
type: keyword
