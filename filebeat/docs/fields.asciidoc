...
*`nginx.access.upstream.response.length`*::
+
--
The response length
...
*`nginx.access.http.request.length`*::
+
--
...
*`nginx.access.http.request.time`*::
+
--
...
*`nginx.access.proxy.upstream.name`*::
+
--
...
*`nginx.access.proxy.upstream.alternative_name`*::
+
--
...
*`nginx.access.upstream.response.time`*::
+
--
...
*`nginx.access.upstream.response.status_code`*::
+
--
