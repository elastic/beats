...
[float]
=== `apache2.error.level`
>>>>>>> e41791964fe4ba91e473f90efe743c0f74a673ef
...
Contains fields for the Apache2 HTTPD ssl access logs.



[float]
=== `apache2.ssl_request.remote_ip`
...
[float]
=== `apache2.ssl_request.ssl_protocol`

type: keyword

The SSL protocol used during the connection.


[float]
=== `apache2.ssl_request.ssl_cipher`

type: keyword

The SSL cipher used during the connection.


[float]
=== `apache2.ssl_request.url`
=======
...
[float]
=== `apache2.ssl_request.http_version`
=======
...
[float]
=== `apache2.ssl_request.body_sent.bytes`
...
The SSL cipher used during the connection.
=======
=== `apache2.ssl_request.geoip.continent_name`
...
[float]
=== `apache2.ssl_request.geoip.country_iso_code`
...
[float]
=== `apache2.ssl_request.geoip.location`
...
[float]
=== `apache2.ssl_request.geoip.region_name`
...
[float]
=== `apache2.ssl_request.geoip.city_name`
