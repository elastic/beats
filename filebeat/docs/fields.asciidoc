...
*`threat.attack_pattern.description`*::
+
--
...
*`threat.attack_pattern.kill_chain_phases`*::
+
--
...
*`threat.course_of_action.description`*::
+
--
...
*`threat.identity.identity_class`*::
+
--
...
*`threat.identity.contact_information`*::
+
--
...
*`threat.intrusion_set.description`*::
+
--
...
*`threat.intrusion_set.first_seen`*::
+
--
...
*`threat.intrusion_set.last_seen`*::
+
--
...
*`threat.intrusion_set.resource_level`*::
+
--
...
*`threat.intrusion_set.primary_motivation`*::
+
--
...
*`threat.intrusion_set.secondary_motivations`*::
+
--
...
*`threat.malware.kill_chain_phases`*::
+
--
...
*`threat.threat_indicator.labels`*::
+
--
...
*`threat.threat_indicator.version`*::
+
--
...
*`threat.threat_indicator.description`*::
+
--
...
*`threat.threat_indicator.valid_from`*::
+
--
...
*`threat.threat_indicator.valid_until`*::
+
--
...
*`threat.threat_indicator.severity`*::
+
--
...
*`threat.threat_indicator.confidence`*::
+
--
...
*`threat.threat_indicator.kill_chain_phases`*::
+
--
...
*`threat.threat_indicator.mitre_tactic`*::
+
--
...
*`threat.threat_indicator.mitre_technique`*::
+
--
...
*`threat.threat_indicator.attack_pattern`*::
+
--
...
*`threat.threat_indicator.negate`*::
+
--
...
*`threat.threat_indicator.intrusion_set`*::
+
--
...
*`threat.threat_indicator.campaign`*::
+
--
...
*`threat.threat_indicator.threat_actor`*::
+
--
...
*`threat.observed_data.first_observed`*::
+
--
...
*`threat.observed_data.last_observed`*::
+
--
...
*`threat.observed_data.number_observed`*::
+
--
...
*`threat.threat_actor.description`*::
+
--
...
*`threat.threat_actor.sophistication`*::
+
--
...
*`threat.threat_actor.resource_level`*::
+
--
...
*`threat.threat_actor.primary_motivation`*::
+
--
...
*`threat.threat_actor.secondary_motivations`*::
+
--
...
*`threat.threat_actor.personal_motivations`*::
+
--
