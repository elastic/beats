...
+
--
Nagios state of the monitored service and host
...
+
--
Number of nagios check attempts
...
example: ERROR: netsnmp : No response from remote host
...
example: notify-by-email-service
