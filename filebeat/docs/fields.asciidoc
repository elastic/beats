...
ActiveMQ audit log lines.



*`activemq.audit.level`*::
+
--
type: alias
...
ActiveMQ application log lines.
...
+
--
Fully qualified class name of the caller issuing the logging request.
...
+
--
Thread that issued the logging request.
