...
|=======
| Metric                    | Description
| `files_read_total`        | Total number of files read.
| `files_closed_total`      | Total number of files closed.
| `files_created_total`     | Total number of file created events detected.
| `files_updated_total`     | Total number of file updated events detected.
| `files_ignored_total`     | Total number of file events ignored.
| `files_truncated_total`   | Total number of file truncated events detected.
| `files_deleted_total`     | Total number of file deleted events detected.
| `files_renamed_total`     | Total number of file renamed events detected.
| `files_active`            | Number of files currently open (gauge).
| `events_in_flight`        | Number of events currently in flight (gauge).
