...
To configure this input, specify a list of <<hosts,`hosts`>> to use for this
cluster, a list of <<topics,`topics`>> to track, and a <<groupid,`group_id`>>
to connect with.
...
A list of Kafka hosts (brokers) for this cluster.
