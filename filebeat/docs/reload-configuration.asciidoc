...
WARNING: DO NOT set the `reload.period` duration to longer than 10s. During
reload, filebeat waits for `reload.period` seconds before shipping logs. If you
set the `reload.period` to `30m`, filebeat will only start shipping logs after
waiting for a period of 30m.
