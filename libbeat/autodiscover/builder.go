...
// Builders is a struct of Builder list objects and a `kubernetesKeystoresRegistry` object, which
...
// SetKubernetesKeystoresRegistry set the k8sKeystoresRegistry of the Builders object
