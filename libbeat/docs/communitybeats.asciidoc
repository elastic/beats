...
https://github.com/hartfordfive/protologbeat[protologbeat]:: Accepts structure and unstructured logs via UDP or TCP.  Can also be used to receive syslog messages or GELF formated messages. (To be used as successor to udplogbeat)
