...
If you have previously configured internal collection, migrate to
using {metricbeat} collection. When using {metricbeat} collection, make
sure that internal collection is disabled.

You cannot use both {metricbeat} and internal collection.

Learn more about <<monitoring-metricbeat-collection,Monitoring with Metricbeat>>.
=========================
