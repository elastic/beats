...
The Central management document format used by Kibana has changed. As a result of the template
template changes, enrolled beats and tags and tags created prior to 6.7 will not work with the new
