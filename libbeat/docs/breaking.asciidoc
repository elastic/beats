...
changes beats and tags created prior to 6.7 will not work with the new UI until their are moved to
the new format, we have created a one time [tool](https://github.com/elastic/migrate-management-beats/releases) to help you migrate your data from
