...
either <<load-kibana-dashboards,load the dashboards>> before enrolling the
Beat, or <<configuration-dashboards,enable dashboard loading>> when you define
the configuration in central management.
endif::[]
