...
After upgrading to 6.7, make sure the 6.7 template gets loaded. 

// Dear Santa, for Christmas, please give me a widget for displaying platform-
// specific commands.
...
// REVIEWERS: I mirrored the steps for Elasticsearch because I figured they
// would be similar, but I have not tried these steps on all platforms. Please
...
learning jobs, and other content to use the new ECS field names. The aliases
may be removed in version 8.0.

// REVIEWERS: Is the 8.0 statement correct? Should I mention it here? If so,
// should I say "will be removed"?
...
TIP: When loading the template, you can also specify
