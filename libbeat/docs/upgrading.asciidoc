...
//REVIEWERS: What (if anything) should we say here ^^ about the modules.d dir?
//Is there a situation where users might have configs defined in 7.17, but also
//want to use some new modules from 8.0? If so, what do we recommend they do?
