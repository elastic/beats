...
ifdef::has_solutions[]
TIP: The example dashboards are a great way to get started visualizing
{beatname_uc} data in {kib}. For deeper observability into what's happening with
your infrastructure, though, you'll want to use the
