...
//TODO: Move this section to appear before the step where you run the beat. The section aobut opening the dashboard should be moved to a separate file so it can be shown as the final step.
