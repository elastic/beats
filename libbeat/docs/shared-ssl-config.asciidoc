...
<<<<<<< HEAD:libbeat/docs/shared-ssl-config.asciidoc
`optional`::
...
>>>>>>> caac795f2 (Fix "text-auditor" typos in data plane team files (#51512)):docs/reference/metricbeat/configuration-ssl.md
