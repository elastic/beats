...
+
NOTE: Certificates must be signed by your root CA. Intermediate CAs are currently not supported. You may be able to
use intermediate CAs by merging all the certificates in the chain into one file.
