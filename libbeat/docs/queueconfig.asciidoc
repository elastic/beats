...
should be evenly divisble by `bulk_max_size` to avoid sending partial batches to the output.
...
Number of events the queue can store. This value should be evenly divisble by `flush.min_events` to
