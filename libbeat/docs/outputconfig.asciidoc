...
To configure the Elasticsearch with index lifecycle management feature configure it as following:

// TODO: Add link to ILM in Elasticsearch
...
it to Elasticsearch. Alternative you can load the default policy and modify it in Kibana.
