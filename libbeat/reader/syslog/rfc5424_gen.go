...
//line parser/parser_rfc5424.rl:10
...
//line rfc5424_gen.go:39
	{
		cs = rfc5424_start
	}

//line rfc5424_gen.go:44
	{
		if p == pe {
			goto _test_eof
		}
...
//line parser/parser_rfc5424.rl:37

	return m, errs
}

//line rfc5424_gen.go:702
...
//line parser/parser_rfc5424.rl:46
...
//line rfc5424_gen.go:721
	{
		cs = check_start
	}

//line rfc5424_gen.go:726
	{
		if p == pe {
			goto _test_eof
		}
	...
	st_case_6:
		...
		goto st0
	tr6:
//line parser/parser_rfc5424.rl:56
...
//line parser/parser_rfc5424.rl:67

	return isRFC5424
}

//line rfc5424_gen.go:878
...
//line parser/parser_rfc5424.rl:76

// structuredData performs a best effort parsing of the raw structured data value
...
//line rfc5424_gen.go:906
	{
		cs = parse_sd_start
	}

//line rfc5424_gen.go:911
	{
		if p == pe {
			goto _test_eof
		}
...
//line parser/parser_rfc5424.rl:102
