...
func TestParseRFC5424(t *testing.T) {
	tests := map[string]struct {
		...
		"sd-with-escaped-backslash": {
			in: `<29>1 2026-03-18T20:12:53.0Z host app - mid [agentInfo@3401 tenantId="1" tenantNodePath="1\\2"] payload`,
			want: message{
				timestamp:  mustParseTime(time.RFC3339Nano, "2026-03-18T20:12:53.0Z", nil),
				priority:   29,
				facility:   3,
				severity:   5,
				version:    1,
				...
				msgID:      "mid",
				msg:        "payload",
				rawSDValue: `[agentInfo@3401 tenantId="1" tenantNodePath="1\\2"]`,
			},
		},
		"sd-with-escaped-quote": {
			in: `<29>1 2026-03-18T20:12:53.0Z host app - mid [info@1 key="val\"ue"] payload`,
			want: message{
				timestamp:  mustParseTime(time.RFC3339Nano, "2026-03-18T20:12:53.0Z", nil),
				priority:   29,
				facility:   3,
				...
				msgID:      "mid",
				msg:        "payload",
				rawSDValue: `[info@1 key="val\"ue"]`,
			},
		},
		"sd-with-all-escapes": {
			in: `<29>1 2026-03-18T20:12:53.0Z host app - mid [info@1 key="a\]b\"c\\d"] payload`,
			want: message{
				timestamp:  mustParseTime(time.RFC3339Nano, "2026-03-18T20:12:53.0Z", nil),
				priority:   29,
				facility:   3,
