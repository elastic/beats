...
func newGenericMetadataFetcher(provider string, conv schemaConv, genericFetcherMeta func(context.Context, http.Client, *result)) (*genericFetcher, error) {
...
func (g *genericFetcher) fetchMetadata(ctx context.Context, client http.Client) result {
	res := result{provider: g.provider, metadata: common.MapStr(mapstr.M{})}
