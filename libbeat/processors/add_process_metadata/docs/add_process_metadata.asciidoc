...
Optionally, the container id can be included, too:
[source,json]
-------------------------------------------------------------------------------
  ...
  "cid": "9317bb0f0c8eef642ded08bf5da182061f7f512a3987b665521a724cc84651ac" 
  ...
-------------------------------------------------------------------------------
...
`include_cid`:: (Optional) By default, this value is false, and the `cid` 
