...
func TestAddProcessMetadata(t *testing.T) {
	...
	processCgroupPaths = func(_ system.Resolver, pid int) (cgroup.PathList, error) {
...
func TestV2CID(t *testing.T) {
	processCgroupPaths = func(_ system.Resolver, _ int) (cgroup.PathList, error) {
	...
	provider := newCidProvider(system.NewTestResolver(""), []string{}, "", processCgroupPaths, nil)
