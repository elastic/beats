...
`wait_for_metadata_timeout` :: (30s) The maximum time the processor should spend trying to fetch metadata before giving up. Applies regardless of the value of `wait_for_metadata`.
