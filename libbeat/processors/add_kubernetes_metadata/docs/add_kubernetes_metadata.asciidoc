...
`wait_for_metadata` :: (false) This specifies if startup should be blocked until processor is initialized. If `false`, processor initialization will occur asynchronously. 
