...
func TestIncludeFields(t *testing.T) {
	...
	filteredEvent, drop := Filters.Filter(event)
...
func TestMultipleIncludeFilters(t *testing.T) {
	...
	actual1, drop1 := Filters.Filter(event1)
	actual2, drop2 := Filters.Filter(event2)
