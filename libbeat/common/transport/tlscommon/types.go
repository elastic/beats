...
var tlsCipherSuites = map[string]tlsCipherSuite{
	...
	"ECDHE-RSA-AES-128-CBC-SHA256": tlsCipherSuite(TLS_ECDHE_RSA_WITH_AES_128_CBC_SHA256),
	...
	"ECDHE-RSA-CHACHA20-POLY1205":  tlsCipherSuite(TLS_ECDHE_RSA_WITH_CHACHA20_POLY1305),
