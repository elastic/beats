...
echo "Import visualizations from ${DIR}/visualization to ${ELASTICSEARCH} in ${KIBANA_INDEX} index"
...
echo "Import dashboards from ${DIR}/dashboard to ${ELASTICSEARCH} in ${KIBANA_INDEX} index"
...
echo "Import index-pattern from ${DIR}/index-pattern to ${ELASTICSEARCH} in ${KIBANA_INDEX} index"
