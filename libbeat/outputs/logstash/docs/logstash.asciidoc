...
==== Outputting to Winlogbeat created Data Stream via Logstash
When you setup Winlogbeat for the first time it will create a Data Stream within Elasticsearch.  To setup Logstash to output to the Elasticearch hosted Data Stream you can start wtih the below example:
