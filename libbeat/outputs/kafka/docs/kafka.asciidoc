...
This output can connect to Kafka version 0.8.2.0 and up. Older versions
...
Kafka protocol version {beatname_lc} will request when connecting. Defaults to 1.0.0.
