...
IMPORTANT: ** It is strongly recommended to update directly to v8.5.1. ** If not possible to update, please continue to the suggested solution.

Suggested resolution: Manually update Heartbeat index template mappings. Start by exporting the actual mappings:
...
[source,json]
----
POST heartbeat-8.5.1/_rollover
----
