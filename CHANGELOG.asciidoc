...
- Add fields for thread pool, transport, circuit breakers, discovery, ingest pipelines, and adaptive selection to `node_stats` metricset of Elasticsearch module. {pull}7993[7993]
