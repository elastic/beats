...
- The base folder for data and logs on Windows has changed from `C:\ProgramData\[BeatName]` to to `C:\Program Files\[BeatName]-Data` because the latter has stricter permissions. {pull}45949[45949]
...
- Update to Go version to 1.24.5. {pull}45403[45403]
