...
=== Beats version HEAD
https://github.com/elastic/beats/compare/v5.0.0-alpha1...master[Check the HEAD diff]
...
https://github.com/elastic/beats/compare/v1.2.0...5.0.0-alpha1[View commits]
