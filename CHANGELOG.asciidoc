...
=== Beats version 7.17.29
https://github.com/elastic/beats/compare/v7.17.28\...v7.17.29[View commits]

==== Bugfixes

*Filebeat*

- Fixed race conditions in the global ratelimit processor that could drop events or apply rate limiting incorrectly. {pull}42966
...
- Update to Go 1.23.10. {pull}44901[44901]
...
=== Beats version 7.17.28
https://github.com/elastic/beats/compare/v7.17.27\...v7.17.28[View commits]
...
- Update Go version to 1.22.10. {pull}41946[41946]


[[release-notes-7.17.26]]
=== Beats version 7.17.26
https://github.com/elastic/beats/compare/v7.17.25\...v7.17.26[View commits]

==== Added

*Affecting all Beats*

- Update Go version to 1.22.9. {pull}41554[41554]
...
- Upgrade github.com/containerd/containerd version to v1.5.18. {pull}40096[40096]
...
=== Beats version 7.17.23
https://github.com/elastic/beats/compare/v7.17.22\...v7.17.23[View commits]

==== Bugfixes

*Filebeat*

- Upgrade github.com/hashicorp/go-retryablehttp version. {pull}40036[40036]
...
- Upgrade Go version to 1.21.12. {pull}40113[40113]
