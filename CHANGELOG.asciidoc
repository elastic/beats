...
=== Beats version HEAD
https://github.com/elastic/beats/compare/v5.6.16...5.6[Check the HEAD diff]
...
=== Beats version 5.6.16
https://github.com/elastic/beats/compare/v5.6.15...v5.6.16[View commits]
...
https://github.com/elastic/beats/compare/v5.6.14...v5.6.15[View commits]
