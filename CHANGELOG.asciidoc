...
*Auditbeat* 
Auditbeat/auditd integration may send malformed data and crash in version 8.4.0. {issue}32818[32818]

Suggested resolution:
Do not start Auditbeat or auditd integration on Elastic Agent at version 8.4.0, and immediately upgrade to 8.4.1. 
