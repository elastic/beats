...
- Upgrade elastic-agent-libs to v0.6.2 which include the following fixes: {pull}36979[36979]:
  ...
  * Sends `PendingStop` and `Stopped` status to Windows service manager on external shutdown notification.
