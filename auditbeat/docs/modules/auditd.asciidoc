...
+
It is important to note that with this setting set, if {beatname_uc} is stopped
for any reason, a system restart is required before restarting it successfully.
