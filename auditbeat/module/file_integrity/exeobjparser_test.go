	...
	"go_elf": {
		"elf": common.MapStr{
			...
			"sections": []objSection{
				...
				{Name: strPtr(".bss"), Size: uint64Ptr(0x2ef48), Entropy: float64Ptr(7.99), VarEntropy: float64Ptr(0.0001)},
				{Name: strPtr(".noptrbss"), Size: uint64Ptr(0x5360), Entropy: float64Ptr(7.97), VarEntropy: float64Ptr(0.0001)},
