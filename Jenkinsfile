        ...
        stage('Parallel') {
          parallel {
            stage('Linux'){
              ...
              options { skipDefaultCheckout() }
              steps {
                mageTarget("build", "${BEAT}", "build test")
              }
            }
            stage('Windows'){
              ...
              options { skipDefaultCheckout() }
              steps {
                mageTargetWin("Unit test", "${BEAT}", "build unitTest")
              }
            }
            stage('Mac OS X'){
              agent { label 'macosx' }
              options { skipDefaultCheckout() }
              steps {
                mageTarget("Unit test", "${BEAT}", "build unitTest")
              }
              post {
                always {
                  delete()
            ...
            stage('ARM'){
              ...
              options { skipDefaultCheckout() }
              steps {
                mageTarget("Unit test", "${BEAT}", "build goUnitTest")
              }
              post {
                always {
                  delete()
            ...
            stage('Crosscompile'){
              ...
              options { skipDefaultCheckout() }
              steps {
                mageTarget("Crosscompile", "${BEAT}", "crosscompile")
              }
              post {
                always {
                  delete()
