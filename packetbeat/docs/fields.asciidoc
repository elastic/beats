...
* <<exported-fields-aws.ec2>>
* <<exported-fields-aws.elb>>
* <<exported-fields-beat-common>>
* <<exported-fields-cassandra>>
* <<exported-fields-cloud>>
* <<exported-fields-cloudfoundry-processor>>
...
* <<exported-fields-nfs>>
* <<exported-fields-nomad-processor>>
...
+
--
The EC2 instance architecture (i386 | x86_64 | arm64 ).
...
+
--
Whether this is an ipv4 or dual-stack IP
...
+
--
Whether this is an application or network loadbalancer
...
+
--
List of security groups for this
...
example: 2019-06-12 21:55:14.490000+00:00
...
+
--
whether this ELB is internet facing or internal-only
...
*`cloudfoundry.envelope.deployment`*::
+
--
