...
hl7 specific event fields.




*`hl7.request.msh_sending_application`*::
+
--
type: keyword
...
*`hl7.request.msh_sending_facility`*::
+
--
type: keyword
...
*`hl7.request.msh_receiving_application`*::
+
--
type: keyword
...
*`hl7.request.msh_receiving_facility`*::
+
--
type: keyword
...
*`hl7.request.msh_datetime_of_message`*::
+
--
type: date
...
*`hl7.request.msh_message_control_id`*::
+
--
type: text
...
*`hl7.request.segments.fields.field`*::
+
--
type: long
...
*`hl7.request.segments.fields.repeat`*::
+
--
type: long
...
*`hl7.request.segments.fields.component`*::
+
--
type: long
...
*`hl7.request.segments.fields.subcomponent`*::
+
--
type: long
...
*`hl7.request.segments.fields.text`*::
+
--
type: text
...
*`hl7.request.segments.fields.numeric`*::
+
--
type: float
...
*`hl7.request.segments.fields.date`*::
+
--
type: date
...
*`hl7.response.msh_sending_application`*::
+
--
type: keyword
...
*`hl7.response.msh_sending_facility`*::
+
--
type: keyword
...
*`hl7.response.msh_receiving_application`*::
+
--
type: keyword
...
*`hl7.response.msh_receiving_facility`*::
+
--
type: keyword
...
*`hl7.response.msh_datetime_of_message`*::
+
--
type: date
...
*`hl7.response.msh_message_control_id`*::
+
--
type: text
...
*`hl7.response.msa_acknowledgement_code`*::
+
--
type: keyword
...
*`hl7.response.msa_message_control_id`*::
+
--
type: text
...
*`hl7.response.segments.fields.field`*::
+
--
type: long
...
*`hl7.response.segments.fields.repeat`*::
+
--
type: long
...
*`hl7.response.segments.fields.component`*::
+
--
type: long
...
*`hl7.response.segments.fields.subcomponent`*::
+
--
type: long
...
*`hl7.response.segments.fields.text`*::
+
--
type: text
...
*`hl7.response.segments.fields.numeric`*::
+
--
type: float
...
*`hl7.response.segments.fields.date`*::
+
--
type: date
