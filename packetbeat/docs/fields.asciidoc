...
*`hl7v2.request.items.subcomponent`*::
+
--
type: long
...
*`hl7v2.response.items.component`*::
+
--
type: long
...
*`hl7v2.response.items.subcomponent`*::
+
--
type: long
