...
*`hl7v2.request.segment.field.component.id`*::
+
--
type: keyword
...
*`hl7v2.request.segment.field.component.value`*::
+
--
type: keyword
...
*`hl7v2.response.segment.field.component.id`*::
+
--
type: keyword
...
*`hl7v2.response.segment.field.component.value`*::
+
--
type: keyword
