...
*`hl7v2.request.msh_sending_application`*::
+
--
type: keyword
...
*`hl7v2.request.msh_sending_facility`*::
+
--
type: keyword
...
*`hl7v2.request.msh_receiving_application`*::
+
--
type: keyword
...
*`hl7v2.request.msh_receiving_facility`*::
+
--
type: keyword
...
*`hl7v2.request.msh_datetime_of_message`*::
+
--
type: date
...
*`hl7v2.request.msh_message_type`*::
+
--
type: keyword
...
*`hl7v2.request.msh_message_control_id`*::
+
--
type: text
...
*`hl7v2.request.segments.segment`*::
+
--
type: keyword
...
*`hl7v2.request.segments.fields.field`*::
+
--
type: long
...
*`hl7v2.request.segments.fields.repeat`*::
+
--
type: long
...
*`hl7v2.request.segments.fields.component`*::
+
--
type: long
...
*`hl7v2.request.segments.fields.subcomponent`*::
+
--
type: long
...
*`hl7v2.request.segments.fields.text`*::
+
--
type: text
...
*`hl7v2.request.segments.fields.numeric`*::
+
--
type: float
...
*`hl7v2.request.segments.fields.date`*::
+
--
type: date
...
*`hl7v2.response.msh_sending_application`*::
+
--
type: keyword
...
*`hl7v2.response.msh_sending_facility`*::
+
--
type: keyword
...
*`hl7v2.response.msh_receiving_application`*::
+
--
type: keyword
...
*`hl7v2.response.msh_receiving_facility`*::
+
--
type: keyword
...
*`hl7v2.response.msh_datetime_of_message`*::
+
--
type: date
...
*`hl7v2.response.msh_message_type`*::
+
--
type: keyword
...
*`hl7v2.response.msh_message_control_id`*::
+
--
type: text
...
*`hl7v2.response.msa_acknowledgement_code`*::
+
--
type: keyword
...
*`hl7v2.response.msa_message_control_id`*::
+
--
type: text
...
*`hl7v2.response.msa_text_message`*::
+
--
type: text
...
*`hl7v2.response.segments.segment`*::
+
--
type: keyword
...
*`hl7v2.response.segments.fields`*::
+
--
type: nested
...
*`hl7v2.response.segments.fields.field`*::
+
--
type: long
...
*`hl7v2.response.segments.fields.repeat`*::
+
--
type: long
...
*`hl7v2.response.segments.fields.component`*::
+
--
type: long
...
*`hl7v2.response.segments.fields.subcomponent`*::
+
--
type: long
...
*`hl7v2.response.segments.fields.text`*::
+
--
type: text
...
*`hl7v2.response.segments.fields.numeric`*::
+
--
type: float
...
*`hl7v2.response.segments.fields.date`*::
+
--
type: date
