...
*`hl7.request.sending_application`*::
+
--
type: keyword
...
*`hl7.request.receiving_application`*::
+
--
type: keyword
...
*`hl7.request.receiving_facility`*::
+
--
type: keyword
...
*`hl7.request.datetime_of_message`*::
+
--
type: date
...
*`hl7.request.message_control_id`*::
+
--
type: text
...
*`hl7.response.sending_application`*::
+
--
type: keyword
...
*`hl7.response.receiving_application`*::
+
--
type: keyword
...
*`hl7.response.receiving_facility`*::
+
--
type: keyword
...
*`hl7.response.datetime_of_message`*::
+
--
type: date
...
*`hl7.response.message_control_id`*::
+
--
type: text
...
*`hl7.response.acknowledgement_code`*::
+
--
type: keyword
