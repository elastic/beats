...
[float]
=== cassandra.response.result.result_type
...
[float]
=== cassandra.response.result.event.change
...
[float]
=== cassandra.response.result.event.keyspace
...
[float]
=== cassandra.response.result.event.table
...
[float]
=== cassandra.response.result.event.object
...
[float]
=== cassandra.response.result.event.target
...
[float]
=== cassandra.response.result.event.name
...
[float]
=== cassandra.response.result.event.args
...
[float]
== prepared_result Fields

The result to a PREPARE message.


[float]
=== cassandra.response.result.prepared_result.prepared_id
...
[float]
=== cassandra.response.result.prepared_result.req_meta.keyspace
...
[float]
=== cassandra.response.result.prepared_result.req_meta.table
...
[float]
=== cassandra.response.result.prepared_result.req_meta.flags
...
[float]
=== cassandra.response.result.prepared_result.req_meta.col_count
...
[float]
=== cassandra.response.result.prepared_result.req_meta.pkey_columns
...
[float]
=== cassandra.response.result.prepared_result.req_meta.paging_state
...
[float]
=== cassandra.response.result.prepared_result.resp_meta.keyspace
...
[float]
=== cassandra.response.result.prepared_result.resp_meta.table
...
[float]
=== cassandra.response.result.prepared_result.resp_meta.flags
...
[float]
=== cassandra.response.result.prepared_result.resp_meta.col_count
...
[float]
=== cassandra.response.result.prepared_result.resp_meta.pkey_columns
...
[float]
=== cassandra.response.result.prepared_result.resp_meta.paging_state
...
[float]
=== cassandra.response.event.event_type
...
[float]
=== cassandra.response.error.err_code
...
[float]
=== cassandra.response.error.err_msg
...
[float]
=== cassandra.response.error.err_type
