...
*`tls.detailed.handshake_completed`*::
+
--
...
*`tls.detailed.client_hello.supported_ciphers`*::
+
--
...
*`tls.detailed.client_certificate.raw`*::
+
--
...
*`tls.detailed.client_certificate.fingerprint.md5`*::
+
--
...
*`tls.detailed.client_certificate.fingerprint.sha1`*::
+
--
...
*`tls.detailed.client_certificate.fingerprint.sha256`*::
+
--
...
*`tls.detailed.server_certificate.raw`*::
+
--
The raw certificate in PEM format.
...
*`tls.detailed.server_certificate.fingerprint.md5`*::
+
--
Certificate's MD5 fingerprint.
...
*`tls.detailed.server_certificate.fingerprint.sha1`*::
+
--
Certificate's SHA-1 fingerprint.
...
*`tls.detailed.server_certificate.fingerprint.sha256`*::
+
--
Certificate's SHA-256 fingerprint.
...
*`tls.detailed.fingerprints.ja3.hash`*::
+
--
...
*`tls.detailed.fingerprints.ja3.str`*::
+
--
