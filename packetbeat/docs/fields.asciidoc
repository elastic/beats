...
[float]
=== cassandra.response.result_type

type: keyword

Cassandra result type. (eg. rows)
...
[float]
=== cassandra.response.rows

type: dict

Details about the returned rows

[float]
=== cassandra.response.err_code
