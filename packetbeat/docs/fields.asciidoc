...
*`hl7v2.request.sending_application`*::
+
--
type: keyword
...
*`hl7v2.request.sending_facility`*::
+
--
type: keyword
...
*`hl7v2.request.receiving_application`*::
+
--
type: keyword
...
*`hl7v2.request.receiving_facility`*::
+
--
type: keyword
...
*`hl7v2.request.datetime_of_message`*::
+
--
type: date
...
*`hl7v2.request.message_control_id`*::
+
--
type: text
...
*`hl7v2.response.acknowledgement_code`*::
+
--
type: keyword
...
*`hl7v2.response.message_control_id`*::
+
--
type: text
