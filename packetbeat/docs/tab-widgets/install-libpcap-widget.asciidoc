...
<div class="tabs" data-tab-group="os">
  <div role="tablist" aria-label="Install libpcap">
    ...
    <button role="tab"
            aria-selected="false"
            aria-controls="brew-tab-install-libpcap"
            id="brew-install-libpcap"
            tabindex="-1">
      Brew
    </button>
    <button role="tab"
...
++++
  ...
  <div tabindex="0"
       role="tabpanel"
       id="brew-tab-install-libpcap"
       aria-labelledby="brew-install-libpcap"
       hidden="">
++++

include::install-libpcap.asciidoc[tag=brew]
