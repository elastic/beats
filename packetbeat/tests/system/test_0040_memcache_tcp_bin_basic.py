...
class Test(BaseTest):
    ...
    def test_store_load(self):
        ...
        assert (set['memcache.request.opaque'] == set['memcache.response.opaque'])
    ...
    def test_multi_store_load(self):
        ...
        assert all((o['memcache.request.opaque'] == o['memcache.response.opaque']) for o in six.itervalues(sets))
        ...
        assert all((o['memcache.request.opaque'] == o['memcache.response.opaque']) for o in six.itervalues(gets))

        noop = objs[8]
        assert noop['memcache.request.command'] == 'noop'
        assert (noop['memcache.request.opaque'] == noop['memcache.response.opaque'])
    ...
    def test_counter_ops(self):
        ...
        assert (inc['memcache.request.opaque'] == inc['memcache.response.opaque'])
        ...
        assert (dec['memcache.request.opaque'] == dec['memcache.response.opaque'])
    ...
    def test_stats(self):
        ...
        assert (trans['memcache.request.opaque'] == trans['memcache.response.opaque'])
