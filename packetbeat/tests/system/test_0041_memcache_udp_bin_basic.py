...
class Test(BaseTest):
    ...
    def test_store(self):
        objs = self._run("memcache/memcache_bin_udp_single_store.pcap", min_events=1)
    ...
    def test_multi_store(self):
        objs = self._run("memcache/memcache_bin_udp_multi_store.pcap", min_events=3)
    ...
    def test_delete(self):
        objs = self._run('memcache/memcache_bin_udp_delete.pcap', min_events=2)
    ...
    def test_counter_ops(self):
        objs = self._run('memcache/memcache_bin_udp_counter_ops.pcap', min_events=3)
