...
=== Beats version HEAD
https://github.com/menderesk/beats/compare/v7.0.0-rc2..main[Check the HEAD diff]
...
- Altered all remaining uses of mapval to use the renamed and enhanced version: https://github.com/menderesk/go-lookslike[go-lookslike] instead, which is a separate project. The mapval tree is now gone. {pull}14165[14165]
