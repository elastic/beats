...
- Events intended for the Elasticsearch output can now take an `op_type` metadata field of type events.OpType to indicate the `op_type` to use for bulk indexing. {pull}12606[12606]
