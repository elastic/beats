...
- Enhance behavior of sanitizeError: replace sensitive info even if it is escaped {pull}45857[45857]
...
- TCP and UDP inputs now support multiple pipeline workers. This improves performance when slow processors are used by decoupling reading from the network connection and publishing {issue}43674[43674] {pull}45124[45124]
