...
- Ensure winlog input restarts metric collection when handling recoverable errors. {issue}36479[36479] {pull}36482[36482]
...
- Ensure event loggers restart metric collection when handling recoverable errors. {issue}36479[36479] {pull}36482[36482]
