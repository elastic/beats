...
- Fix to collect the Google Cloud organization ID and display name, and assign them to `cloud.account.id` and `cloud.account.name`, respectively {issue}39203[39203] {pull}40454[40454]
