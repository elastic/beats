...
- TCP and UDP inputs now support multiple pipeline workers. This improves performance by decoupling reading from the network connection and publishing {issue}43674[43674] {pull}45124[45124]
