...
- Enhance add_cloud_metadata processor with `orchestrator.cluster.name`, `orchestrator.cluster.id` and `cloud.resourceGroup.name` when running inside an AKS cluster. {issue}33081[33081] {pull}37685[37685]
