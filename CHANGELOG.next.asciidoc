...
- Add support for location label as an optional configuration parameter in- Add `use_performance_counters` to use performance counters to collect CPU related metrics on Windows. {pull}41965[41965]
