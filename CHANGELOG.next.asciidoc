...
- Remove options `logging.files.suffix` and default to datetime endings in log file names. {pull}28927[28927]
...
- The extension of the log files of Beats and Elastic Agent is changed to `.ndjson`. If you are collecting their logs, you must change the path configuration to `/path/to/logs/{beatname}*.ndjson` to avoid any issues. {pull}28927[28927]
