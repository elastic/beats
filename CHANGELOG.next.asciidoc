...
- Fix too-frequent API calls made to vCenter for host and network information lookups in the vSphere module. {pull}37137[37137]
...
- Add support for all metrics and multiple additional configration items returned by a vCenter server for the virtualmachine metric set in the vSphere module. {pull}37137[37137]
