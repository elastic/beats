...
- Switch persistent storage from dgraph-io/badger to etcd-io/bbolt in x-pack/libbeat/persistentcache/persistentcache.go. This change impacts only Cloudfoundry-related functionality. After updating to this version, caches will be regenerated, potentially resulting in numerous calls to the Cloudfoundry API. {pull}42571[42571]
