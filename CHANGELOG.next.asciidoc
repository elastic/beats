...
- Fix for GCP to update the period value to default value(60s) when user specifies a value below the minimum period value in GCP. {issue}30434[30434] {pull}40020[40020]
