...
- Migrate field `http.response.elapsed_time` (ms) to `event.duration` (ns) (ECS). {pull}10188[10188]
- Rename field `http.response.content_length` to `http.response.body.bytes` (ECS). {pull}10188[10188]
- Migrate multiple fields to `event.duration`, from modules "iis", "kibana" and "traefik" (ECS). {pull}10188[10188]
- Rename fields to `http.response.body.bytes`, from modules "apache", "iis",
  "kibana", "nginx" and "traefik" (ECS). {pull}10188[10188]
- Rename field `iis.access.body_received.bytes` to `http.request.body.bytes` (ECS). {pull}10188[10188]
