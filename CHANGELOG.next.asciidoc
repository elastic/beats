...
- Fix an issue where the conntrack metricset entries field reported an inflated count because it was multiplied by the number of CPU cores. {issue}46138[46138] {pull}46140[46140]
