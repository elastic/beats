...
- Filestream's `clean_inactive` setting is now validated, if the validation fails, Filebeat exits with an error code. To keep the legacy behavior of not validating set `disable_clean_inactive_checks: true`. {issue}45601[45601]
{pull}46373[46373]
- In Filestream, setting `clean_inactive: 0` now disables `clean_inactive`. {issue}45601[45601]
{pull}46373[46373]
