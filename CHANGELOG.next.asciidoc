...
- Fix a FD leaks when the Elasticsearch output was reloaded. {pull}10567[10567]
- Fix a goroutine leaks when reloading the Elasticsearch output. {pull}10567[10567]
- Fix a goroutine leaks when outputs are reloaded. {pull}10567[10567]
