...
- Fixed a memory leak when using the add_process_metadata processor under Windows. {pull}TODO[TODO]
...
- Process dataset: Fixed a memory leak under Windows. {pull}TODO[TODO]
...
- Fixed a memory leak when using process monitoring under Windows. {pull}TODO[TODO]
