...
packetbeat:
  pkg:
    ...
    - sources:
{% if grains['os_family'] == 'RedHat' %}
      - packetbeat: https://download.elastic.co/beats/packetbeat/packetbeat-1.0.0-beta4-x86_64.rpm
{% elif grains['os_family'] == 'Debian' %}
      - packetbeat: https://download.elastic.co/beats/packetbeat/packetbeat_1.0.0-beta4_amd64.deb
{% endif %}
  service:
    - running
    - watch:
