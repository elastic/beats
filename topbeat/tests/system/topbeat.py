...
class TestCase(unittest.TestCase):
    ...
    def render_config_template(self, template="topbeat.yml.j2",
                               output="topbeat.yml", **kargs):
    ...
    def read_output(self, output_file="output/topbeat"):
        jsons = []
    ...
    def log_contains(self, msg, logfile="topbeat.log"):
        """
