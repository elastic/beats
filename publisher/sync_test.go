...
func TestSyncPublishEventSuccess(t *testing.T) {
	...
	assert.True(t, testPub.pub.syncPublisher.client().PublishEvent(event))
...
func TestSyncPublishEventsSuccess(t *testing.T) {
	...
	assert.True(t, testPub.pub.syncPublisher.client().PublishEvents(events))
...
func TestSyncPublishEventFailed(t *testing.T) {
	...
	assert.False(t, testPub.pub.syncPublisher.client().PublishEvent(event))
...
func TestSyncPublishEventsFailed(t *testing.T) {
	...
	assert.False(t, testPub.pub.syncPublisher.client().PublishEvents(events))
