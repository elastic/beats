# Contributing to Topbeat

Topbeat is an open source project and we love to receive contributions from
our community — you!
...
Topbeat, please start by opening a topic on the
[forums](https://discuss.elastic.co/c/beats/topbeat). It may be that
...
Topbeat is a Go program, so install [golang](http://golang.org/) if you
...
simply set it to your home directory (`export GOPATH=$HOME`).
    ...
    $ git clone https://github.com/elastic/topbeat.git
