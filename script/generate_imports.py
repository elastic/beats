...
asl2 = """// Licensed to Elasticsearch B.V. under one or more contributor
...
"""
elastic_license = """// Copyright Elasticsearch B.V. and/or licensed to Elasticsearch B.V. under one
