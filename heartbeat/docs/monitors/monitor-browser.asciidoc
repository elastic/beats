...
The recommended way to run Synthetic tests is to use project monitors instead. See the https://www.elastic.co/guide/en/observability/current/synthetic-run-tests.html#synthetic-monitor-choose-project[Elastic synthetics docs].
