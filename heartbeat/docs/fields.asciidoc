...
+
--
The current status of this state at the time of this event, can changed from up->flapping or down->flapping at any time
...
+
--
total checks within this state
