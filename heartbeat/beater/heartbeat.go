...
func New(b *beat.Beat, rawConfig *common.Config) (beat.Beater, error) {
	...
	bt := &Heartbeat{
		...
		dynamicFactory: monitors.NewFactory(b.Info, scheduler, false, monitors.FORMAT_STANDALONE),
	}
	return bt, nil
}
...
func (bt *Heartbeat) RunStaticMonitors(b *beat.Beat) error {
	factory := monitors.NewFactory(b.Info, bt.scheduler, true, monitors.FORMAT_STANDALONE)
