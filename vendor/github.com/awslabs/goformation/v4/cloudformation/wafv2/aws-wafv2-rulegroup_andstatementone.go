...
// RuleGroup_AndStatementOne AWS CloudFormation Resource (AWS::WAFv2::RuleGroup.AndStatementOne)
// See: http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-wafv2-rulegroup-andstatementone.html
type RuleGroup_AndStatementOne struct {
...
func (r *RuleGroup_AndStatementOne) AWSCloudFormationType() string {
	return "AWS::WAFv2::RuleGroup.AndStatementOne"
}
