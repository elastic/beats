...
// RuleGroup_StatementOne AWS CloudFormation Resource (AWS::WAFv2::RuleGroup.StatementOne)
// See: http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-wafv2-rulegroup-statementone.html
type RuleGroup_StatementOne struct {
	...
	AndStatement *RuleGroup_AndStatementOne `json:"AndStatement,omitempty"`
	...
	NotStatement *RuleGroup_NotStatementOne `json:"NotStatement,omitempty"`
	...
	OrStatement *RuleGroup_OrStatementOne `json:"OrStatement,omitempty"`
	...
	RateBasedStatement *RuleGroup_RateBasedStatementOne `json:"RateBasedStatement,omitempty"`
...
func (r *RuleGroup_StatementOne) AWSCloudFormationType() string {
	return "AWS::WAFv2::RuleGroup.StatementOne"
}
