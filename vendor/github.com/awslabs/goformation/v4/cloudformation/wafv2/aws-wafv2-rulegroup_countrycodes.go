...
// RuleGroup_CountryCodes AWS CloudFormation Resource (AWS::WAFv2::RuleGroup.CountryCodes)
// See: http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-wafv2-rulegroup-countrycodes.html
type RuleGroup_CountryCodes struct {
...
func (r *RuleGroup_CountryCodes) AWSCloudFormationType() string {
	return "AWS::WAFv2::RuleGroup.CountryCodes"
}
